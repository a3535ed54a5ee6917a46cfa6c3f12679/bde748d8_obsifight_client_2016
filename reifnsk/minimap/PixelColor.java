...
public class PixelColor {
   ...
   public void composite(float alpha, int rgb, float lr, float lg, float lb) {
      if(this.alphaComposite) {
         float r = (float)(rgb >> 16 & 255) * 0.003921569F * lr;
         float g = (float)(rgb >> 8 & 255) * 0.003921569F * lg;
         float b = (float)(rgb >> 0 & 255) * 0.003921569F * lb;
         this.red += (r - this.red) * alpha;
         this.green += (g - this.green) * alpha;
         this.blue += (b - this.blue) * alpha;
         this.alpha += (1.0F - this.alpha) * alpha;
         ...
         this.alpha = (float)(rgb >> 24 & 255) * 0.003921569F;
         this.red = (float)(rgb >> 16 & 255) * 0.003921569F * lr;
         this.green = (float)(rgb >> 8 & 255) * 0.003921569F * lg;
         this.blue = (float)(rgb >> 0 & 255) * 0.003921569F * lb;
      }
   }
