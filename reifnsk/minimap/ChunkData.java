...
public class ChunkData {
   ...
   private void updateEnvironmentColor() {
      ...
      BiomeGenBase var6;
      if(this.chunk != null) {
         byte[] var5 = this.chunk.getBiomeArray();
         this.biomes = (BiomeGenBase[])((BiomeGenBase[])Arrays.copyOf(this.biomes, 256));
         ...
         for(x = 0; x < 256; ++x) {
            ...
            var6 = BiomeGenBase.getBiomeGenArray()[x1];
            this.biomes[x] = var6 == null?BiomeGenBase.plains:var6;
         }
      }
      ...
      int var61;
      for(var61 = 0; var61 < 256; ++var61) {
         var6 = this.biomes[var61];
         this.waterColors[var61] = var6.waterColorMultiplier;
         x1 = this.xPosition * 16 + (var61 & 15);
         int var7 = this.zPosition * 16 + (var61 >> 4);
         this.foliageColors[var61] = var6.getBiomeFoliageColor(x1, 64, var7);
         this.grassColors[var61] = var6.getBiomeGrassColor(x1, 64, var7);
      }

      for(var61 = -1; var61 <= 16; ++var61) {
         for(x = -1; x <= 16; ++x) {
            this.calcSmoothColor(x, var61);
         }
      }
   }
   ...
   static void init() {
      try {
         ...
         if(Minecraft.getMinecraft().getIntegratedServer() != null) {
            WorldServer[] var1 = Minecraft.getMinecraft().getIntegratedServer().worldServers;
   ...
   private static IChunkLoader getChunkLoader(IChunkProvider chunkProvider) {
      try {
         for(Class e = chunkProvider.getClass(); e != null; e = e.getSuperclass()) {
            Field[] arr$ = e.getDeclaredFields();
            int len$ = arr$.length;
