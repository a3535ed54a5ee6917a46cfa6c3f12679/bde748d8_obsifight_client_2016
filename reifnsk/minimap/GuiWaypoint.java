...
class GuiWaypoint extends GuiButton {
   ...
   public void drawButton(Minecraft minecraft, int i, int j) {
      if(this.waypoint != null) {
         ...
         this.drawString(fontRenderer, this.name, this.field_146128_h + 1, this.field_146129_i + 1, (hover?COLOR1:COLOR2)[this.waypoint.type]);
         ...
         if(tooltip) {
            String tooltipText = String.format("X:%d, Y:%d, Z:%d", new Object[]{Integer.valueOf(this.waypoint.x), Integer.valueOf(this.waypoint.y), Integer.valueOf(this.waypoint.z)});
