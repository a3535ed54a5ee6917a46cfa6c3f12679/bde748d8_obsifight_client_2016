      ...
      if(this.worldObj == null) {
         ...
         if(!this.isUpdating) {
            for(int var30 = 0; var30 < 2; ++var30) {
               this.tempSkipRenderPass[var30] = true;
            }

            this.tempVertexState = null;
            Minecraft var28 = Minecraft.getMinecraft();
            EntityLivingBase var31 = var28.renderViewEntity;
            viewEntityPosX = MathHelper.floor_double(var31.posX);
            viewEntityPosY = MathHelper.floor_double(var31.posY);
            viewEntityPosZ = MathHelper.floor_double(var31.posZ);
            byte var32 = 1;
            chunkcache = new ChunkCache(this.worldObj, var271 - var32, yMin - var32, zMin - var32, xMax + var32, yMax + var32, zMax + var32, var32);
         ...
         if(this.isUpdating || !chunkcache.extendedLevelsInChunkCache()) {
            ...
            for(int var311 = 0; var311 < 2; ++var311) {
               ...
               for(int y = yMin; y < yMax; ++y) {
                  if(this.isUpdating) {
                     ...
                     var311 = this.updateState.renderPass;
                     y = this.updateState.y;
                     var321 = this.updateState.flag;
                     hasRenderedBlocks = this.updateState.hasRenderedBlocks;
                     hasGlList = this.updateState.hasGlList;
                     if(hasGlList) {
                        this.preRenderBlocksSmooth(var311);
                     }
                  } else if(hasGlList && finishTime != 0L && System.nanoTime() - finishTime > 0L && this.activeListIndex[var311] < 15) {
                     if(hasRenderedBlocks) {
                        this.tempSkipRenderPass[var311] = false;
                     }

                     this.postRenderBlocksSmooth(var311, this.renderGlobal.renderViewEntity, false);
                     ++this.activeListIndex[var311];
                     ...
                     this.updateState.renderPass = var311;
                     this.updateState.y = y;
                     this.updateState.flag = var321;
                  ...
                  for(int z = zMin; z < zMax; ++z) {
                     for(int x = var271; x < xMax; ++x) {
                        ...
                        if(block.getMaterial() != Material.air) {
                           ...
                           if(var311 == 0 && hasTileEntity) {
                              TileEntity var33 = chunkcache.getTileEntity(x, y, z);
                              if(TileEntityRendererDispatcher.instance.hasSpecialRenderer(var33)) {
                                 this.tileEntityRenderers.add(var33);
                              }
                           }

                           int var331 = block.getRenderBlockPass();
                           if(var331 > var311) {
                              var321 = true;
                           }

                           boolean canRender = var331 == var311;
                           if(Reflector.ForgeBlock_canRenderInPass.exists()) {
                              canRender = Reflector.callBoolean(block, Reflector.ForgeBlock_canRenderInPass, new Object[]{Integer.valueOf(var311)});
                           }
               ...
               if(hasGlList) {
                  this.postRenderBlocksSmooth(var311, this.renderGlobal.renderViewEntity, true);
               } else {
         ...
         var301.removeAll(setOldEntityRenders);
         this.tileEntities.addAll(var301);
