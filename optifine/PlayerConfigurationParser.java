...
public class PlayerConfigurationParser {
   ...
   private BufferedImage downloadTextureImage(String texturePath) {
      ...
      try {
         byte[] var5 = HttpPipeline.get(textureUrl, Minecraft.getMinecraft().getProxy());
         BufferedImage image = ImageIO.read(new ByteArrayInputStream(var5));
         return image;
      } catch (IOException var51) {
         Config.warn("Error loading item texture " + texturePath + ": " + var51.getClass().getName() + ": " + var51.getMessage());
         return null;
      }
   }
   ...
   private PlayerItemModel downloadModel(String modelPath) {
      ...
      try {
         byte[] var9 = HttpPipeline.get(modelUrl, Minecraft.getMinecraft().getProxy());
         String jsonStr = new String(var9, "ASCII");
         ...
         Config.warn("Error loading item model " + modelPath + ": " + var91.getClass().getName() + ": " + var91.getMessage());
         return null;
      }
   }
}
