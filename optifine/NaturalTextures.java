...
public class NaturalTextures {
   ...
   public static void update() {
      ...
      if(Config.isNaturalTextures()) {
         ...
         try {
            ResourceLocation var16 = new ResourceLocation(fileName);
            if(!Config.hasResource(var16)) {
            ...
            propertiesByIndex = (NaturalProperties[])((NaturalProperties[])((NaturalProperties[])list.toArray(new NaturalProperties[list.size()])));
   ...
   private static NaturalProperties[] makeDefaultProperties() {
      ...
      NaturalProperties[] terrainProps = (NaturalProperties[])((NaturalProperties[])((NaturalProperties[])propsList.toArray(new NaturalProperties[propsList.size()])));
      return terrainProps;
   }
