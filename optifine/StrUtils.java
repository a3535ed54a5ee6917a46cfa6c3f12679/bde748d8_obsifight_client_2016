   ...
   public static String[] split(String str, String separators) {
      if(str != null && str.length() > 0) {
         if(separators == null) {
            ...
            return (String[])((String[])((String[])tokens.toArray(new String[tokens.size()])));
         }
      } else {
         return new String[0];
      }
      ...
      if(strs == null) {
         ...
         if(start >= end) {
            ...
            for(int var6 = 0; var6 < strs.length; ++var6) {
               String str = strs[var6];
               if(var6 < start || var6 >= end) {
                  list.add(str);
               }
            }

            String[] var61 = (String[])((String[])list.toArray(new String[list.size()]));
            return var61;
         }
      } else {
         return strs;
