      ...
      if(locMcp == null) {
         ...
         for(sum = 0; sum < this.resourceLocations.length; ++sum) {
            ...
            if(i <= 1) {
               ...
               ResourceLocation var6 = RandomMobs.getLocationIndexed(locMcp, i);
               if(var6 == null) {
                  Config.warn("Invalid path: " + this.baseResLoc.getResourcePath());
                  return false;
               }
               ...
               this.resourceLocations[sum] = var6;
            }
         }
         ...
         if(this.weights != null) {
            ...
            if(this.weights.length > this.resourceLocations.length) {
               ...
               var71 = new int[this.resourceLocations.length];
               System.arraycopy(this.weights, 0, var71, 0, var71.length);
               this.weights = var71;
            }
            ...
            if(this.weights.length < this.resourceLocations.length) {
               ...
               var71 = new int[this.resourceLocations.length];
               System.arraycopy(this.weights, 0, var71, 0, this.weights.length);
               i = MathUtils.getAverage(this.weights);

               for(int var7 = this.weights.length; var7 < var71.length; ++var7) {
                  var71[var7] = i;
               }
