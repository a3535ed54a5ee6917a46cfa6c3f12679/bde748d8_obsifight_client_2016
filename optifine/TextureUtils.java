...
public class TextureUtils {
   ...
   public static void registerResourceListener() {
      ...
      if(rm instanceof IReloadableResourceManager) {
         IReloadableResourceManager tto1 = (IReloadableResourceManager)rm;
         IResourceManagerReloadListener ttol1 = new IResourceManagerReloadListener() {
            public void onResourceManagerReload(IResourceManager var1) {
               TextureUtils.resourcesReloaded(var1);
            }
         };
         tto1.registerReloadListener(ttol1);
      }

      ITickableTextureObject tto11 = new ITickableTextureObject() {
         public void tick() {
      ...
      ResourceLocation ttol11 = new ResourceLocation("optifine/TickableTextures");
      Config.getTextureManager().loadTickableTexture(ttol11, tto11);
   }
