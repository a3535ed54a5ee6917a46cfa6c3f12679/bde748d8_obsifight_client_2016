...
public class Reflector {
   ...
   public static void callVoid(ReflectorMethod refMethod, Object ... params) {
      try {
         Method var3 = refMethod.getTargetMethod();
         if(var3 == null) {
            return;
         }

         var3.invoke((Object)null, params);
      } catch (Throwable var31) {
         handleException(var31, (Object)null, refMethod, params);
      }
   }

   public static boolean callBoolean(ReflectorMethod refMethod, Object ... params) {
      try {
         Method var4 = refMethod.getTargetMethod();
         if(var4 == null) {
            return false;
         } else {
            Boolean retVal = (Boolean)var4.invoke((Object)null, params);
            return retVal.booleanValue();
         }
      } catch (Throwable var41) {
         handleException(var41, (Object)null, refMethod, params);
         return false;
      }
   }
   ...
   public static int callInt(ReflectorMethod refMethod, Object ... params) {
      try {
         ...
         if(var4 == null) {
            ...
            Integer retVal = (Integer)var4.invoke((Object)null, params);
   ...
   public static float callFloat(ReflectorMethod refMethod, Object ... params) {
      try {
         ...
         if(var4 == null) {
            ...
            Float retVal = (Float)var4.invoke((Object)null, params);
   ...
   public static double callDouble(ReflectorMethod refMethod, Object ... params) {
      try {
         ...
         if(var4 == null) {
            ...
            Double retVal = (Double)var4.invoke((Object)null, params);
   ...
   public static String callString(ReflectorMethod refMethod, Object ... params) {
      try {
         ...
         if(var4 == null) {
            ...
            String retVal = (String)var4.invoke((Object)null, params);
            return retVal;
         }
      } catch (Throwable var41) {
         handleException(var41, (Object)null, refMethod, params);
   ...
   public static Object call(ReflectorMethod refMethod, Object ... params) {
      try {
         ...
         if(var4 == null) {
            ...
            Object retVal = var4.invoke((Object)null, params);
            return retVal;
         }
      } catch (Throwable var41) {
         handleException(var41, (Object)null, refMethod, params);
   ...
   public static void callVoid(Object obj, ReflectorMethod refMethod, Object ... params) {
      try {
         ...
         var4.invoke(obj, params);
      } catch (Throwable var41) {
         handleException(var41, obj, refMethod, params);
      }
   }

   public static boolean callBoolean(Object obj, ReflectorMethod refMethod, Object ... params) {
      try {
         Method var5 = refMethod.getTargetMethod();
         if(var5 == null) {
            return false;
         } else {
            Boolean retVal = (Boolean)var5.invoke(obj, params);
            return retVal.booleanValue();
         }
      } catch (Throwable var51) {
         handleException(var51, obj, refMethod, params);
         return false;
      }
   }
   ...
   public static int callInt(Object obj, ReflectorMethod refMethod, Object ... params) {
      try {
         ...
         if(var5 == null) {
            ...
            Integer retVal = (Integer)var5.invoke(obj, params);
            return retVal.intValue();
         }
      } catch (Throwable var51) {
         handleException(var51, obj, refMethod, params);
   ...
   public static float callFloat(Object obj, ReflectorMethod refMethod, Object ... params) {
      try {
         ...
         if(var5 == null) {
            ...
            Float retVal = (Float)var5.invoke(obj, params);
            return retVal.floatValue();
         }
      } catch (Throwable var51) {
         handleException(var51, obj, refMethod, params);
   ...
   public static double callDouble(Object obj, ReflectorMethod refMethod, Object ... params) {
      try {
         ...
         if(var5 == null) {
            ...
            Double retVal = (Double)var5.invoke(obj, params);
            return retVal.doubleValue();
         }
      } catch (Throwable var51) {
         handleException(var51, obj, refMethod, params);
   ...
   public static String callString(Object obj, ReflectorMethod refMethod, Object ... params) {
      try {
         ...
         if(var5 == null) {
            ...
            String retVal = (String)var5.invoke(obj, params);
            return retVal;
         }
      } catch (Throwable var51) {
         handleException(var51, obj, refMethod, params);
   ...
   public static Object call(Object obj, ReflectorMethod refMethod, Object ... params) {
      try {
         ...
         if(var5 == null) {
            ...
            Object retVal = var5.invoke(obj, params);
            return retVal;
         }
      } catch (Throwable var51) {
         handleException(var51, obj, refMethod, params);
   ...
   public static Object getFieldValue(Object obj, ReflectorField refField) {
      try {
         Field var4 = refField.getTargetField();
         if(var4 == null) {
            return null;
         } else {
            Object value = var4.get(obj);
            return value;
         }
      } catch (Throwable var41) {
   ...
   public static Object newInstance(ReflectorConstructor constr, Object ... params) {
      ...
      if(c == null) {
         ...
         try {
            Object var4 = c.newInstance(params);
            return var4;
         } catch (Throwable var41) {
            handleException(var41, constr, params);
            return null;
         }
      }
   }
   ...
   public static Method[] getMethods(Class cls, String methodName) {
      ...
      for(int var6 = 0; var6 < ms.length; ++var6) {
         Method m = ms[var6];
         if(m.getName().equals(methodName)) {
            listMethods.add(m);
         }
      ...
      Method[] var61 = (Method[])((Method[])((Method[])listMethods.toArray(new Method[listMethods.size()])));
      return var61;
   }
   ...
   public static Field[] getFields(Class cls, Class fieldType) {
      ...
      try {
         ...
         Field[] var71 = (Field[])((Field[])((Field[])list.toArray(new Field[list.size()])));
         return var71;
