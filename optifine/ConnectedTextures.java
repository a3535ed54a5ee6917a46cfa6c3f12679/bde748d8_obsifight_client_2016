...
public class ConnectedTextures {
   ...
   public static IIcon getConnectedTextureSingle(IBlockAccess blockAccess, Block block, int x, int y, int z, int side, IIcon icon, boolean checkBlocks) {
      if(!(icon instanceof TextureAtlasSprite)) {
         ...
         if(tileProperties != null && Tessellator.instance.defaultTexture && iconId >= 0 && iconId < tileProperties.length) {
            ConnectedProperties[] blockId1 = tileProperties[iconId];
            if(blockId1 != null) {
               if(metadata < 0) {
                  metadata = blockAccess.getBlockMetadata(x, y, z);
               }

               IIcon cps1 = getConnectedTexture(blockId1, blockAccess, block, x, y, z, side, ts, metadata);
               if(cps1 != null) {
                  return cps1;
               }
            }
         ...
         if(blockProperties != null && checkBlocks) {
            int blockId11 = Block.getIdFromBlock(block);
            if(blockId11 >= 0 && blockId11 < blockProperties.length) {
               ConnectedProperties[] cps11 = blockProperties[blockId11];
               if(cps11 != null) {
                  if(metadata < 0) {
                     metadata = blockAccess.getBlockMetadata(x, y, z);
                  }

                  IIcon newIcon = getConnectedTexture(cps11, blockAccess, block, x, y, z, side, ts, metadata);
                  if(newIcon != null) {
                     return newIcon;
                  }
               }
      ...
      if(blockAccess == null) {
         ...
         if(tileProperties != null && Tessellator.instance.defaultTexture && iconId >= 0 && iconId < tileProperties.length) {
            ...
            if(blockId1 != null) {
               ...
               ConnectedProperties cps1 = getConnectedProperties(blockId1, blockAccess, block, x, y, z, side, ts, metadata);
               if(cps1 != null) {
                  return cps1;
               }
            }
         ...
         if(blockProperties != null) {
            ...
            if(blockId11 >= 0 && blockId11 < blockProperties.length) {
               ...
               if(cps11 != null) {
                  ...
                  ConnectedProperties cp = getConnectedProperties(cps11, blockAccess, block, x, y, z, side, ts, metadata);
                  if(cp != null) {
                     return cp;
                  }
               }
   ...
   private static IIcon getConnectedTexture(ConnectedProperties cp, IBlockAccess blockAccess, Block block, int x, int y, int z, int side, IIcon icon, int metadata) {
      if(y >= cp.minHeight && y <= cp.maxHeight) {
         int mds;
         if(cp.biomes != null) {
            BiomeGenBase var14 = blockAccess.getBiomeGenForCoords(x, z);
            boolean var15 = false;

            for(mds = 0; mds < cp.biomes.length; ++mds) {
               BiomeGenBase var16 = cp.biomes[mds];
               if(var14 == var16) {
                  var15 = true;
                  break;
               }
         ...
         if(block instanceof BlockRotatedPillar) {
            var151 = getWoodAxis(side, metadata);
            var161 = metadata & 3;
         }

         if(block instanceof BlockQuartz) {
            var151 = getQuartzAxis(side, metadata);
            if(var161 > 2) {
               var161 = 2;
            }
         }
         ...
         if(cp.metadatas != null) {
            int[] var171 = cp.metadatas;
            boolean var17 = false;

            for(int i = 0; i < var171.length; ++i) {
               if(var171[i] == var161) {
                  var17 = true;
                  break;
               }
         ...
         case 2:
            return getConnectedTextureHorizontal(cp, blockAccess, block, x, y, z, var151, side, icon, metadata);
         case 3:
            return getConnectedTextureTop(cp, blockAccess, block, x, y, z, var151, side, icon, metadata);
         case 4:
            return getConnectedTextureRandom(cp, x, y, z, side);
         case 5:
            return getConnectedTextureRepeat(cp, x, y, z, side);
         case 6:
            return getConnectedTextureVertical(cp, blockAccess, block, x, y, z, var151, side, icon, metadata);
         case 7:
            return getConnectedTextureFixed(cp);
         case 8:
            return getConnectedTextureHorizontalVertical(cp, blockAccess, block, x, y, z, var151, side, icon, metadata);
         case 9:
            return getConnectedTextureVerticalHorizontal(cp, blockAccess, block, x, y, z, var151, side, icon, metadata);
         default:
            return null;
         }
      } else {
   ...
   public static void updateIcons(TextureMap textureMap, IResourcePack rp) {
      ...
      for(int i = 0; i < names.length; ++i) {
         ...
         try {
            ResourceLocation var12 = new ResourceLocation(name);
            InputStream in = rp.getInputStream(var12);
            if(in == null) {
   ...
   private static boolean detectMultipass() {
      ...
      ConnectedProperties[] var6 = (ConnectedProperties[])((ConnectedProperties[])((ConnectedProperties[])propList.toArray(new ConnectedProperties[propList.size()])));
   ...
   private static ConnectedProperties[][] propertyListToArray(List list) {
      ...
      for(int i = 0; i < list.size(); ++i) {
         ...
         if(subList != null) {
            ConnectedProperties[] subArr = (ConnectedProperties[])((ConnectedProperties[])((ConnectedProperties[])subList.toArray(new ConnectedProperties[subList.size()])));
            propArr[i] = subArr;
         }
      }
   ...
   private static String[] getDefaultCtmPaths() {
      ...
      for(int var5 = 0; var5 < colors.length; ++var5) {
         String color = colors[var5];
         if(Config.isFromDefaultResourcePack(new ResourceLocation("textures/blocks/glass_" + color + ".png"))) {
            list.add(defPath + var5 + "_glass_" + color + "/glass_" + color + ".properties");
            list.add(defPath + var5 + "_glass_" + color + "/glass_pane_" + color + ".properties");
         }
      }

      String[] var51 = (String[])((String[])((String[])list.toArray(new String[list.size()])));
      return var51;
   }
