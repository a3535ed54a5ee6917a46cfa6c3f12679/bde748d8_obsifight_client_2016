...
public class ConnectedParser {
   ...
   public MatchBlock[] parseMatchBlocks(String propMatchBlocks) {
      if(propMatchBlocks == null) {
         ...
         for(int var7 = 0; var7 < blockStrs.length; ++var7) {
            String blockStr = blockStrs[var7];
         ...
         MatchBlock[] var71 = (MatchBlock[])((MatchBlock[])((MatchBlock[])list.toArray(new MatchBlock[list.size()])));
         return var71;
      }
   }
   ...
   public MatchBlock[] parseMatchBlock(String blockStr) {
      if(blockStr == null) {
         ...
         if(blockStr.length() <= 0) {
            ...
            String[] params = (String[])((String[])Arrays.copyOfRange(parts, var14 + 1, parts.length));
   ...
   public BiomeGenBase[] parseBiomes(String str) {
      if(str == null) {
         ...
         for(int var7 = 0; var7 < biomeNames.length; ++var7) {
            String biomeName = biomeNames[var7];
         ...
         BiomeGenBase[] var71 = (BiomeGenBase[])((BiomeGenBase[])((BiomeGenBase[])list.toArray(new BiomeGenBase[list.size()])));
         return var71;
      }
   }
   ...
   public int[] parseIntList(String str) {
      if(str == null) {
         ...
         for(int var10 = 0; var10 < intStrs.length; ++var10) {
            String var11 = intStrs[var10];
            if(var11.contains("-")) {
               String[] var12 = Config.tokenize(var11, "-");
               if(var12.length != 2) {
                  this.warn("Invalid interval: " + var11 + ", when parsing: " + str);
               } else {
                  int min = Config.parseInt(var12[0], -1);
               ...
               int var121 = Config.parseInt(var11, -1);
               if(var121 < 0) {
                  this.warn("Invalid number: " + var11 + ", when parsing: " + str);
               } else {
                  list.add(Integer.valueOf(var121));
               }
            }
         }

         int[] var101 = new int[list.size()];

         for(int var111 = 0; var111 < var101.length; ++var111) {
            var101[var111] = ((Integer)list.get(var111)).intValue();
         }
   ...
   public static int parseColor(String str, int defVal) {
      if(str == null) {
         ...
         try {
            int var3 = Integer.parseInt(str, 16) & 16777215;
            return var3;
