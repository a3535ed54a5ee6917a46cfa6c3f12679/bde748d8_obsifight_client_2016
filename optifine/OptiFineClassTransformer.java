      ...
      try {
         ...
         for(int i = 0; i < urls.length; ++i) {
            ...
            if(zipFile != null) {
               ...
               this.ofVer = Installer.getOptiFineVersion(this.ofZipFile);
               this.mcVer = Installer.getMinecraftVersionFromOfVersion(this.ofVer);
               dbg("OptiFine Version: " + this.ofVer);
               dbg("Minecraft Version: " + this.mcVer);
