...
public class GuiWorkSurface extends GuiContainer {
   private static final ResourceLocation field_147019_u = new ResourceLocation("textures/gui/container/worksurface.png");

   public GuiWorkSurface(InventoryPlayer p_i46397_1_, World p_i46397_2_, int p_i46397_3_, int p_i46397_4_, int p_i46397_5_) {
      super(new ContainerWorkSurface(p_i46397_1_, p_i46397_2_, p_i46397_3_, p_i46397_4_, p_i46397_5_));
   }
