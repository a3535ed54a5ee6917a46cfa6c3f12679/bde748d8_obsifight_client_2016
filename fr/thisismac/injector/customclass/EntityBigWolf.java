...
public class EntityBigWolf extends EntityMob {
   private static final String __OBFID = "CL_00001699";

   public EntityBigWolf(World p_i1743_1_) {
      super(p_i1743_1_);
   ...
   public IEntityLivingData onSpawnWithEgg(IEntityLivingData p_110161_1_) {
      ...
      if(p_110161_1_1 == null) {
         p_110161_1_1 = new EntityBigWolf.GroupData();
         if(this.worldObj.difficultySetting == EnumDifficulty.HARD && this.worldObj.rand.nextFloat() < 0.1F * this.worldObj.func_147462_b(this.posX, this.posY, this.posZ)) {
            ((EntityBigWolf.GroupData)p_110161_1_1).func_111104_a(this.worldObj.rand);
         }
      }

      if(p_110161_1_1 instanceof EntityBigWolf.GroupData) {
         int var4 = ((EntityBigWolf.GroupData)p_110161_1_1).field_111105_a;
