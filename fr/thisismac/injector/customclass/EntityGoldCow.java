...
public class EntityGoldCow extends EntityAnimal {
   public EntityGoldCow(World p_i1683_1_) {
      super(p_i1683_1_);
   ...
   protected void dropFewItems(boolean p_70628_1_, int p_70628_2_) {
      ...
      for(var4 = 0; var4 < var3; ++var4) {
         this.func_145779_a(Items.golden_apple, 1);
      }

      var3 = this.rand.nextInt(10) + 1 + this.rand.nextInt(1 + p_70628_2_);

      for(var4 = 0; var4 < var3; ++var4) {
         if(var3 == 1) {
            this.func_145778_a(Items.golden_apple, 1, 1.0F);
         }
      }
   ...
   public EntityGoldCow createChild(EntityAgeable p_90011_1_) {
      return new EntityGoldCow(this.worldObj);
   }
