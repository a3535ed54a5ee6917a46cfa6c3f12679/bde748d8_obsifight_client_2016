...
public class GuiButtonWiki extends GuiButton {
   private static final ResourceLocation texture = new ResourceLocation("textures/gui/wiki.png");

   public GuiButtonWiki(int p_i1041_1_, int p_i1041_2_, int p_i1041_3_) {
