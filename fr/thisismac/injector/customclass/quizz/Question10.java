...
public class Question10 extends GuiScreen {
   ...
   public Question10(Minecraft minecraft, World theWorld) {
      mc = minecraft;
      this.world = theWorld;
      this.xSize = 256;
      this.ySize = 256;
   ...
   public void drawScreen(int i, int j, float f) {
      ...
      drawRect(this.width / 2 - 100, this.height - 27, this.width / 2 - 100 + 180, this.height - 16, -267739136);
      this.drawCenteredString(this.fontRendererObj, ChatFormatting.GRAY + "Progression", this.width / 2, this.height - 40, 16777215);
      this.drawCenteredString(this.fontRendererObj, ChatFormatting.GREEN + "90%", this.width / 2, this.height - 13, 16777215);
   ...
   protected void drawBackgroundImage() {
      ...
      this.drawString(this.fontRendererObj, "nn ?", this.width / 2 - 85, this.height / 4 + 20 + 0, 10526880);
      this.drawString(this.fontRendererObj, "ui", this.width / 2 - 55, this.height / 4 + 55 + 0, 10526880);
      this.drawString(this.fontRendererObj, "tg", this.width / 2 - 55, this.height / 4 + 100 + 0, 10526880);
      this.drawString(this.fontRendererObj, "xc", this.width / 2 - 55, this.height / 4 + 145 + 0, 10526880);
      this.drawString(this.fontRendererObj, "rush b", this.width / 2 - 55, this.height / 4 + 190 + 0, 10526880);
   }
   ...
   protected void actionPerformed(GuiButton guibutton) {
      if(guibutton.enabled) {
         if(guibutton.id == 2) {
            ++Calculator.points;
            Calculator.question10 = true;
            mc.displayGuiScreen(new GuiFinal(mc, mc.theWorld));
         }

         if(guibutton.id == 3 || guibutton.id == 4 || guibutton.id == 5) {
            Calculator.question10 = false;
            mc.displayGuiScreen(new GuiFinal(mc, mc.theWorld));
         }
      }
   }
