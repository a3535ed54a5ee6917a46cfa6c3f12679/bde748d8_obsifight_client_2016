...
public class GuiButtonQuestion extends GuiButton {
   private static final ResourceLocation texture = new ResourceLocation("textures/custom/social/check.png");

   public GuiButtonQuestion(int p_i1041_1_, int p_i1041_2_, int p_i1041_3_) {
