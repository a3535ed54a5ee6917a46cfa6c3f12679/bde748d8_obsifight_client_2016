...
public class GuiButtonTeamspeak extends GuiButton {
   private static final ResourceLocation texture = new ResourceLocation("textures/gui/button_teamspeak.png");

   public GuiButtonTeamspeak(int p_i1041_1_, int p_i1041_2_, int p_i1041_3_) {
