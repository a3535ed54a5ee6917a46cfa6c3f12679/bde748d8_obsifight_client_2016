...
public class ButtonCraft extends GuiButton {
   private static final ResourceLocation texture = new ResourceLocation("textures/gui/craft.png");

   public ButtonCraft(int p_i1041_1_, int p_i1041_2_, int p_i1041_3_) {
