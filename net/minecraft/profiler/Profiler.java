...
public class Profiler {
   ...
   public List getProfilingData(String par1Str) {
      ...
      if(!this.profilerLocalEnabled) {
         ...
         while(var10.hasNext()) {
            String var201 = (String)var10.next();
            if(var201.length() > par1Str.length() && var201.startsWith(par1Str) && var201.indexOf(".", par1Str.length() + 1) < 0) {
               var8 += ((Long)this.profilingMap.get(var201)).longValue();
            }
         }

         float var2011 = (float)var8;
         if(var8 < var5) {
            var8 = var5;
         }
         ...
         if((float)var8 > var2011) {
            var7.add(new Profiler.Result("unspecified", (double)((float)var8 - var2011) * 100.0D / (double)var8, (double)((float)var8 - var2011) * 100.0D / (double)var3));
         }
