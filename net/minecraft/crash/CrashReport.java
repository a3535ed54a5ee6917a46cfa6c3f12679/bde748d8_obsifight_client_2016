...
public class CrashReport {
   ...
   private void populateEnvironment() {
      ...
      this.theReportCategory.addCrashSectionCallable("IntCache", new Callable() {
         ...
         public String call1() throws SecurityException, NoSuchFieldException, IllegalAccessException, IllegalArgumentException {
   ...
   public void getSectionsInStringBuilder(StringBuilder par1StringBuilder) {
      if((this.stacktrace == null || this.stacktrace.length <= 0) && this.crashReportSections.size() > 0) {
         this.stacktrace = (StackTraceElement[])((StackTraceElement[])((StackTraceElement[])ArrayUtils.subarray(((CrashReportCategory)this.crashReportSections.get(0)).func_147152_a(), 0, 1)));
      }

      if(this.stacktrace != null && this.stacktrace.length > 0) {
         par1StringBuilder.append("-- Head --\n");
         par1StringBuilder.append("Stacktrace:\n");
         StackTraceElement[] var61 = this.stacktrace;
         int var71 = var61.length;

         for(int var4 = 0; var4 < var71; ++var4) {
            StackTraceElement var5 = var61[var4];
   ...
   public boolean saveToFile(File p_147149_1_) {
      if(this.crashReportFile != null) {
         ...
         try {
            FileWriter var31 = new FileWriter(p_147149_1_);
            var31.write(this.getCompleteReport());
            var31.close();
