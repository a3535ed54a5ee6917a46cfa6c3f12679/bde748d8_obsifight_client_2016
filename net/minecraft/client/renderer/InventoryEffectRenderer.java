      ...
      if(!var4.isEmpty()) {
         ...
         for(Iterator var6 = mc.thePlayer.getActivePotionEffects().iterator(); var6.hasNext(); var2 += var5) {
            ...
            if(var8.hasStatusIcon()) {
               int var11 = var8.getStatusIconIndex();
               this.drawTexturedModalRect(var1 + 6, var2 + 7, 0 + var11 % 8 * 18, 198 + var11 / 8 * 18, 18, 18);
            }

            String var111 = I18n.format(var8.getName(), new Object[0]);
            if(var7.getAmplifier() == 1) {
               var111 = var111 + " " + I18n.format("enchantment.level.2", new Object[0]);
            } else if(var7.getAmplifier() == 2) {
               var111 = var111 + " " + I18n.format("enchantment.level.3", new Object[0]);
            } else if(var7.getAmplifier() == 3) {
               var111 = var111 + " " + I18n.format("enchantment.level.4", new Object[0]);
            }

            this.fontRendererObj.drawStringWithShadow(var111, var1 + 10 + 18, var2 + 6, 16777215);
