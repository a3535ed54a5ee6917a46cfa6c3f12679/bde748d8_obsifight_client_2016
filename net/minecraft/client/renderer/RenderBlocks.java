...
public class RenderBlocks {
   ...
   public boolean renderBlockBrewingStand(BlockBrewingStand p_147741_1_, int p_147741_2_, int p_147741_3_, int p_147741_4_) {
      ...
      if(EntityRenderer.anaglyphEnable) {
         float var311 = (var7 * 30.0F + var8 * 59.0F + var9 * 11.0F) / 100.0F;
         float var321 = (var7 * 30.0F + var8 * 70.0F) / 100.0F;
      ...
      if(Config.isConnectedTextures() && this.overrideBlockTexture == null) {
         var31 = ConnectedTextures.getConnectedTexture(this.blockAccess, p_147741_1_, p_147741_2_, p_147741_3_, p_147741_4_, -1, var31);
      }
   ...
   public boolean renderBlockCauldron(BlockCauldron p_147785_1_, int p_147785_2_, int p_147785_3_, int p_147785_4_) {
      ...
      float var11;
      if(EntityRenderer.anaglyphEnable) {
         float var151 = (var7 * 30.0F + var8 * 59.0F + var9 * 11.0F) / 100.0F;
         var11 = (var7 * 30.0F + var8 * 70.0F) / 100.0F;
         float var161 = (var7 * 30.0F + var9 * 70.0F) / 100.0F;
         var7 = var151;
         var8 = var11;
         var9 = var161;
      }
      ...
      var5.setColorOpaque_F(var7, var8, var9);
      IIcon var1511 = p_147785_1_.getBlockTextureFromSide(2);
      var11 = 0.125F;
      this.renderFaceXPos(p_147785_1_, (double)((float)p_147785_2_ - 1.0F + var11), (double)p_147785_3_, (double)p_147785_4_, var1511);
      this.renderFaceXNeg(p_147785_1_, (double)((float)p_147785_2_ + 1.0F - var11), (double)p_147785_3_, (double)p_147785_4_, var1511);
      this.renderFaceZPos(p_147785_1_, (double)p_147785_2_, (double)p_147785_3_, (double)((float)p_147785_4_ - 1.0F + var11), var1511);
      this.renderFaceZNeg(p_147785_1_, (double)p_147785_2_, (double)p_147785_3_, (double)((float)p_147785_4_ + 1.0F - var11), var1511);
      IIcon var1611 = BlockCauldron.func_150026_e("inner");
      this.renderFaceYPos(p_147785_1_, (double)p_147785_2_, (double)((float)p_147785_3_ - 1.0F + 0.25F), (double)p_147785_4_, var1611);
      this.renderFaceYNeg(p_147785_1_, (double)p_147785_2_, (double)((float)p_147785_3_ + 1.0F - 0.75F), (double)p_147785_4_, var1611);
   ...
   public boolean renderBlockFlowerpot(BlockFlowerPot p_147752_1_, int p_147752_2_, int p_147752_3_, int p_147752_4_) {
      ...
      if(EntityRenderer.anaglyphEnable) {
         ...
         float var211 = (var8 * 30.0F + var9 * 70.0F) / 100.0F;
         float var221 = (var8 * 30.0F + var10 * 70.0F) / 100.0F;
         var8 = var11;
         var9 = var211;
         var10 = var221;
      }
      ...
      TileEntity var2111 = this.blockAccess.getTileEntity(p_147752_2_, p_147752_3_, p_147752_4_);
      if(var2111 != null && var2111 instanceof TileEntityFlowerPot) {
         Item var2211 = ((TileEntityFlowerPot)var2111).func_145965_a();
         int var14 = ((TileEntityFlowerPot)var2111).func_145966_b();
         if(var2211 instanceof ItemBlock) {
            Block var15 = Block.getBlockFromItem(var2211);
   ...
   public float renderBlockAnvilRotate(BlockAnvil p_147737_1_, int p_147737_2_, int p_147737_3_, int p_147737_4_, int p_147737_5_, float p_147737_6_, float p_147737_7_, float p_147737_8_, float p_147737_9_, boolean p_147737_10_, boolean p_147737_11_, int p_147737_12_) {
      ...
      if(p_147737_11_) {
         Tessellator var1411 = Tessellator.instance;
         var1411.startDrawingQuads();
         var1411.setNormal(0.0F, -1.0F, 0.0F);
         ...
         var1411.draw();
         var1411.startDrawingQuads();
         var1411.setNormal(0.0F, 0.0F, -1.0F);
         ...
         var1411.draw();
         var1411.startDrawingQuads();
         var1411.setNormal(-1.0F, 0.0F, 0.0F);
   ...
   public boolean renderBlockLever(Block p_147790_1_, int p_147790_2_, int p_147790_3_, int p_147790_4_) {
      ...
      for(int var311 = 0; var311 < 8; ++var311) {
         if(var7) {
            var22[var311].zCoord -= 0.0625D;
            var22[var311].rotateAroundX(((float)Math.PI * 2F / 9F));
         } else {
            var22[var311].zCoord += 0.0625D;
            var22[var311].rotateAroundX(-((float)Math.PI * 2F / 9F));
         }
         ...
         if(var6 == 0 || var6 == 7) {
            var22[var311].rotateAroundZ((float)Math.PI);
         }

         if(var6 == 6 || var6 == 0) {
            var22[var311].rotateAroundY(((float)Math.PI / 2F));
         }

         if(var6 > 0 && var6 < 5) {
            var22[var311].yCoord -= 0.375D;
            var22[var311].rotateAroundX(((float)Math.PI / 2F));
            if(var6 == 4) {
               var22[var311].rotateAroundY(0.0F);
            }

            if(var6 == 3) {
               var22[var311].rotateAroundY((float)Math.PI);
            }
            ...
            var22[var311].xCoord += (double)p_147790_2_ + 0.5D;
            var22[var311].yCoord += (double)((float)p_147790_3_ + 0.5F);
            var22[var311].zCoord += (double)p_147790_4_ + 0.5D;
         } else if(var6 != 0 && var6 != 7) {
            var22[var311].xCoord += (double)p_147790_2_ + 0.5D;
            var22[var311].yCoord += (double)((float)p_147790_3_ + 0.125F);
            var22[var311].zCoord += (double)p_147790_4_ + 0.5D;
         } else {
            var22[var311].xCoord += (double)p_147790_2_ + 0.5D;
            var22[var311].yCoord += (double)((float)p_147790_3_ + 0.875F);
            var22[var311].zCoord += (double)p_147790_4_ + 0.5D;
         }
      }
   ...
   public boolean renderBlockTripWireSource(Block p_147723_1_, int p_147723_2_, int p_147723_3_, int p_147723_4_) {
      ...
      for(int var601 = 0; var601 < 8; ++var601) {
         var26[var601].zCoord += 0.0625D;
         if(var9) {
            var26[var601].rotateAroundX(0.5235988F);
            var26[var601].yCoord -= 0.4375D;
         } else if(var8) {
            var26[var601].rotateAroundX(0.08726647F);
            var26[var601].yCoord -= 0.4375D;
         } else {
            var26[var601].rotateAroundX(-((float)Math.PI * 2F / 9F));
            var26[var601].yCoord -= 0.375D;
         }

         var26[var601].rotateAroundX(((float)Math.PI / 2F));
         if(var7 == 2) {
            var26[var601].rotateAroundY(0.0F);
         }

         if(var7 == 0) {
            var26[var601].rotateAroundY((float)Math.PI);
         }

         if(var7 == 1) {
            var26[var601].rotateAroundY(((float)Math.PI / 2F));
         }
         ...
         var26[var601].xCoord += (double)p_147723_2_ + 0.5D;
         var26[var601].yCoord += (double)((float)p_147723_3_ + 0.3125F);
         var26[var601].zCoord += (double)p_147723_4_ + 0.5D;
      }
      ...
      for(int var611 = 0; var611 < 6; ++var611) {
         if(var611 == 0) {
            var60 = var26[0];
            var31 = var26[1];
            var32 = var26[2];
      ...
      for(int var621 = 0; var621 < 8; ++var621) {
         var26[var621].zCoord += 0.21875D;
         if(var9) {
            var26[var621].yCoord -= 0.09375D;
            var26[var621].zCoord -= 0.1625D;
            var26[var621].rotateAroundX(0.0F);
         } else if(var8) {
            var26[var621].yCoord += 0.015625D;
            var26[var621].zCoord -= 0.171875D;
            var26[var621].rotateAroundX(0.17453294F);
         } else {
            var26[var621].rotateAroundX(0.87266463F);
         }

         if(var7 == 2) {
            var26[var621].rotateAroundY(0.0F);
         }

         if(var7 == 0) {
            var26[var621].rotateAroundY((float)Math.PI);
         }

         if(var7 == 1) {
            var26[var621].rotateAroundY(((float)Math.PI / 2F));
         }
         ...
         var26[var621].xCoord += (double)p_147723_2_ + 0.5D;
         var26[var621].yCoord += (double)((float)p_147723_3_ + 0.3125F);
         var26[var621].zCoord += (double)p_147723_4_ + 0.5D;
      }
   ...
   public boolean renderBlockRedstoneWire(Block p_147788_1_, int p_147788_2_, int p_147788_3_, int p_147788_4_) {
      ...
      if(rsColor != -1) {
         int var151 = rsColor >> 16 & 255;
         int green = rsColor >> 8 & 255;
         int var171 = rsColor & 255;
         var12 = (float)var151 / 255.0F;
         var13 = (float)green / 255.0F;
         var14 = (float)var171 / 255.0F;
      }

      var5.setColorOpaque_F(var12, var13, var14);
      double var1511 = 0.015625D;
      double var1711 = 0.015625D;
      ...
      if(!var27) {
         ...
         var5.addVertexWithUV((double)var23, (double)p_147788_3_ + 0.015625D, (double)var25, (double)var7.getInterpolatedU((double)var331), (double)var7.getInterpolatedV((double)var29));
         var5.addVertexWithUV((double)var23, (double)p_147788_3_ + 0.015625D, (double)var26, (double)var7.getInterpolatedU((double)var331), (double)var7.getInterpolatedV((double)var31));
         var5.setColorOpaque_F(1.0F, 1.0F, 1.0F);
         ...
         var5.addVertexWithUV((double)var23, (double)p_147788_3_ + 0.015625D, (double)var25, (double)var9.getInterpolatedU((double)var331), (double)var9.getInterpolatedV((double)var29));
         var5.addVertexWithUV((double)var23, (double)p_147788_3_ + 0.015625D, (double)var26, (double)var9.getInterpolatedU((double)var331), (double)var9.getInterpolatedV((double)var31));
      } else if(var27) {
   ...
   public boolean renderBlockVine(Block p_147726_1_, int p_147726_2_, int p_147726_3_, int p_147726_4_) {
      ...
      if(Config.isConnectedTextures() && this.overrideBlockTexture == null) {
         ...
         var6 = ConnectedTextures.getConnectedTexture(this.blockAccess, p_147726_1_, p_147726_2_, p_147726_3_, p_147726_4_, var71, var6);
      }

      var5.setBrightness(p_147726_1_.getBlockBrightness(this.blockAccess, p_147726_2_, p_147726_3_, p_147726_4_));
      int var711 = CustomColorizer.getColorMultiplier(p_147726_1_, this.blockAccess, p_147726_2_, p_147726_3_, p_147726_4_);
      float var8 = (float)(var711 >> 16 & 255) / 255.0F;
      float var9 = (float)(var711 >> 8 & 255) / 255.0F;
      float var10 = (float)(var711 & 255) / 255.0F;
      var5.setColorOpaque_F(var8, var9, var10);
   ...
   public boolean renderBlockStainedGlassPane(Block block, int x, int y, int z) {
      ...
      float var10 = (float)(var7 & 255) / 255.0F;
      if(EntityRenderer.anaglyphEnable) {
         float isStainedGlass1 = (var8 * 30.0F + var9 * 59.0F + var10 * 11.0F) / 100.0F;
         float metadata = (var8 * 30.0F + var9 * 70.0F) / 100.0F;
         float iconGlass1 = (var8 * 30.0F + var10 * 70.0F) / 100.0F;
         var8 = isStainedGlass1;
         var9 = metadata;
         var10 = iconGlass1;
      }

      var6.setColorOpaque_F(var8, var9, var10);
      boolean isStainedGlass11 = block instanceof BlockStainedGlassPane;
      int metadata1 = 0;
      IIcon iconGlassPaneTop1;
      IIcon iconGlass11;
      if(this.hasOverrideBlockTexture()) {
         iconGlass11 = this.overrideBlockTexture;
         iconGlassPaneTop1 = this.overrideBlockTexture;
      } else {
         metadata1 = this.blockAccess.getBlockMetadata(x, y, z);
         iconGlass11 = this.getBlockIconFromSideAndMetadata(block, 0, metadata1);
         iconGlassPaneTop1 = isStainedGlass11?((BlockStainedGlassPane)block).func_150104_b(metadata1):((BlockPane)block).func_150097_e();
      }

      IIcon iconZ = iconGlass11;
      boolean drawTop = true;
      boolean drawBottom = true;
      if(Config.isConnectedTextures() && this.overrideBlockTexture == null) {
         IIcon gMinU1 = ConnectedTextures.getConnectedTexture(this.blockAccess, block, x, y, z, 4, iconGlass11);
         IIcon iz = ConnectedTextures.getConnectedTexture(this.blockAccess, block, x, y, z, 3, iconGlass11);
         if(gMinU1 != iconGlass11 || iz != iconGlass11) {
            BlockPane gHalf7U1 = (BlockPane)block;
            drawTop = this.blockAccess.getBlock(x, y + 1, z) != block || this.blockAccess.getBlockMetadata(x, y + 1, z) != metadata1;
            drawBottom = this.blockAccess.getBlock(x, y - 1, z) != block || this.blockAccess.getBlockMetadata(x, y - 1, z) != metadata1;
         }
      ...
      double gMinU11 = (double)iconGlass11.getMinU();
      double gHalf7U11 = (double)iconGlass11.getInterpolatedU(7.0D);
      double gHalf9U = (double)iconGlass11.getInterpolatedU(9.0D);
      double gMaxU = (double)iconGlass11.getMaxU();
      double gMinV = (double)iconGlass11.getMinV();
      double gMaxV = (double)iconGlass11.getMaxV();
      ...
      boolean connZNeg = isStainedGlass11?((BlockStainedGlassPane)block).func_150098_a(this.blockAccess.getBlock(x, y, z - 1)):((BlockPane)block).func_150098_a(this.blockAccess.getBlock(x, y, z - 1));
      boolean connZPos = isStainedGlass11?((BlockStainedGlassPane)block).func_150098_a(this.blockAccess.getBlock(x, y, z + 1)):((BlockPane)block).func_150098_a(this.blockAccess.getBlock(x, y, z + 1));
      boolean connXNeg = isStainedGlass11?((BlockStainedGlassPane)block).func_150098_a(this.blockAccess.getBlock(x - 1, y, z)):((BlockPane)block).func_150098_a(this.blockAccess.getBlock(x - 1, y, z));
      boolean connXPos = isStainedGlass11?((BlockStainedGlassPane)block).func_150098_a(this.blockAccess.getBlock(x + 1, y, z)):((BlockPane)block).func_150098_a(this.blockAccess.getBlock(x + 1, y, z));
      double var58 = 0.001D;
      double var60 = 0.999D;
      double var62 = 0.001D;
      ...
      if(!connXNeg && !disconnected) {
         if(!connZNeg && !connZPos) {
            var6.addVertexWithUV(xHalfMin, yTop, zHalfMin, gHalf7U11, gMinV);
            var6.addVertexWithUV(xHalfMin, yBottom, zHalfMin, gHalf7U11, gMaxV);
      ...
      if((connXPos || disconnected) && !connXNeg) {
         ...
         var6.addVertexWithUV(xHalfMax, yTop, zHalfMax, gHalf7U11, gMinV);
         var6.addVertexWithUV(xHalfMax, yBottom, zHalfMax, gHalf7U11, gMaxV);
      ...
      if(!connZNeg && !disconnected) {
         ...
         if(!connXNeg) {
            var6.addVertexWithUV(xHalfMin, yTop, z0, gMinU11, gMinV);
            var6.addVertexWithUV(xHalfMin, yBottom, z0, gMinU11, gMaxV);
         ...
         if(!connXPos) {
            ...
            var6.addVertexWithUV(xHalfMax, yBottom, z0, gMinU11, gMaxV);
            var6.addVertexWithUV(xHalfMax, yTop, z0, gMinU11, gMinV);
         } else {
            var6.addVertexWithUV(xHalfMax, yTop, zHalfMin, gHalf7U11, gMinV);
            var6.addVertexWithUV(xHalfMax, yBottom, zHalfMin, gHalf7U11, gMaxV);
            var6.addVertexWithUV(xHalfMax, yBottom, z0, gMinU11, gMaxV);
            var6.addVertexWithUV(xHalfMax, yTop, z0, gMinU11, gMinV);
            var6.addVertexWithUV(xHalfMax, yTop, z1, gMaxU, gMinV);
            var6.addVertexWithUV(xHalfMax, yBottom, z1, gMaxU, gMaxV);
      ...
      if(disconnected) {
         var6.addVertexWithUV(x0, yTop, zHalfMin, gHalf7U11, gMinV);
         var6.addVertexWithUV(x0, yBottom, zHalfMin, gHalf7U11, gMaxV);
         var6.addVertexWithUV(x0, yBottom, zHalfMax, gHalf9U, gMaxV);
         var6.addVertexWithUV(x0, yTop, zHalfMax, gHalf9U, gMinV);
         var6.addVertexWithUV(x1, yTop, zHalfMax, gHalf7U11, gMinV);
         var6.addVertexWithUV(x1, yBottom, zHalfMax, gHalf7U11, gMaxV);
   ...
   public boolean renderBlockPane(BlockPane p_147767_1_, int p_147767_2_, int p_147767_3_, int p_147767_4_) {
      ...
      float var10 = (float)(var7 & 255) / 255.0F;
      if(EntityRenderer.anaglyphEnable) {
         float var631 = (var8 * 30.0F + var9 * 59.0F + var10 * 11.0F) / 100.0F;
         float var641 = (var8 * 30.0F + var9 * 70.0F) / 100.0F;
         float kr2 = (var8 * 30.0F + var10 * 70.0F) / 100.0F;
         var8 = var631;
         var9 = var641;
         var10 = kr2;
      }
      ...
      IIcon var6411;
      if(this.hasOverrideBlockTexture()) {
         var6311 = this.overrideBlockTexture;
         var6411 = this.overrideBlockTexture;
      } else {
         int kr21 = this.blockAccess.getBlockMetadata(p_147767_2_, p_147767_3_, p_147767_4_);
         var6311 = this.getBlockIconFromSideAndMetadata(p_147767_1_, 0, kr21);
         var6411 = p_147767_1_.func_150097_e();
      }
      ...
      IIcon kzr = var6311;
      if(Config.isConnectedTextures() && this.overrideBlockTexture == null) {
         var6311 = ConnectedTextures.getConnectedTexture(this.blockAccess, p_147767_1_, p_147767_2_, p_147767_3_, p_147767_4_, 2, var6311);
         kr22 = ConnectedTextures.getConnectedTexture(this.blockAccess, p_147767_1_, p_147767_2_, p_147767_3_, p_147767_4_, 3, kr22);
      ...
      double var65 = (double)var6311.getMinU();
      double var15 = (double)var6311.getInterpolatedU(8.0D);
      double var17 = (double)var6311.getMaxU();
      double var19 = (double)var6311.getMinV();
      double var21 = (double)var6311.getMaxV();
      double dr = (double)kr22.getMinU();
      double d1r = (double)kr22.getInterpolatedU(8.0D);
      double d2r = (double)kr22.getMaxU();
      double d3r = (double)kr22.getMinV();
      double d4r = (double)kr22.getMaxV();
      ...
      double var23 = (double)var6411.getInterpolatedU(7.0D);
      double var25 = (double)var6411.getInterpolatedU(9.0D);
      double var27 = (double)var6411.getMinV();
      double var29 = (double)var6411.getInterpolatedV(8.0D);
      double var31 = (double)var6411.getMaxV();
   ...
   public boolean renderCrossedSquares(Block p_147746_1_, int p_147746_2_, int p_147746_3_, int p_147746_4_) {
      ...
      float var9 = (float)(var6 & 255) / 255.0F;
      if(EntityRenderer.anaglyphEnable) {
         float var181 = (var7 * 30.0F + var8 * 59.0F + var9 * 11.0F) / 100.0F;
         float var11 = (var7 * 30.0F + var8 * 70.0F) / 100.0F;
         float var191 = (var7 * 30.0F + var9 * 70.0F) / 100.0F;
         var7 = var181;
         var8 = var11;
         var9 = var191;
      }
      ...
      var5.setColorOpaque_F(var7, var8, var9);
      double var1811 = (double)p_147746_2_;
      double var1911 = (double)p_147746_3_;
      ...
      if(p_147746_1_ == Blocks.tallgrass) {
         ...
         var1811 += ((double)((float)(var16 >> 16 & 15L) / 15.0F) - 0.5D) * 0.5D;
         var1911 += ((double)((float)(var16 >> 20 & 15L) / 15.0F) - 1.0D) * 0.2D;
         var14 += ((double)((float)(var16 >> 24 & 15L) / 15.0F) - 0.5D) * 0.5D;
      } else if(p_147746_1_ == Blocks.red_flower || p_147746_1_ == Blocks.yellow_flower) {
         var16 = (long)(p_147746_2_ * 3129871) ^ (long)p_147746_4_ * 116129781L ^ (long)p_147746_3_;
         var16 = var16 * var16 * 42317861L + var16 * 11L;
         var1811 += ((double)((float)(var16 >> 16 & 15L) / 15.0F) - 0.5D) * 0.3D;
      ...
      this.drawCrossedSquares(var20, var1811, var1911, var14, 1.0F);
   ...
   public boolean renderBlockDoublePlant(BlockDoublePlant p_147774_1_, int p_147774_2_, int p_147774_3_, int p_147774_4_) {
      ...
      float var9 = (float)(var6 & 255) / 255.0F;
      if(EntityRenderer.anaglyphEnable) {
         float var581 = (var7 * 30.0F + var8 * 59.0F + var9 * 11.0F) / 100.0F;
         float var11 = (var7 * 30.0F + var8 * 70.0F) / 100.0F;
         float var591 = (var7 * 30.0F + var9 * 70.0F) / 100.0F;
         var7 = var581;
         var8 = var11;
         var9 = var591;
      }
      ...
      var5.setColorOpaque_F(var7, var8, var9);
      long var5811 = (long)(p_147774_2_ * 3129871) ^ (long)p_147774_4_ * 116129781L;
      var5811 = var5811 * var5811 * 42317861L + var5811 * 11L;
      double var5911 = (double)p_147774_2_;
      double var14 = (double)p_147774_3_;
      double var16 = (double)p_147774_4_;
      var5911 += ((double)((float)(var5811 >> 16 & 15L) / 15.0F) - 0.5D) * 0.3D;
      var16 += ((double)((float)(var5811 >> 24 & 15L) / 15.0F) - 0.5D) * 0.3D;
      ...
      this.drawCrossedSquares(var21, var5911, var14, var16, 1.0F);
      if(var20 && var60 == 0) {
         IIcon var22 = p_147774_1_.field_149891_b[0];
         double var23 = Math.cos((double)var5811 * 0.8D) * Math.PI * 0.1D;
         ...
         var5.addVertexWithUV(var5911 + var49, var14 + 1.0D, var16 + var51, var29, var35);
         var5.addVertexWithUV(var5911 + var53, var14 + 1.0D, var16 + var55, var33, var35);
         var5.addVertexWithUV(var5911 + var41, var14 + 0.0D, var16 + var43, var33, var31);
         var5.addVertexWithUV(var5911 + var45, var14 + 0.0D, var16 + var47, var29, var31);
         ...
         var5.addVertexWithUV(var5911 + var53, var14 + 1.0D, var16 + var55, var29, var35);
         var5.addVertexWithUV(var5911 + var49, var14 + 1.0D, var16 + var51, var33, var35);
         var5.addVertexWithUV(var5911 + var45, var14 + 0.0D, var16 + var47, var33, var31);
         var5.addVertexWithUV(var5911 + var41, var14 + 0.0D, var16 + var43, var29, var31);
      }
   ...
   public boolean renderBlockStem(Block p_147724_1_, int p_147724_2_, int p_147724_3_, int p_147724_4_) {
      ...
      float var10 = (float)(var7 & 255) / 255.0F;
      if(EntityRenderer.anaglyphEnable) {
         float var141 = (var8 * 30.0F + var9 * 59.0F + var10 * 11.0F) / 100.0F;
         float var12 = (var8 * 30.0F + var9 * 70.0F) / 100.0F;
         float var13 = (var8 * 30.0F + var10 * 70.0F) / 100.0F;
         var8 = var141;
         var9 = var12;
      ...
      int var1411 = var5.func_149873_e(this.blockAccess, p_147724_2_, p_147724_3_, p_147724_4_);
      if(var1411 < 0) {
         ...
         this.renderBlockStemBig(var5, this.blockAccess.getBlockMetadata(p_147724_2_, p_147724_3_, p_147724_4_), var1411, this.renderMaxY, (double)p_147724_2_, (double)((float)p_147724_3_ - 0.0625F), (double)p_147724_4_);
      }
   ...
   public boolean renderBlockFluids(Block p_147721_1_, int p_147721_2_, int p_147721_3_, int p_147721_4_) {
      ...
      if(!var10 && !var11 && !var12[0] && !var12[1] && !var12[2] && !var12[3]) {
         ...
         if(this.renderAllFaces || var10) {
            var13 = true;
            IIcon var571 = this.getBlockIconFromSideAndMetadata(p_147721_1_, 1, var23);
            float var581 = (float)BlockLiquid.func_149802_a(this.blockAccess, p_147721_2_, p_147721_3_, p_147721_4_, var22);
            if(var581 > -999.0F) {
               var571 = this.getBlockIconFromSideAndMetadata(p_147721_1_, 2, var23);
            }
            ...
            double var60;
            if(var581 < -999.0F) {
               var591 = (double)var571.getInterpolatedU(0.0D);
               var45 = (double)var571.getInterpolatedV(0.0D);
               var39 = var591;
               var47 = (double)var571.getInterpolatedV(16.0D);
               var41 = (double)var571.getInterpolatedU(16.0D);
               var49 = var47;
               var43 = var41;
               var60 = var45;
            } else {
               var52 = MathHelper.sin(var581) * 0.25F;
               var53 = MathHelper.cos(var581) * 0.25F;
               var54 = 8.0F;
               var591 = (double)var571.getInterpolatedU((double)(8.0F + (-var53 - var52) * 16.0F));
               var45 = (double)var571.getInterpolatedV((double)(8.0F + (-var53 + var52) * 16.0F));
               var39 = (double)var571.getInterpolatedU((double)(8.0F + (-var53 + var52) * 16.0F));
               var47 = (double)var571.getInterpolatedV((double)(8.0F + (var53 + var52) * 16.0F));
               var41 = (double)var571.getInterpolatedU((double)(8.0F + (var53 + var52) * 16.0F));
               var49 = (double)var571.getInterpolatedV((double)(8.0F + (var53 - var52) * 16.0F));
               var43 = (double)var571.getInterpolatedU((double)(8.0F + (var53 - var52) * 16.0F));
               var60 = (double)var571.getInterpolatedV((double)(8.0F + (-var53 - var52) * 16.0F));
            }
            ...
            double var61 = 3.90625E-5D;
            var5.addVertexWithUV((double)(p_147721_2_ + 0), (double)p_147721_3_ + var24, (double)(p_147721_4_ + 0), var591 + var61, var45 + var61);
            var5.addVertexWithUV((double)(p_147721_2_ + 0), (double)p_147721_3_ + var26, (double)(p_147721_4_ + 1), var39 + var61, var47 - var61);
            var5.addVertexWithUV((double)(p_147721_2_ + 1), (double)p_147721_3_ + var28, (double)(p_147721_4_ + 1), var41 - var61, var49 - var61);
            var5.addVertexWithUV((double)(p_147721_2_ + 1), (double)p_147721_3_ + var30, (double)(p_147721_4_ + 0), var43 - var61, var60 + var61);
            var5.addVertexWithUV((double)(p_147721_2_ + 0), (double)p_147721_3_ + var24, (double)(p_147721_4_ + 0), var591 + var61, var45 + var61);
            var5.addVertexWithUV((double)(p_147721_2_ + 1), (double)p_147721_3_ + var30, (double)(p_147721_4_ + 0), var43 - var61, var60 + var61);
            var5.addVertexWithUV((double)(p_147721_2_ + 1), (double)p_147721_3_ + var28, (double)(p_147721_4_ + 1), var41 - var61, var49 - var61);
            var5.addVertexWithUV((double)(p_147721_2_ + 0), (double)p_147721_3_ + var26, (double)(p_147721_4_ + 1), var39 + var61, var47 - var61);
         ...
         for(int var57 = 0; var57 < 4; ++var57) {
            ...
            if(this.renderAllFaces || var12[var57]) {
               ...
               var13 = true;
               float var601 = var59.getInterpolatedU(0.0D);
               ...
               var5.setBrightness(p_147721_1_.getBlockBrightness(this.blockAccess, var58, p_147721_3_, var591));
               float var611 = 1.0F;
               var611 *= var57 < 2?var16:var17;
               var5.setColorOpaque_F(var15 * var611 * var7, var15 * var611 * var8, var15 * var611 * var9);
               var5.addVertexWithUV(var43, (double)p_147721_3_ + var39, var45, (double)var601, (double)var53);
               ...
               var5.addVertexWithUV(var43, (double)(p_147721_3_ + 0), var45, (double)var601, (double)var55);
               var5.addVertexWithUV(var43, (double)(p_147721_3_ + 0), var45, (double)var601, (double)var55);
               var5.addVertexWithUV(var47, (double)(p_147721_3_ + 0), var49, (double)var52, (double)var55);
               var5.addVertexWithUV(var47, (double)p_147721_3_ + var41, var49, (double)var52, (double)var54);
               var5.addVertexWithUV(var43, (double)p_147721_3_ + var39, var45, (double)var601, (double)var53);
   ...
   public boolean renderBlockHopperMetadata(BlockHopper p_147799_1_, int p_147799_2_, int p_147799_3_, int p_147799_4_, int p_147799_5_, boolean p_147799_6_) {
      ...
      if(!p_147799_6_) {
         ...
         int var241 = p_147799_1_.colorMultiplier(this.blockAccess, p_147799_2_, p_147799_3_, p_147799_4_);
         float var251 = (float)(var241 >> 16 & 255) / 255.0F;
         var13 = (float)(var241 >> 8 & 255) / 255.0F;
         float var261 = (float)(var241 & 255) / 255.0F;
         if(EntityRenderer.anaglyphEnable) {
            float var15 = (var251 * 30.0F + var13 * 59.0F + var261 * 11.0F) / 100.0F;
            float var271 = (var251 * 30.0F + var13 * 70.0F) / 100.0F;
            float var17 = (var251 * 30.0F + var261 * 70.0F) / 100.0F;
            var251 = var15;
            var13 = var271;
            var261 = var17;
         }

         var7.setColorOpaque_F(var251, var13, var261);
      }

      IIcon var2411 = BlockHopper.func_149916_e("hopper_outside");
      IIcon var2511 = BlockHopper.func_149916_e("hopper_inside");
      var13 = 0.125F;
      if(p_147799_6_) {
         var7.startDrawingQuads();
         var7.setNormal(1.0F, 0.0F, 0.0F);
         this.renderFaceXPos(p_147799_1_, (double)(-1.0F + var13), 0.0D, 0.0D, var2411);
         var7.draw();
         var7.startDrawingQuads();
         var7.setNormal(-1.0F, 0.0F, 0.0F);
         this.renderFaceXNeg(p_147799_1_, (double)(1.0F - var13), 0.0D, 0.0D, var2411);
         var7.draw();
         var7.startDrawingQuads();
         var7.setNormal(0.0F, 0.0F, 1.0F);
         this.renderFaceZPos(p_147799_1_, 0.0D, 0.0D, (double)(-1.0F + var13), var2411);
         var7.draw();
         var7.startDrawingQuads();
         var7.setNormal(0.0F, 0.0F, -1.0F);
         this.renderFaceZNeg(p_147799_1_, 0.0D, 0.0D, (double)(1.0F - var13), var2411);
         var7.draw();
         var7.startDrawingQuads();
         var7.setNormal(0.0F, 1.0F, 0.0F);
         this.renderFaceYPos(p_147799_1_, 0.0D, -1.0D + var9, 0.0D, var2511);
         var7.draw();
      } else {
         this.renderFaceXPos(p_147799_1_, (double)((float)p_147799_2_ - 1.0F + var13), (double)p_147799_3_, (double)p_147799_4_, var2411);
         this.renderFaceXNeg(p_147799_1_, (double)((float)p_147799_2_ + 1.0F - var13), (double)p_147799_3_, (double)p_147799_4_, var2411);
         this.renderFaceZPos(p_147799_1_, (double)p_147799_2_, (double)p_147799_3_, (double)((float)p_147799_4_ - 1.0F + var13), var2411);
         this.renderFaceZNeg(p_147799_1_, (double)p_147799_2_, (double)p_147799_3_, (double)((float)p_147799_4_ + 1.0F - var13), var2411);
         this.renderFaceYPos(p_147799_1_, (double)p_147799_2_, (double)((float)p_147799_3_ - 1.0F) + var9, (double)p_147799_4_, var2511);
      }

      this.setOverrideBlockTexture(var2411);
      double var2611 = 0.25D;
      double var2711 = 0.25D;
      this.setRenderBounds(var2611, var2711, var2611, 1.0D - var2611, var9 - 0.002D, 1.0D - var2611);
      if(p_147799_6_) {
         var7.startDrawingQuads();
         var7.setNormal(1.0F, 0.0F, 0.0F);
         this.renderFaceXPos(p_147799_1_, 0.0D, 0.0D, 0.0D, var2411);
         var7.draw();
         var7.startDrawingQuads();
         var7.setNormal(-1.0F, 0.0F, 0.0F);
         this.renderFaceXNeg(p_147799_1_, 0.0D, 0.0D, 0.0D, var2411);
         var7.draw();
         var7.startDrawingQuads();
         var7.setNormal(0.0F, 0.0F, 1.0F);
         this.renderFaceZPos(p_147799_1_, 0.0D, 0.0D, 0.0D, var2411);
         var7.draw();
         var7.startDrawingQuads();
         var7.setNormal(0.0F, 0.0F, -1.0F);
         this.renderFaceZNeg(p_147799_1_, 0.0D, 0.0D, 0.0D, var2411);
         var7.draw();
         var7.startDrawingQuads();
         var7.setNormal(0.0F, 1.0F, 0.0F);
         this.renderFaceYPos(p_147799_1_, 0.0D, 0.0D, 0.0D, var2411);
         var7.draw();
         var7.startDrawingQuads();
         var7.setNormal(0.0F, -1.0F, 0.0F);
         this.renderFaceYNeg(p_147799_1_, 0.0D, 0.0D, 0.0D, var2411);
         var7.draw();
      } else {
         this.renderStandardBlock(p_147799_1_, p_147799_2_, p_147799_3_, p_147799_4_);
      }
      ...
      if(!p_147799_6_) {
         ...
         if(var8 == 2) {
            this.setRenderBounds(var20, var2711, 0.0D, 1.0D - var20, var2711 + var22, var2611);
            this.renderStandardBlock(p_147799_1_, p_147799_2_, p_147799_3_, p_147799_4_);
         }

         if(var8 == 3) {
            this.setRenderBounds(var20, var2711, 1.0D - var2611, 1.0D - var20, var2711 + var22, 1.0D);
            this.renderStandardBlock(p_147799_1_, p_147799_2_, p_147799_3_, p_147799_4_);
         }

         if(var8 == 4) {
            this.setRenderBounds(0.0D, var2711, var20, var2611, var2711 + var22, 1.0D - var20);
            this.renderStandardBlock(p_147799_1_, p_147799_2_, p_147799_3_, p_147799_4_);
         }

         if(var8 == 5) {
            this.setRenderBounds(1.0D - var2611, var2711, var20, 1.0D, var2711 + var22, 1.0D - var20);
            this.renderStandardBlock(p_147799_1_, p_147799_2_, p_147799_3_, p_147799_4_);
         }
      }
   ...
   public void renderFaceYNeg(Block p_147768_1_, double p_147768_2_, double p_147768_4_, double p_147768_6_, IIcon p_147768_8_) {
      ...
      if(Config.isNaturalTextures() && this.overrideBlockTexture == null && this.uvRotateBottom == 0) {
         NaturalProperties var101 = NaturalTextures.getNaturalProperties(p_147768_8_);
         if(var101 != null) {
            int rand = Config.getRandom((int)p_147768_2_, (int)p_147768_4_, (int)p_147768_6_, 0);
            if(var101.rotation > 1) {
               this.uvRotateBottom = rand & 3;
            }

            if(var101.rotation == 2) {
      ...
      double var1011 = (double)p_147768_8_.getInterpolatedU(this.renderMinX * 16.0D);
      ...
      if(this.renderMinX < 0.0D || this.renderMaxX > 1.0D) {
         var1011 = (double)p_147768_8_.getMinU();
      ...
      var18 = var12;
      double var20 = var1011;
      double var22 = var14;
      double var24 = var16;
      double var26;
      if(this.uvRotateBottom == 2) {
         var1011 = (double)p_147768_8_.getInterpolatedU(this.renderMinZ * 16.0D);
         ...
         var1011 = (double)p_147768_8_.getInterpolatedU(16.0D - this.renderMaxZ * 16.0D);
         ...
         var1011 = (double)p_147768_8_.getInterpolatedU(16.0D - this.renderMinX * 16.0D);
      ...
      if(this.enableAO) {
         ...
         var9.addVertexWithUV(var26, var30, var32, var1011, var14);
   ...
   public void renderFaceYPos(Block p_147806_1_, double p_147806_2_, double p_147806_4_, double p_147806_6_, IIcon p_147806_8_) {
      ...
      if(Config.isNaturalTextures() && this.overrideBlockTexture == null && this.uvRotateTop == 0) {
         NaturalProperties var101 = NaturalTextures.getNaturalProperties(p_147806_8_);
         if(var101 != null) {
      ...
      double var1011 = (double)p_147806_8_.getInterpolatedU(this.renderMinX * 16.0D);
      ...
      if(this.renderMinX < 0.0D || this.renderMaxX > 1.0D) {
         var1011 = (double)p_147806_8_.getMinU();
      ...
      if(this.uvRotateTop == 1) {
         var1011 = (double)p_147806_8_.getInterpolatedU(this.renderMinZ * 16.0D);
         ...
         var1011 = (double)p_147806_8_.getInterpolatedU(16.0D - this.renderMaxZ * 16.0D);
         ...
         var1011 = (double)p_147806_8_.getInterpolatedU(16.0D - this.renderMinX * 16.0D);
   ...
   public void renderFaceZNeg(Block p_147761_1_, double p_147761_2_, double p_147761_4_, double p_147761_6_, IIcon p_147761_8_) {
      ...
      if(Config.isNaturalTextures() && this.overrideBlockTexture == null && this.uvRotateEast == 0) {
         NaturalProperties var101 = NaturalTextures.getNaturalProperties(p_147761_8_);
         if(var101 != null) {
      ...
      double var1011 = (double)p_147761_8_.getInterpolatedU(this.renderMinX * 16.0D);
      ...
      if(this.field_152631_f) {
         ...
         var1011 = (double)p_147761_8_.getInterpolatedU((1.0D - this.renderMaxX) * 16.0D);
      }
      ...
      if(this.renderMinX < 0.0D || this.renderMaxX > 1.0D) {
         var1011 = (double)p_147761_8_.getMinU();
      ...
      if(this.uvRotateEast == 2) {
         var1011 = (double)p_147761_8_.getInterpolatedU(this.renderMinY * 16.0D);
         ...
         var1011 = (double)p_147761_8_.getInterpolatedU(16.0D - this.renderMaxY * 16.0D);
         ...
         var1011 = (double)p_147761_8_.getInterpolatedU(16.0D - this.renderMinX * 16.0D);
      ...
      if(this.enableAO) {
         ...
         var9.setColorOpaque_F(this.colorRedBottomLeft, this.colorGreenBottomLeft, this.colorBlueBottomLeft);
         var9.setBrightness(this.brightnessBottomLeft);
         var9.addVertexWithUV(var28, var32, var34, var1011, var14);
         var9.setColorOpaque_F(this.colorRedBottomRight, this.colorGreenBottomRight, this.colorBlueBottomRight);
         var9.setBrightness(this.brightnessBottomRight);
   ...
   public void renderFaceZPos(Block p_147734_1_, double p_147734_2_, double p_147734_4_, double p_147734_6_, IIcon p_147734_8_) {
      ...
      if(Config.isNaturalTextures() && this.overrideBlockTexture == null && this.uvRotateWest == 0) {
         NaturalProperties var101 = NaturalTextures.getNaturalProperties(p_147734_8_);
         if(var101 != null) {
      ...
      double var1011 = (double)p_147734_8_.getInterpolatedU(this.renderMinX * 16.0D);
      ...
      if(this.renderMinX < 0.0D || this.renderMaxX > 1.0D) {
         var1011 = (double)p_147734_8_.getMinU();
      ...
      if(this.uvRotateWest == 1) {
         var1011 = (double)p_147734_8_.getInterpolatedU(this.renderMinY * 16.0D);
         ...
         var1011 = (double)p_147734_8_.getInterpolatedU(16.0D - this.renderMaxY * 16.0D);
         ...
         var1011 = (double)p_147734_8_.getInterpolatedU(16.0D - this.renderMinX * 16.0D);
      ...
      if(this.enableAO) {
         var9.setColorOpaque_F(this.colorRedTopLeft, this.colorGreenTopLeft, this.colorBlueTopLeft);
         var9.setBrightness(this.brightnessTopLeft);
         var9.addVertexWithUV(var26, var32, var34, var1011, var14);
         var9.setColorOpaque_F(this.colorRedBottomLeft, this.colorGreenBottomLeft, this.colorBlueBottomLeft);
         var9.setBrightness(this.brightnessBottomLeft);
         var9.addVertexWithUV(var26, var30, var34, var20, var24);
         var9.setColorOpaque_F(this.colorRedBottomRight, this.colorGreenBottomRight, this.colorBlueBottomRight);
   ...
   public void renderFaceXNeg(Block p_147798_1_, double p_147798_2_, double p_147798_4_, double p_147798_6_, IIcon p_147798_8_) {
      ...
      if(Config.isNaturalTextures() && this.overrideBlockTexture == null && this.uvRotateNorth == 0) {
         NaturalProperties var101 = NaturalTextures.getNaturalProperties(p_147798_8_);
         if(var101 != null) {
      ...
      double var1011 = (double)p_147798_8_.getInterpolatedU(this.renderMinZ * 16.0D);
      ...
      if(this.renderMinZ < 0.0D || this.renderMaxZ > 1.0D) {
         var1011 = (double)p_147798_8_.getMinU();
      ...
      if(this.uvRotateNorth == 1) {
         var1011 = (double)p_147798_8_.getInterpolatedU(this.renderMinY * 16.0D);
         ...
         var1011 = (double)p_147798_8_.getInterpolatedU(16.0D - this.renderMaxY * 16.0D);
         ...
         var1011 = (double)p_147798_8_.getInterpolatedU(16.0D - this.renderMinZ * 16.0D);
   ...
   public void renderFaceXPos(Block p_147764_1_, double p_147764_2_, double p_147764_4_, double p_147764_6_, IIcon p_147764_8_) {
      ...
      if(Config.isNaturalTextures() && this.overrideBlockTexture == null && this.uvRotateSouth == 0) {
         NaturalProperties var101 = NaturalTextures.getNaturalProperties(p_147764_8_);
         if(var101 != null) {
      ...
      double var1011 = (double)p_147764_8_.getInterpolatedU(this.renderMinZ * 16.0D);
      ...
      if(this.field_152631_f) {
         ...
         var1011 = (double)p_147764_8_.getInterpolatedU((1.0D - this.renderMaxZ) * 16.0D);
      }
      ...
      if(this.renderMinZ < 0.0D || this.renderMaxZ > 1.0D) {
         var1011 = (double)p_147764_8_.getMinU();
      ...
      if(this.uvRotateSouth == 2) {
         var1011 = (double)p_147764_8_.getInterpolatedU(this.renderMinY * 16.0D);
         ...
         var1011 = (double)p_147764_8_.getInterpolatedU(16.0D - this.renderMaxY * 16.0D);
         ...
         var1011 = (double)p_147764_8_.getInterpolatedU(16.0D - this.renderMinZ * 16.0D);
      ...
      if(this.enableAO) {
         ...
         var9.setColorOpaque_F(this.colorRedTopRight, this.colorGreenTopRight, this.colorBlueTopRight);
         var9.setBrightness(this.brightnessTopRight);
         var9.addVertexWithUV(var26, var30, var34, var1011, var14);
      } else {
         var9.addVertexWithUV(var26, var28, var34, var20, var24);
         var9.addVertexWithUV(var26, var28, var32, var12, var16);
         var9.addVertexWithUV(var26, var30, var32, var18, var22);
