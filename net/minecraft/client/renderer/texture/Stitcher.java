...
public class Stitcher {
   ...
   public List getStichSlots() {
      ...
      while(var2.hasNext()) {
         Stitcher.Slot var71 = (Stitcher.Slot)var2.next();
         var71.getAllStitchSlots(var1);
      }

      ArrayList var711 = Lists.newArrayList();
   ...
   private boolean expandAndAllocateSlot(Stitcher.Holder par1StitchHolder) {
      ...
      if(this.forcePowerOf2) {
         ...
         int var152 = MathHelper.roundUpToPowerOfTwo(this.currentHeight);
         int var141 = MathHelper.roundUpToPowerOfTwo(this.currentWidth + var2);
         int var8 = MathHelper.roundUpToPowerOfTwo(this.currentHeight + var2);
         boolean var9 = var141 <= this.maxWidth;
         boolean var10 = var8 <= this.maxHeight;
         if(!var9 && !var10) {
            return false;
         }

         boolean var11 = var5 != var141;
         boolean var12 = var152 != var8;
         if(var11 ^ var12) {
            var4 = !var11;
         } else {
            var4 = var9 && var5 <= var152;
         }
      } else {
         boolean var1521 = this.currentWidth + var2 <= this.maxWidth;
         boolean var1411 = this.currentHeight + var2 <= this.maxHeight;
         if(!var1521 && !var1411) {
            return false;
         }

         var4 = var1521 && (var3 || this.currentWidth <= this.currentHeight);
      }
      ...
      if(MathHelper.roundUpToPowerOfTwo((!var4?this.currentHeight:this.currentWidth) + var5) > (!var4?this.maxHeight:this.maxWidth)) {
         ...
         if(var4) {
            ...
            var1522 = new Stitcher.Slot(this.currentWidth, 0, par1StitchHolder.getWidth(), this.currentHeight);
            this.currentWidth += par1StitchHolder.getWidth();
         } else {
            var1522 = new Stitcher.Slot(0, this.currentHeight, this.currentWidth, par1StitchHolder.getHeight());
            this.currentHeight += par1StitchHolder.getHeight();
         }

         var1522.addSlot(par1StitchHolder);
         this.stitchSlots.add(var1522);
         return true;
      }
   }
            ...
            if(var2 <= this.width && var3 <= this.height) {
               if(var2 == this.width && var3 == this.height) {
                  ...
                  if(this.subSlots == null) {
                     ...
                     int var81 = this.width - var2;
                     int var91 = this.height - var3;
                     if(var91 > 0 && var81 > 0) {
                        int var6 = Math.max(this.height, var81);
                        int var7 = Math.max(this.width, var91);
                        if(var6 >= var7) {
                           this.subSlots.add(new Stitcher.Slot(this.originX, this.originY + var3, var2, var91));
                           this.subSlots.add(new Stitcher.Slot(this.originX + var2, this.originY, var81, this.height));
                        } else {
                           this.subSlots.add(new Stitcher.Slot(this.originX + var2, this.originY, var81, var3));
                           this.subSlots.add(new Stitcher.Slot(this.originX, this.originY + var3, this.width, var91));
                        }
                     } else if(var81 == 0) {
                        this.subSlots.add(new Stitcher.Slot(this.originX, this.originY + var3, var2, var91));
                     } else if(var91 == 0) {
                  ...
                  Iterator var811 = this.subSlots.iterator();

                  Stitcher.Slot var911;
                  do {
                     if(!var811.hasNext()) {
                        return false;
                     }

                     var911 = (Stitcher.Slot)var811.next();
                  } while(!var911.addSlot(par1StitchHolder));
