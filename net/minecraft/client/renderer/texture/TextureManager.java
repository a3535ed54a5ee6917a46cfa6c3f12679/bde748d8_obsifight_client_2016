...
public class TextureManager implements ITickable, IResourceManagerReloadListener {
   ...
   public void onResourceManagerReload(IResourceManager par1ResourceManager) {
      ...
      while(it.hasNext()) {
         ResourceLocation var21 = (ResourceLocation)it.next();
         if(var21.getResourcePath().startsWith("mcpatcher/")) {
            ITextureObject var31 = (ITextureObject)this.mapTextureObjects.get(var21);
            int glTexId = var31.getGlTextureId();
            if(glTexId > 0) {
      ...
      Iterator var211 = this.mapTextureObjects.entrySet().iterator();

      while(var211.hasNext()) {
         Entry var311 = (Entry)var211.next();
         this.loadTexture((ResourceLocation)var311.getKey(), (ITextureObject)var311.getValue());
      }
   }
}
