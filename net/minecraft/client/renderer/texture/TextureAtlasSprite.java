...
public class TextureAtlasSprite implements IIcon {
   ...
   public void updateAnimation() {
      ...
      if(this.tickCounter >= this.animationMetadata.getFrameTimeSingle(this.frameCounter)) {
         ...
         if(var1 != var3 && var3 >= 0 && var3 < this.framesTextureData.size()) {
            TextureUtil.func_147955_a((int[][])((int[][])((int[][])this.framesTextureData.get(var3))), this.width, this.height, this.originX, this.originY, false, false);
   ...
   public int[][] func_147965_a(int p_147965_1_) {
      return (int[][])((int[][])((int[][])this.framesTextureData.get(p_147965_1_)));
   }
   ...
   public void func_147964_a(BufferedImage[] p_147964_1_, AnimationMetadataSection p_147964_2_, boolean p_147964_3_) {
      ...
      for(var7 = 0; var7 < p_147964_1_.length; ++var7) {
         BufferedImage var121 = p_147964_1_[var7];
         if(var121 != null) {
            if(var7 > 0 && (var121.getWidth() != var4 >> var7 || var121.getHeight() != var5 >> var7)) {
               throw new RuntimeException(String.format("Unable to load miplevel: %d, image is size: %dx%d, expected %dx%d", new Object[]{Integer.valueOf(var7), Integer.valueOf(var121.getWidth()), Integer.valueOf(var121.getHeight()), Integer.valueOf(var4 >> var7), Integer.valueOf(var5 >> var7)}));
            }

            var6[var7] = new int[var121.getWidth() * var121.getHeight()];
            var121.getRGB(0, 0, var121.getWidth(), var121.getHeight(), var6[var7], 0, var121.getWidth());
         }
      }
      ...
      if(p_147964_2_ == null) {
         ...
         if(p_147964_2_.getFrameCount() > 0) {
            Iterator var131 = p_147964_2_.getFrameIndexSet().iterator();

            while(var131.hasNext()) {
               var11 = ((Integer)var131.next()).intValue();
               if(var11 >= var7) {
   ...
   public void func_147963_d(int p_147963_1_) {
      ...
      for(int var3 = 0; var3 < this.framesTextureData.size(); ++var3) {
         final int[][] var4 = (int[][])((int[][])((int[][])this.framesTextureData.get(var3)));
         if(var4 != null) {
            try {
   ...
   public void setFramesTextureData(List par1List) {
      ...
      for(int i = 0; i < this.framesTextureData.size(); ++i) {
         int[][] datas = (int[][])((int[][])((int[][])this.framesTextureData.get(i)));
