...
import fr.thisismac.injector.customclass.EntityBigWolf;
import fr.thisismac.injector.customclass.EntityGoldCow;
import fr.thisismac.injector.customclass.EntityHellCow;
import fr.thisismac.injector.customclass.EntityKingZombie;
import fr.thisismac.injector.customclass.EntityXTNT;
import fr.thisismac.injector.customclass.ModelBigWolf;
import fr.thisismac.injector.customclass.ModelGoldCow;
import fr.thisismac.injector.customclass.ModelHellCow;
import fr.thisismac.injector.customclass.RenderBigWolf;
import fr.thisismac.injector.customclass.RenderGoldCow;
import fr.thisismac.injector.customclass.RenderHellCow;
import fr.thisismac.injector.customclass.RenderKingZombie;
import fr.thisismac.injector.customclass.RenderXTNT;
...
public class RenderManager {
   ...
   private RenderManager() {
      ...
      this.entityRenderMap.put(EntityXTNT.class, new RenderXTNT());
      this.entityRenderMap.put(EntityKingZombie.class, new RenderKingZombie());
      this.entityRenderMap.put(EntityGoldCow.class, new RenderGoldCow(new ModelGoldCow(), 0.7F));
      this.entityRenderMap.put(EntityBigWolf.class, new RenderBigWolf(new ModelBigWolf(), new ModelBigWolf(), 0.5F));
      this.entityRenderMap.put(EntityHellCow.class, new RenderHellCow(new ModelHellCow(), 0.7F));
