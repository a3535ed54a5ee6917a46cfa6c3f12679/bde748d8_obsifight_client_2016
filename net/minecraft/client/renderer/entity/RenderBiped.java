...
public class RenderBiped extends RenderLiving {
   ...
   public static List<String> bipedArmorFilenamePrefix = new ArrayList(Arrays.asList(new String[]{"leather", "chainmail", "iron", "diamond", "gold", "manganese", "garnet", "amethyst", "titanium", "xenotium", "obsidium"}));
   ...
   public static ResourceLocation func_110858_a(ItemArmor p_110858_0_, int p_110858_1_, String p_110858_2_) {
      String var3 = String.format("textures/models/armor/%s_layer_%d%s.png", new Object[]{bipedArmorFilenamePrefix.get(p_110858_0_.renderIndex), Integer.valueOf(p_110858_1_ == 2?2:1), p_110858_2_ == null?"":String.format("_%s", new Object[]{p_110858_2_})});
   ...
   protected void renderEquippedItems(EntityLiving p_77029_1_, float p_77029_2_) {
      ...
      if(var4 != null) {
         ...
         if(var5 instanceof ItemBlock) {
            ...
            if(var4.hasTagCompound()) {
               NBTTagCompound var11 = var4.getTagCompound();
               if(var11.func_150297_b("SkullOwner", 10)) {
                  var9 = NBTUtil.func_152459_a(var11.getCompoundTag("SkullOwner"));
               } else if(var11.func_150297_b("SkullOwner", 8) && !StringUtils.isNullOrEmpty(var11.getString("SkullOwner"))) {
                  var9 = new GameProfile((UUID)null, var11.getString("SkullOwner"));
               }
            }

            TileEntitySkullRenderer.field_147536_b.func_152674_a(-0.5F, 0.0F, -0.5F, 1, 180.0F, var4.getItemDamage(), var9);
         }
      ...
      if(var3 != null && var3.getItem() != null) {
         ...
         if(var5 instanceof ItemBlock && RenderBlocks.renderItemIn3d(Block.getBlockFromItem(var5).getRenderType())) {
            ...
            GL11.glScalef(-var6, -var6, var6);
         } else if(var5 != Items.bow && !(var5 instanceof CustomBow)) {
            if(var5.isFull3D()) {
               var6 = 0.625F;
         ...
         if(var3.getItem().requiresMultipleRenderPasses()) {
            for(var131 = 0; var131 <= 1; ++var131) {
               int var13 = var3.getItem().getColorFromItemStack(var3, var131);
               var14 = (float)(var13 >> 16 & 255) / 255.0F;
               var12 = (float)(var13 >> 8 & 255) / 255.0F;
               float var10 = (float)(var13 & 255) / 255.0F;
               GL11.glColor4f(var14, var12, var10, 1.0F);
               this.renderManager.itemRenderer.renderItem(p_77029_1_, var3, var131);
            }
         } else {
            var131 = var3.getItem().getColorFromItemStack(var3, 0);
            float var141 = (float)(var131 >> 16 & 255) / 255.0F;
            var14 = (float)(var131 >> 8 & 255) / 255.0F;
            var12 = (float)(var131 & 255) / 255.0F;
            GL11.glColor4f(var141, var14, var12, 1.0F);
