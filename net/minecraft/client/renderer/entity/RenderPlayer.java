...
public class RenderPlayer extends RendererLivingEntity {
   ...
   public void doRender(AbstractClientPlayer p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
      ...
      if(var10 != null && p_76986_1_.getItemInUseCount() > 0) {
         EnumAction var13 = var10.getItemUseAction();
         if(var13 == EnumAction.block) {
            this.modelArmorChestplate.heldItemRight = this.modelArmor.heldItemRight = this.modelBipedMain.heldItemRight = 3;
         } else if(var13 == EnumAction.bow) {
      ...
      double var131 = p_76986_4_ - (double)p_76986_1_.yOffset;
      if(p_76986_1_.isSneaking() && !(p_76986_1_ instanceof EntityPlayerSP)) {
         var131 -= 0.125D;
      }

      super.doRender((EntityLivingBase)p_76986_1_, p_76986_2_, var131, p_76986_6_, p_76986_8_, p_76986_9_);
   ...
   protected void renderEquippedItems(AbstractClientPlayer p_77029_1_, float p_77029_2_) {
      ...
      if(var3 != null) {
         ...
         if(var3.getItem() instanceof ItemBlock) {
            ...
            if(var3.hasTagCompound()) {
               NBTTagCompound var11 = var3.getTagCompound();
               if(var11.func_150297_b("SkullOwner", 10)) {
                  var21 = NBTUtil.func_152459_a(var11.getCompoundTag("SkullOwner"));
               } else if(var11.func_150297_b("SkullOwner", 8) && !StringUtils.isNullOrEmpty(var11.getString("SkullOwner"))) {
                  var21 = new GameProfile((UUID)null, var11.getString("SkullOwner"));
               }
            }

            TileEntitySkullRenderer.field_147536_b.func_152674_a(-0.5F, 0.0F, -0.5F, 1, 180.0F, var3.getItemDamage(), var21);
         }
      ...
      if(p_77029_1_.getCommandSenderName().equals("deadmau5") && p_77029_1_.func_152123_o()) {
         ...
         for(int var211 = 0; var211 < 2; ++var211) {
            var23 = p_77029_1_.prevRotationYaw + (p_77029_1_.rotationYaw - p_77029_1_.prevRotationYaw) * p_77029_2_ - (p_77029_1_.prevRenderYawOffset + (p_77029_1_.renderYawOffset - p_77029_1_.prevRenderYawOffset) * p_77029_2_);
            float var24 = p_77029_1_.prevRotationPitch + (p_77029_1_.rotationPitch - p_77029_1_.prevRotationPitch) * p_77029_2_;
            GL11.glPushMatrix();
            GL11.glRotatef(var23, 0.0F, 1.0F, 0.0F);
            GL11.glRotatef(var24, 1.0F, 0.0F, 0.0F);
            GL11.glTranslatef(0.375F * (float)(var211 * 2 - 1), 0.0F, 0.0F);
      ...
      boolean var22 = p_77029_1_.func_152122_n();
      if(var22 && !p_77029_1_.isInvisible() && !p_77029_1_.getHideCape()) {
         this.bindTexture(p_77029_1_.getLocationCape());
         GL11.glPushMatrix();
         GL11.glTranslatef(0.0F, 0.0F, 0.125F);
         double var241 = p_77029_1_.field_71091_bM + (p_77029_1_.field_71094_bP - p_77029_1_.field_71091_bM) * (double)p_77029_2_ - (p_77029_1_.prevPosX + (p_77029_1_.posX - p_77029_1_.prevPosX) * (double)p_77029_2_);
         double var10 = p_77029_1_.field_71096_bN + (p_77029_1_.field_71095_bQ - p_77029_1_.field_71096_bN) * (double)p_77029_2_ - (p_77029_1_.prevPosY + (p_77029_1_.posY - p_77029_1_.prevPosY) * (double)p_77029_2_);
         double var30 = p_77029_1_.field_71097_bO + (p_77029_1_.field_71085_bR - p_77029_1_.field_71097_bO) * (double)p_77029_2_ - (p_77029_1_.prevPosZ + (p_77029_1_.posZ - p_77029_1_.prevPosZ) * (double)p_77029_2_);
         var23 = p_77029_1_.prevRenderYawOffset + (p_77029_1_.renderYawOffset - p_77029_1_.prevRenderYawOffset) * p_77029_2_;
         double var12 = (double)MathHelper.sin(var23 * (float)Math.PI / 180.0F);
         double var14 = (double)(-MathHelper.cos(var23 * (float)Math.PI / 180.0F));
         float var16 = (float)var10 * 10.0F;
         if(var16 < -6.0F) {
            var16 = -6.0F;
         }
         ...
         float var17 = (float)(var241 * var12 + var30 * var14) * 100.0F;
         float var18 = (float)(var241 * var14 - var30 * var12) * 100.0F;
         if(var17 < 0.0F) {
            var17 = 0.0F;
         }
      ...
      ItemStack var25 = p_77029_1_.inventory.getCurrentItem();
      if(var25 != null) {
         GL11.glPushMatrix();
         ...
         if(var25.getItem() instanceof ItemBlock && RenderBlocks.renderItemIn3d(Block.getBlockFromItem(var25.getItem()).getRenderType())) {
            ...
            GL11.glScalef(-var7, -var7, var7);
         } else if(var25.getItem() != Items.bow && !(var25.getItem() instanceof CustomBow)) {
            if(var25.getItem().isFull3D()) {
               var7 = 0.625F;
         ...
         if(var25.getItem().requiresMultipleRenderPasses()) {
            for(var28 = 0; var28 <= 1; ++var28) {
               int var29 = var25.getItem().getColorFromItemStack(var25, var28);
               var27 = (float)(var29 >> 16 & 255) / 255.0F;
               var261 = (float)(var29 >> 8 & 255) / 255.0F;
               var23 = (float)(var29 & 255) / 255.0F;
               GL11.glColor4f(var27, var261, var23, 1.0F);
               this.renderManager.itemRenderer.renderItem(p_77029_1_, var25, var28);
            }
         } else {
            var28 = var25.getItem().getColorFromItemStack(var25, 0);
            float var281 = (float)(var28 >> 16 & 255) / 255.0F;
            var27 = (float)(var28 >> 8 & 255) / 255.0F;
            var261 = (float)(var28 & 255) / 255.0F;
            GL11.glColor4f(var281, var27, var261, 1.0F);
            this.renderManager.itemRenderer.renderItem(p_77029_1_, var25, 0);
         }
