...
public class ThreadDownloadImageData extends SimpleTexture {
            ...
            if(ThreadDownloadImageData.this.shouldPipeline()) {
               ...
               try {
                  ...
                  if(ThreadDownloadImageData.this.field_152434_e != null) {
                     ...
                     var61 = ImageIO.read(ThreadDownloadImageData.this.field_152434_e);
                  } else {
                     var61 = ImageIO.read(var1.getInputStream());
                  }

                  if(ThreadDownloadImageData.this.imageBuffer != null) {
                     var61 = ThreadDownloadImageData.this.imageBuffer.parseUserSkin(var61);
                  }

                  ThreadDownloadImageData.this.func_147641_a(var61);
   ...
   private void loadPipelined() {
      try {
         HttpRequest var9 = HttpPipeline.makeRequest(this.imageUrl, Minecraft.getMinecraft().getProxy());
         HttpResponse resp = HttpPipeline.executeRequest(var9);
         ...
         logger.error("Couldn\'t download http texture: " + var91.getClass().getName() + ": " + var91.getMessage());
      } finally {
         this.imageFound = Boolean.valueOf(this.bufferedImage != null);
      }
   }
