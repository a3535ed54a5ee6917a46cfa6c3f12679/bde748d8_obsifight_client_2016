...
public class TileEntityChestRenderer extends TileEntitySpecialRenderer {
   ...
   public void renderTileEntityAt(TileEntityChest p_147500_1_, double p_147500_2_, double p_147500_4_, double p_147500_6_, float p_147500_8_) {
      ...
      if(!p_147500_1_.hasWorldObj()) {
         ...
         Block var14 = p_147500_1_.getBlockType();
         var9 = p_147500_1_.getBlockMetadata();
         if(var14 instanceof BlockChest && var9 == 0) {
            ((BlockChest)var14).func_149954_e(p_147500_1_.getWorldObj(), p_147500_1_.field_145851_c, p_147500_1_.field_145848_d, p_147500_1_.field_145849_e);
            var9 = p_147500_1_.getBlockMetadata();
         }
      ...
      if(p_147500_1_.field_145992_i == null && p_147500_1_.field_145991_k == null) {
         ...
         if(p_147500_1_.field_145990_j == null && p_147500_1_.field_145988_l == null) {
            var141 = this.field_147510_h;
            if(p_147500_1_.func_145980_j() > 1) {
               Iterator var11 = Core.get().getBlocks().values().iterator();

               while(var11.hasNext()) {
                  Block var12 = (Block)var11.next();
                  if(var12 instanceof CustomChest) {
                     CustomChest var13 = (CustomChest)var12;
                     if(var13.getId() == p_147500_1_.func_145980_j()) {
                        this.bindTexture(var13.texture);
                        break;
                     }
                  }
               }
            } else if(p_147500_1_.func_145980_j() == 1) {
         ...
         GL11.glRotatef((float)var111, 0.0F, 1.0F, 0.0F);
         GL11.glTranslatef(-0.5F, -0.5F, -0.5F);
         float var121 = p_147500_1_.field_145986_n + (p_147500_1_.field_145989_m - p_147500_1_.field_145986_n) * p_147500_8_;
         float var131;
         if(p_147500_1_.field_145992_i != null) {
            var131 = p_147500_1_.field_145992_i.field_145986_n + (p_147500_1_.field_145992_i.field_145989_m - p_147500_1_.field_145992_i.field_145986_n) * p_147500_8_;
            if(var131 > var121) {
               var121 = var131;
            }
         }
         ...
         if(p_147500_1_.field_145991_k != null) {
            var131 = p_147500_1_.field_145991_k.field_145986_n + (p_147500_1_.field_145991_k.field_145989_m - p_147500_1_.field_145991_k.field_145986_n) * p_147500_8_;
            if(var131 > var121) {
               var121 = var131;
            }
         }
         ...
         var121 = 1.0F - var121;
         var121 = 1.0F - var121 * var121 * var121;
         var141.chestLid.rotateAngleX = -(var121 * (float)Math.PI / 2.0F);
         var141.renderAll();
