...
public class TileEntityRendererChestHelper {
   ...
   public void func_147715_a(Block p_147715_1_, int p_147715_2_, float p_147715_3_) {
      if(p_147715_1_ instanceof CustomChest) {
         CustomChest chest = (CustomChest)p_147715_1_;
         TileEntityRendererDispatcher.instance.func_147549_a(new TileEntityChest(chest.getId()), 0.0D, 0.0D, 0.0D, 0.0F);
      } else if(p_147715_1_ == Blocks.ender_chest) {
