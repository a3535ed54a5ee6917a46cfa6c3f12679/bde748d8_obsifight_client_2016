...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
   ...
   public void handleSpawnObject(S0EPacketSpawnObject p_147235_1_) {
      ...
      if(p_147235_1_.func_148993_l() == 10) {
         ...
         Entity var121 = this.clientWorldController.getEntityByID(p_147235_1_.func_149009_m());
         if(var121 instanceof EntityPlayer) {
            var8 = new EntityFishHook(this.clientWorldController, var2, var4, var6, (EntityPlayer)var121);
         }
      ...
      if(var8 != null) {
         ...
         if(var12 != null) {
            int var131 = p_147235_1_.func_149001_c() - ((Entity)var8).getEntityId();

            for(int var141 = 0; var141 < var12.length; ++var141) {
               var12[var141].setEntityId(var12[var141].getEntityId() + var131);
            }
         }
   ...
   public void handleMultiBlockChange(S22PacketMultiBlockChange p_147287_1_) {
      ...
      if(p_147287_1_.func_148921_d() != null) {
         ...
         try {
            for(int var13 = 0; var13 < p_147287_1_.func_148922_e(); ++var13) {
   ...
   public void onDisconnect(IChatComponent p_147231_1_) {
      ...
      if(this.guiScreenServer != null) {
         ...
         this.gameController.displayGuiScreen(new GuiDisconnected(new CustomMainMenu(), "disconnect.lost", p_147231_1_));
      }
   }
   ...
   public void handleChat(S02PacketChat p_147251_1_) {
      Iterator prefixMessage = Core.get().getNetworkTrigger().entrySet().iterator();

      while(true) {
         Entry shop;
         do {
            if(!prefixMessage.hasNext()) {
               String var35 = "[A] ";
               String var36 = "[XOXO] ";
               String msg = p_147251_1_.func_148915_c().getFormattedText();
               String unFormattedMsg = p_147251_1_.func_148915_c().getUnformattedText();
               String[] msgTab = unFormattedMsg.split(" ");
               String[] unformattedTab = unFormattedMsg.split(" ");
               if(unFormattedMsg.startsWith("[KILLS]") && !GameSettings.showDeathMessage) {
                  return;
               }

               if(unFormattedMsg.startsWith("[KILLS]")) {
                  this.gameController.ingameGUI.getChatGUI().func_146227_a(new ChatComponentText(p_147251_1_.func_148915_c().getFormattedText().replace("[KILLS]", "")));
                  return;
               }

               if(unFormattedMsg.contains("-> moi]")) {
                  Minecraft.getMinecraft().thePlayer.playSound("random.orb", 15.0F, 1.0F);
               }

               String var30;
               if(unFormattedMsg.startsWith(var36)) {
                  String[] var29 = unFormattedMsg.split(" ");
                  var30 = var29[1];
                  String message = var29[3];
                  String var10002 = var29[4];
                  String messageCut = var29[2];
                  Minecraft.getMinecraft().displayGuiScreen(new GuiShop(Minecraft.getMinecraft(), var30, messageCut, var10002, message));
               }

               if(unFormattedMsg.startsWith(var35)) {
                  String var37 = msg.substring(var35.length());
                  String[] var38 = var37.split(";");
                  GuiGUIMessage var39 = new GuiGUIMessage();
                  if(var38.length > 1) {
                     if(var38[1].equals("clear")) {
                        this.gameController.ingameGUI.clearMessages();
                        return;
                     }
                     ...
                     for(int i$ = 0; i$ < var41; ++i$) {
                        String item = var40[i$];
                        String[] itemCut = item.split(":");
                        if(itemCut.length == 2) {
                           String check;
                           if(itemCut[0].equalsIgnoreCase("id")) {
                              try {
                                 check = itemCut[1];
                                 var39.setId(check);
                              ...
                              float var31;
                              if(itemCut[0].equalsIgnoreCase("scale")) {
                                 try {
                                    var31 = Float.parseFloat(itemCut[1]);
                                    var39.setScale(var31);
                                 } catch (Exception var321) {
                                    ;
                                 }
                              } else if(itemCut[0].equalsIgnoreCase("spinValue")) {
                                 try {
                                    var31 = Float.parseFloat(itemCut[1]);
                                    var39.setSpinValue(var31);
                                 } catch (Exception var311) {
                                    ;
                                 }
                              } else if(itemCut[0].equalsIgnoreCase("spin")) {
                                 try {
                                    check = itemCut[1];
                                    if(check.equalsIgnoreCase("none")) {
                                       var39.setSpin(GuiGUIMessage.ROTATION.DEFAULT);
                                    } else if(check.equalsIgnoreCase("left")) {
                                       var39.setSpin(GuiGUIMessage.ROTATION.LEFT);
                                    } else if(check.equalsIgnoreCase("right")) {
                                       var39.setSpin(GuiGUIMessage.ROTATION.RIGHT);
                                    } else if(check.equalsIgnoreCase("customleft")) {
                                       var39.setSpin(GuiGUIMessage.ROTATION.CUSTOMLEFT);
                                    } else if(check.equalsIgnoreCase("customright")) {
                                       var39.setSpin(GuiGUIMessage.ROTATION.CUSTOMRIGHT);
                                    }
                                 } catch (Exception var301) {
                                    ;
                                 }
                              } else if(itemCut[0].equalsIgnoreCase("rotation")) {
                                 try {
                                    var31 = Float.parseFloat(itemCut[1]);
                                    var39.setRotation(var31);
                                 } catch (Exception var291) {
                                    ;
                                 }
                              } else {
                                 int var32;
                                 if(itemCut[0].equalsIgnoreCase("renderPass")) {
                                    try {
                                       if(itemCut[1].equalsIgnoreCase("auto")) {
                                          var32 = Minecraft.getMinecraft().fpsCounter;
                                          if(var32 <= 60) {
                                             var39.setRenderPass(0);
                                          } else {
                                             var39.setRenderPass(1);
                                          }
                                       } else {
                                          var32 = Integer.parseInt(itemCut[1]);
                                          var39.setRenderPass(var32);
                                       }
                                    } catch (Exception var28) {
                                       ;
                                    }
                                 } else if(itemCut[0].equalsIgnoreCase("stack")) {
                                    try {
                                       var32 = Integer.parseInt(itemCut[1]);
                                       var39.setStack(var32);
                                    } catch (Exception var27) {
                                       var27.printStackTrace();
                                    }
                                 } else if(itemCut[0].equalsIgnoreCase("anchor")) {
                                    try {
                                       check = itemCut[1];
                                       if(check.equalsIgnoreCase("bot")) {
                                          var39.setAnchor(GuiGUIMessage.Anchor.BOT);
                                       } else if(check.equalsIgnoreCase("botleft")) {
                                          var39.setAnchor(GuiGUIMessage.Anchor.BOTLEFT);
                                       } else if(check.equalsIgnoreCase("botright")) {
                                          var39.setAnchor(GuiGUIMessage.Anchor.BOTRIGHT);
                                       } else if(check.equalsIgnoreCase("left")) {
                                          var39.setAnchor(GuiGUIMessage.Anchor.LEFT);
                                       } else if(check.equalsIgnoreCase("right")) {
                                          var39.setAnchor(GuiGUIMessage.Anchor.RIGHT);
                                       } else if(check.equalsIgnoreCase("center")) {
                                          var39.setAnchor(GuiGUIMessage.Anchor.CENTER);
                                       } else if(check.equalsIgnoreCase("top")) {
                                          var39.setAnchor(GuiGUIMessage.Anchor.TOP);
                                       } else if(check.equalsIgnoreCase("topleft")) {
                                          var39.setAnchor(GuiGUIMessage.Anchor.TOPLEFT);
                                       } else if(check.equalsIgnoreCase("topright")) {
                                          var39.setAnchor(GuiGUIMessage.Anchor.TOPRIGHT);
                                       }
                                    } catch (Exception var26) {
                                       ;
                                    }
                                 } else if(itemCut[0].equalsIgnoreCase("x")) {
                                    try {
                                       var32 = Integer.parseInt(itemCut[1]);
                                       var39.setX(var32);
                                 ...
                                 } else if(itemCut[0].equalsIgnoreCase("xFinal")) {
                                    try {
                                       var32 = Integer.parseInt(itemCut[1]);
                                       var39.setXFinal(var32);
                                    } catch (Exception var24) {
                                       ;
                                    }
                                 } else if(itemCut[0].equalsIgnoreCase("y")) {
                                    try {
                                       var32 = Integer.parseInt(itemCut[1]);
                                       var39.setY(var32);
                                 ...
                                 } else if(itemCut[0].equalsIgnoreCase("yFinal")) {
                                    try {
                                       var32 = Integer.parseInt(itemCut[1]);
                                       var39.setYFinal(var32);
                                    } catch (Exception var22) {
                                       ;
                                    }
                                 } else if(itemCut[0].equalsIgnoreCase("time")) {
                                    try {
                                       var32 = Integer.parseInt(itemCut[1]);
                                       var39.setDisplayTimer(var32);
                                    } catch (Exception var21) {
                                       ;
                                    }
                                 } else if(itemCut[0].equalsIgnoreCase("shadow")) {
                                    check = itemCut[1];
                                    if(check.equalsIgnoreCase("true")) {
                                       var39.setShadow(true);
                                    } else if(check.equalsIgnoreCase("false")) {
                                       var39.setShadow(false);
                                    }
                                 }
                              }
                           }
                  ...
                  if(var30.contains("%name%")) {
                     var10000 = this.gameController;
                     if(Minecraft.getMinecraft().session == null) {
                        return;
                     }

                     Minecraft var42 = this.gameController;
                     var30 = var30.replace("%name%", Minecraft.getMinecraft().session.getUsername());
                  }

                  var39.setMessage(var30.replace(var30.substring(0, 1), ""));
                  this.gameController.ingameGUI.displayMessage(var39);
               } else {
            ...
            shop = (Entry)prefixMessage.next();
         } while(!p_147251_1_.func_148915_c().getUnformattedText().startsWith((String)shop.getKey()));

         try {
            ((Method)shop.getValue()).invoke(NetworkTrigger.class.newInstance(), new Object[]{p_147251_1_.func_148915_c().getFormattedText()});
            return;
   ...
   public void handleAnimation(S0BPacketAnimation p_147279_1_) {
      ...
      if(var2 != null) {
         if(p_147279_1_.func_148977_d() == 0) {
            EntityLivingBase var52 = (EntityLivingBase)var2;
            var52.swingItem();
         } else if(p_147279_1_.func_148977_d() == 1) {
            var2.performHurtAnimation();
         } else if(p_147279_1_.func_148977_d() == 2) {
            EntityPlayer var521 = (EntityPlayer)var2;
            var521.wakeUpPlayer(false, false, false);
            ...
            EntityCrit2FX var522 = new EntityCrit2FX(this.gameController.theWorld, var2, "magicCrit");
            this.gameController.effectRenderer.addEffect(var522);
         }
      }
   }
   ...
   public void handleSpawnMob(S0FPacketSpawnMob p_147281_1_) {
      ...
      if(var11 != null) {
         int var141 = p_147281_1_.func_149024_d() - var10.getEntityId();

         for(int var13 = 0; var13 < var11.length; ++var13) {
            var11[var13].setEntityId(var11[var13].getEntityId() + var141);
         }
      }
   ...
   public void handleSetSlot(S2FPacketSetSlot p_147266_1_) {
      ...
      if(p_147266_1_.func_149175_c() == -1) {
         ...
         if(this.gameController.currentScreen instanceof GuiContainerCreative) {
            GuiContainerCreative var51 = (GuiContainerCreative)this.gameController.currentScreen;
            var3 = var51.func_147056_g() != CreativeTabs.tabInventory.getTabIndex();
         }

         if(p_147266_1_.func_149175_c() == 0 && p_147266_1_.func_149173_d() >= 36 && p_147266_1_.func_149173_d() < 45) {
            ItemStack var511 = var2.inventoryContainer.getSlot(p_147266_1_.func_149173_d()).getStack();
            if(p_147266_1_.func_149174_e() != null && (var511 == null || var511.stackSize < p_147266_1_.func_149174_e().stackSize)) {
   ...
   public void handleCustomPayload(S3FPacketCustomPayload p_147240_1_) {
      if("MC|TrList".equals(p_147240_1_.func_149169_c())) {
         ByteBuf var121 = Unpooled.wrappedBuffer(p_147240_1_.func_149168_d());

         try {
            int var101 = var121.readInt();
            GuiScreen var4 = this.gameController.currentScreen;
            if(var4 != null && var4 instanceof GuiMerchant && var101 == this.gameController.thePlayer.openContainer.windowId) {
               IMerchant var5 = ((GuiMerchant)var4).func_147035_g();
               MerchantRecipeList var6 = MerchantRecipeList.func_151390_b(new PacketBuffer(var121));
         ...
         final String var1211 = new String(p_147240_1_.func_149168_d(), Charsets.UTF_8);
         if(this.gameController.func_147104_D() != null && this.gameController.func_147104_D().func_152586_b() == ServerData.ServerResourceMode.ENABLED) {
            this.gameController.getResourcePackRepository().func_148526_a(var1211);
            ...
            this.gameController.displayGuiScreen(new GuiYesNo(new GuiYesNoCallback() {
               ...
               public void confirmClicked(boolean p_73878_1_, int p_73878_2_) {
                  ...
                  if(p_73878_1_) {
                     NetHandlerPlayClient.this.gameController.getResourcePackRepository().func_148526_a(var1211);
                  }
   ...
   public void handleParticles(S2APacketParticles p_147289_1_) {
      if(p_147289_1_.func_149222_k() == 0) {
         double var151 = (double)(p_147289_1_.func_149227_j() * p_147289_1_.func_149221_g());
         ...
         this.clientWorldController.spawnParticle(p_147289_1_.func_149228_c(), p_147289_1_.func_149220_d(), p_147289_1_.func_149226_e(), p_147289_1_.func_149225_f(), var151, var4, var6);
      } else {
