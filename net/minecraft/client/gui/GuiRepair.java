...
public class GuiRepair extends GuiContainer implements ICrafting {
   ...
   protected void func_146979_b(int p_146979_1_, int p_146979_2_) {
      ...
      if(this.field_147092_v.maximumCost > 0) {
         ...
         if(this.field_147092_v.maximumCost >= 40 && !mc.thePlayer.capabilities.isCreativeMode) {
   ...
   private void func_147090_g() {
      ...
      mc.thePlayer.sendQueue.addToSendQueue(new C17PacketCustomPayload("MC|ItemName", var1.getBytes(Charsets.UTF_8)));
   }
