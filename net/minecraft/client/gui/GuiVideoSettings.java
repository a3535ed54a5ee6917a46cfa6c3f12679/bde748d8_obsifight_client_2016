...
public class GuiVideoSettings extends GuiScreen {
   ...
   public void initGui() {
      ...
      for(int var12 = 0; var12 < var3; ++var12) {
         String var111 = var2[var12];
         String var13 = System.getProperty(var111);
         if(var13 != null && var13.contains("64")) {
            this.is64bit = true;
            break;
         }
      }
      ...
      boolean var141 = !this.is64bit;
      GameSettings.Options[] var151 = field_146502_i;
      int var14 = var151.length;
      boolean var11 = false;

      int x;
      int var15;
      for(var15 = 0; var15 < var14; ++var15) {
         GameSettings.Options var16 = var151[var15];
         if(var16 != null) {
            x = this.width / 2 - 155 + var15 % 2 * 160;
            int var17 = this.height / 6 + 21 * (var15 / 2) - 10;
            if(var16.getEnumFloat()) {
               this.buttonList.add(new GuiOptionSlider(var16.returnEnumOrdinal(), x, var17, var16));
            } else {
               this.buttonList.add(new GuiOptionButton(var16.returnEnumOrdinal(), x, var17, var16, this.field_146499_g.getKeyBinding(var16)));
            }
         }
      }

      int var161 = this.height / 6 + 21 * (var15 / 2) - 10;
      boolean var171 = false;
      x = this.width / 2 - 155 + 160;
      this.buttonList.add(new GuiOptionButton(202, x, var161, "Quality..."));
      var161 += 21;
      x = this.width / 2 - 155 + 0;
      this.buttonList.add(new GuiOptionButton(201, x, var161, "Details..."));
      x = this.width / 2 - 155 + 160;
      this.buttonList.add(new GuiOptionButton(212, x, var161, "Performance..."));
      var161 += 21;
      x = this.width / 2 - 155 + 0;
      this.buttonList.add(new GuiOptionButton(211, x, var161, "Animations..."));
      x = this.width / 2 - 155 + 160;
      this.buttonList.add(new GuiOptionButton(222, x, var161, "Other..."));
   ...
   protected void actionPerformed(GuiButton par1GuiButton) {
      if(par1GuiButton.enabled) {
         ...
         if(par1GuiButton.id == 200) {
            ...
            mc.displayGuiScreen(this.field_146498_f);
         }

         if(this.field_146499_g.guiScale != var2) {
            ScaledResolution scr5 = new ScaledResolution(mc, mc.displayWidth, mc.displayHeight);
            int var4 = scr5.getScaledWidth();
            int var5 = scr5.getScaledHeight();
            this.setWorldAndResolution(mc, var4, var5);
         }

         if(par1GuiButton.id == 201) {
            mc.gameSettings.saveOptions();
            GuiDetailSettingsOF scr51 = new GuiDetailSettingsOF(this, this.field_146499_g);
            mc.displayGuiScreen(scr51);
         }

         if(par1GuiButton.id == 202) {
            mc.gameSettings.saveOptions();
            GuiQualitySettingsOF scr52 = new GuiQualitySettingsOF(this, this.field_146499_g);
            mc.displayGuiScreen(scr52);
         }

         if(par1GuiButton.id == 211) {
            mc.gameSettings.saveOptions();
            GuiAnimationSettingsOF scr53 = new GuiAnimationSettingsOF(this, this.field_146499_g);
            mc.displayGuiScreen(scr53);
         }

         if(par1GuiButton.id == 212) {
            mc.gameSettings.saveOptions();
            GuiPerformanceSettingsOF scr54 = new GuiPerformanceSettingsOF(this, this.field_146499_g);
            mc.displayGuiScreen(scr54);
         }

         if(par1GuiButton.id == 222) {
            mc.gameSettings.saveOptions();
            GuiOtherSettingsOF scr55 = new GuiOtherSettingsOF(this, this.field_146499_g);
            mc.displayGuiScreen(scr55);
         }
   ...
   public void drawScreen(int x, int y, float z) {
      ...
      if(ed.equals("HD_U")) {
         ver = "OptiFine HD D3 Ultra";
      }

      if(ed.equals("L")) {
         ver = "OptiFine D3 Light";
      }
