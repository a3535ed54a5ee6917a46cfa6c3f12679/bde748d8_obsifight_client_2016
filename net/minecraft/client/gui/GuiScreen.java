...
import fr.thisismac.injector.customclass.GuiButtonTrans;
...
public class GuiScreen extends Gui {
   ...
   protected List TButtonList = new ArrayList();
   protected List labelList = new ArrayList();
   public boolean field_146291_p;
   protected FontRenderer fontRendererObj;
   private GuiButton selectedButton;
   private GuiButtonTrans selectedTransButton;
   ...
   public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
      ...
      for(var4 = 0; var4 < this.buttonList.size(); ++var4) {
         ((GuiButton)this.buttonList.get(var4)).drawButton(mc, p_73863_1_, p_73863_2_);
      }

      for(var4 = 0; var4 < this.TButtonList.size(); ++var4) {
         ((GuiButtonTrans)this.TButtonList.get(var4)).drawButton(mc, p_73863_1_, p_73863_2_);
      }

      for(var4 = 0; var4 < this.labelList.size(); ++var4) {
         ((GuiLabel)this.labelList.get(var4)).func_146159_a(mc, p_73863_1_, p_73863_2_);
      }
   }
   ...
   protected void func_146283_a(List p_146283_1_, int p_146283_2_, int p_146283_3_) {
      if(!p_146283_1_.isEmpty()) {
         ...
         while(var5.hasNext()) {
            ...
            var15 = this.fontRendererObj.getStringWidth(var14);
            if(var15 > var4) {
               var4 = var15;
            }
         }

         int var141 = p_146283_2_ + 12;
         var15 = p_146283_3_ - 12;
         int var8 = 8;
         if(p_146283_1_.size() > 1) {
            var8 += 2 + (p_146283_1_.size() - 1) * 10;
         }

         if(var141 + var4 > this.width) {
            var141 -= 28 + var4;
         }
         ...
         int var9 = -267386864;
         this.drawGradientRect(var141 - 3, var15 - 4, var141 + var4 + 3, var15 - 3, var9, var9);
         this.drawGradientRect(var141 - 3, var15 + var8 + 3, var141 + var4 + 3, var15 + var8 + 4, var9, var9);
         this.drawGradientRect(var141 - 3, var15 - 3, var141 + var4 + 3, var15 + var8 + 3, var9, var9);
         this.drawGradientRect(var141 - 4, var15 - 3, var141 - 3, var15 + var8 + 3, var9, var9);
         this.drawGradientRect(var141 + var4 + 3, var15 - 3, var141 + var4 + 4, var15 + var8 + 3, var9, var9);
         int var10 = 1347420415;
         int var11 = (var10 & 16711422) >> 1 | var10 & -16777216;
         this.drawGradientRect(var141 - 3, var15 - 3 + 1, var141 - 3 + 1, var15 + var8 + 3 - 1, var10, var11);
         this.drawGradientRect(var141 + var4 + 2, var15 - 3 + 1, var141 + var4 + 3, var15 + var8 + 3 - 1, var10, var11);
         this.drawGradientRect(var141 - 3, var15 - 3, var141 + var4 + 3, var15 - 3 + 1, var10, var10);
         this.drawGradientRect(var141 - 3, var15 + var8 + 2, var141 + var4 + 3, var15 + var8 + 3, var11, var11);

         for(int var12 = 0; var12 < p_146283_1_.size(); ++var12) {
            String var13 = (String)p_146283_1_.get(var12);
            this.fontRendererObj.drawStringWithShadow(var13, var141, var15, -1);
            if(var12 == 0) {
               var15 += 2;
            }
   ...
   protected void mouseClicked(int p_73864_1_, int p_73864_2_, int p_73864_3_) {
      if(p_73864_3_ == 0) {
         ...
         for(var4 = 0; var4 < this.TButtonList.size(); ++var4) {
            GuiButtonTrans var6 = (GuiButtonTrans)this.TButtonList.get(var4);
            if(var6.mousePressed(mc, p_73864_1_, p_73864_2_)) {
               this.selectedTransButton = var6;
               var6.func_146113_a(mc.getSoundHandler());
   ...
   protected void actionPerformed(GuiButtonTrans p_146284_1_) {}
   ...
   public void handleMouseInput() {
      int var1 = Mouse.getEventX() * this.width / mc.displayWidth;
      int var2 = this.height - Mouse.getEventY() * this.height / mc.displayHeight - 1;
      int var3 = Mouse.getEventButton();
      if(Mouse.getEventButtonState()) {
         if(mc.gameSettings.touchscreen && this.field_146298_h++ > 0) {
            return;
         }
