...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback {
   ...
   public void initGui() {
      ...
      if(!this.field_146801_C) {
         ...
         this.field_146804_i = new ServerList(mc);
         ...
         this.field_146803_h = new ServerSelectionList(this, mc, this.width, this.height, 32, this.height - 64, 36);
   ...
   protected void actionPerformed(GuiButton p_146284_1_) {
      if(p_146284_1_.enabled) {
         ...
         if(p_146284_1_.id == 2 && var2 instanceof ServerListEntryNormal) {
            String var31 = ((ServerListEntryNormal)var2).func_148296_a().serverName;
            if(var31 != null) {
               this.field_146807_u = true;
               String var4 = I18n.format("selectServer.deleteQuestion", new Object[0]);
               String var5 = "\'" + var31 + "\' " + I18n.format("selectServer.deleteWarning", new Object[0]);
            ...
            mc.displayGuiScreen(new GuiScreenServerList(this, this.field_146811_z = new ServerData(I18n.format("selectServer.defaultName", new Object[0]), "")));
         } else if(p_146284_1_.id == 3) {
            this.field_146806_v = true;
            mc.displayGuiScreen(new GuiScreenAddServer(this, this.field_146811_z = new ServerData(I18n.format("selectServer.defaultName", new Object[0]), "")));
            ...
            mc.displayGuiScreen(new GuiScreenAddServer(this, this.field_146811_z));
         } else if(p_146284_1_.id == 0) {
            mc.displayGuiScreen(this.field_146798_g);
   ...
   private void func_146792_q() {
      mc.displayGuiScreen(new GuiMultiplayer(this.field_146798_g));
   }
