...
public class GuiStats extends GuiScreen implements IProgressMeter {
   ...
   protected void actionPerformed(GuiButton p_146284_1_) {
      if(p_146284_1_.enabled) {
         if(p_146284_1_.id == 0) {
            mc.displayGuiScreen(this.field_146549_a);
   ...
   private void func_146521_a(int p_146521_1_, int p_146521_2_, Item p_146521_3_) {
      ...
      field_146544_g.renderItemIntoGUI(this.fontRendererObj, mc.getTextureManager(), new ItemStack(p_146521_3_, 1, 0), p_146521_1_ + 2, p_146521_2_ + 2);
   ...
   abstract class Stats extends GuiSlot {
      ...
      protected Stats() {
         super(GuiStats.mc, GuiStats.this.width, GuiStats.this.height, 32, GuiStats.this.height - 64, 20);
      ...
      protected void func_148132_a(int p_148132_1_, int p_148132_2_) {
         ...
         if(this.field_148218_l >= 0) {
            ...
            GuiStats var10000 = GuiStats.this;
            GuiStats.mc.getSoundHandler().playSound(PositionedSoundRecord.func_147674_a(new ResourceLocation("gui.button.press"), 1.0F));
         }
      }
      ...
      protected void func_148142_b(int p_148142_1_, int p_148142_2_) {
         if(p_148142_2_ >= this.field_148153_b && p_148142_2_ <= this.field_148154_c) {
            ...
            if(var3 >= 0) {
               ...
               this.func_148213_a(var9, p_148142_1_, p_148142_2_);
            } else {
               String var91 = "";
               if(p_148142_1_ >= var4 + 115 - 18 && p_148142_1_ <= var4 + 115) {
                  var91 = this.func_148210_b(0);
               } else if(p_148142_1_ >= var4 + 165 - 18 && p_148142_1_ <= var4 + 165) {
                  var91 = this.func_148210_b(1);
               } else {
                  if(p_148142_1_ < var4 + 215 - 18 || p_148142_1_ > var4 + 215) {
                     return;
                  }

                  var91 = this.func_148210_b(2);
               }

               var91 = ("" + I18n.format(var91, new Object[0])).trim();
               if(var91.length() > 0) {
                  int var6 = p_148142_1_ + 12;
                  int var7 = p_148142_2_ - 12;
                  int var8 = GuiStats.this.fontRendererObj.getStringWidth(var91);
                  GuiStats.this.drawGradientRect(var6 - 3, var7 - 3, var6 + var8 + 3, var7 + 8 + 3, -1073741824, -1073741824);
                  GuiStats.this.fontRendererObj.drawStringWithShadow(var91, var6, var7, -1);
               }
            }
         }
      }
   ...
   class StatsGeneral extends GuiSlot {
      ...
      public StatsGeneral() {
         super(GuiStats.mc, GuiStats.this.width, GuiStats.this.height, 32, GuiStats.this.height - 64, 10);
         this.func_148130_a(false);
      }
   ...
   class StatsMobsList extends GuiSlot {
      ...
      public StatsMobsList() {
         super(GuiStats.mc, GuiStats.this.width, GuiStats.this.height, 32, GuiStats.this.height - 64, GuiStats.this.fontRendererObj.FONT_HEIGHT * 4);
         this.func_148130_a(false);
