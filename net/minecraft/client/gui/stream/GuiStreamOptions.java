...
public class GuiStreamOptions extends GuiScreen {
   ...
   public void initGui() {
      ...
      var6.enabled = mc.func_152346_Z().func_152924_m() && mc.func_152346_Z().func_152925_v().length > 0 || mc.func_152346_Z().func_152908_z();
   ...
   protected void actionPerformed(GuiButton p_146284_1_) {
      if(p_146284_1_.enabled) {
         if(p_146284_1_.id < 100 && p_146284_1_ instanceof GuiOptionButton) {
            ...
            if(mc.func_152346_Z().func_152934_n() && var2 != GameSettings.Options.STREAM_CHAT_ENABLED && var2 != GameSettings.Options.STREAM_CHAT_USER_FILTER) {
         ...
         if(p_146284_1_.id == 200) {
            ...
            mc.displayGuiScreen(this.field_152317_g);
