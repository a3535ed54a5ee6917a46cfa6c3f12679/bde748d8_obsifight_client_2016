...
public class GuiTwitchUserMode extends GuiScreen {
   ...
   public static List func_152328_a(Set p_152328_0_, Set p_152328_1_, IStream p_152328_2_) {
      ...
      while(var6.hasNext()) {
         ChatUserMode var10 = (ChatUserMode)var6.next();
         var8 = func_152329_a(var10, var3, var4);
         if(var8 != null) {
      ...
      while(var6.hasNext()) {
         ChatUserSubscription var101 = (ChatUserSubscription)var6.next();
         var8 = func_152330_a(var101, var3, var4);
         if(var8 != null) {
            var9 = new ChatComponentText("- ");
            var9.appendSibling(var8);
            var5.add(var9);
