...
public class GuiIngestServers extends GuiScreen {
   ...
   protected void actionPerformed(GuiButton p_146284_1_) {
      if(p_146284_1_.enabled) {
         if(p_146284_1_.id == 1) {
            mc.displayGuiScreen(this.field_152309_a);
         } else {
   ...
   class ServerList extends GuiSlot {
      ...
      public ServerList() {
         super(GuiIngestServers.mc, GuiIngestServers.this.width, GuiIngestServers.this.height, 32, GuiIngestServers.this.height - 35, (int)((double)GuiIngestServers.mc.fontRenderer.FONT_HEIGHT * 3.5D));
         this.func_148130_a(false);
      }

      protected int getSize() {
         GuiIngestServers var10000 = GuiIngestServers.this;
         return GuiIngestServers.mc.func_152346_Z().func_152925_v().length;
      }

      protected void elementClicked(int p_148144_1_, boolean p_148144_2_, int p_148144_3_, int p_148144_4_) {
         GuiIngestServers var10000 = GuiIngestServers.this;
         GuiIngestServers var10001 = GuiIngestServers.this;
         GuiIngestServers.mc.gameSettings.field_152407_Q = GuiIngestServers.mc.func_152346_Z().func_152925_v()[p_148144_1_].serverUrl;
      ...
      protected boolean isSelected(int p_148131_1_) {
         GuiIngestServers var10000 = GuiIngestServers.this;
         GuiIngestServers var10001 = GuiIngestServers.this;
         return GuiIngestServers.mc.func_152346_Z().func_152925_v()[p_148131_1_].serverUrl.equals(GuiIngestServers.mc.gameSettings.field_152407_Q);
      }
      ...
      protected void drawSlot(int p_148126_1_, int p_148126_2_, int p_148126_3_, int p_148126_4_, Tessellator p_148126_5_, int p_148126_6_, int p_148126_7_) {
         GuiIngestServers var10000 = GuiIngestServers.this;
         IngestServer var8 = GuiIngestServers.mc.func_152346_Z().func_152925_v()[p_148126_1_];
         String var9 = var8.serverUrl.replaceAll("\\{stream_key\\}", "");
         String var10 = (int)var8.bitrateKbps + " kbps";
         String var11 = null;
         var10000 = GuiIngestServers.this;
         IngestServerTester var12 = GuiIngestServers.mc.func_152346_Z().func_152932_y();
         if(var12 != null) {
