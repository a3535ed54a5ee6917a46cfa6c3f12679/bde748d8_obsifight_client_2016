...
public class GuiMerchant extends GuiContainer {
   ...
   public void updateScreen() {
      super.updateScreen();
      MerchantRecipeList var1 = this.field_147037_w.getRecipes(mc.thePlayer);
      if(var1 != null) {
   ...
   protected void actionPerformed(GuiButton p_146284_1_) {
      ...
      if(var2) {
         ...
         try {
            ...
            mc.getNetHandler().addToSendQueue(new C17PacketCustomPayload("MC|TrSel", var3));
   ...
   protected void func_146976_a(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
      ...
      MerchantRecipeList var6 = this.field_147037_w.getRecipes(mc.thePlayer);
   ...
   public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
      ...
      MerchantRecipeList var4 = this.field_147037_w.getRecipes(mc.thePlayer);
      if(var4 != null && !var4.isEmpty()) {
         ...
         itemRender.renderItemAndEffectIntoGUI(this.fontRendererObj, mc.getTextureManager(), var9, var5 + 36, var6 + 24);
         itemRender.renderItemOverlayIntoGUI(this.fontRendererObj, mc.getTextureManager(), var9, var5 + 36, var6 + 24);
         if(var10 != null) {
            itemRender.renderItemAndEffectIntoGUI(this.fontRendererObj, mc.getTextureManager(), var10, var5 + 62, var6 + 24);
            itemRender.renderItemOverlayIntoGUI(this.fontRendererObj, mc.getTextureManager(), var10, var5 + 62, var6 + 24);
         }

         itemRender.renderItemAndEffectIntoGUI(this.fontRendererObj, mc.getTextureManager(), var11, var5 + 120, var6 + 24);
         itemRender.renderItemOverlayIntoGUI(this.fontRendererObj, mc.getTextureManager(), var11, var5 + 120, var6 + 24);
