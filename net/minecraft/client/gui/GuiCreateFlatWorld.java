...
public class GuiCreateFlatWorld extends GuiScreen {
   ...
   protected void actionPerformed(GuiButton p_146284_1_) {
      ...
      if(p_146284_1_.id == 1) {
         mc.displayGuiScreen(this.field_146385_f);
   ...
   class Details extends GuiSlot {
      ...
      private void func_148225_a(int p_148225_1_, int p_148225_2_, ItemStack p_148225_3_) {
         ...
         if(p_148225_3_ != null) {
            ...
            RenderItem var10000 = GuiCreateFlatWorld.field_146392_a;
            GuiCreateFlatWorld var10002 = GuiCreateFlatWorld.this;
            var10000.renderItemIntoGUI(GuiCreateFlatWorld.this.fontRendererObj, GuiCreateFlatWorld.mc.getTextureManager(), p_148225_3_, p_148225_1_ + 2, p_148225_2_ + 2);
      ...
      private void func_148224_c(int p_148224_1_, int p_148224_2_, int p_148224_3_, int p_148224_4_) {
         ...
         GuiCreateFlatWorld var10000 = GuiCreateFlatWorld.this;
         GuiCreateFlatWorld.mc.getTextureManager().bindTexture(Gui.statIcons);
