...
public class GuiScreenOptionsSounds extends GuiScreen {
   ...
   protected void actionPerformed(GuiButton p_146284_1_) {
      if(p_146284_1_.enabled && p_146284_1_.id == 200) {
         ...
         mc.displayGuiScreen(this.field_146505_f);
      }
   }
   ...
   public class Button extends GuiButton {
      public final SoundCategory field_146153_r;
      public final String field_146152_s;
      ...
      public void mouseReleased(int p_146118_1_, int p_146118_2_) {
         if(this.field_146155_p) {
            ...
            GuiScreenOptionsSounds var10000 = GuiScreenOptionsSounds.this;
            GuiScreenOptionsSounds.mc.getSoundHandler().playSound(PositionedSoundRecord.func_147674_a(new ResourceLocation("gui.button.press"), 1.0F));
         }
