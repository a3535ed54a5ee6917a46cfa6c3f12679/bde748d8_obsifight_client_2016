...
public class GuiEnchantment extends GuiContainer {
   ...
   protected void mouseClicked(int p_73864_1_, int p_73864_2_, int p_73864_3_) {
      ...
      for(int var6 = 0; var6 < 3; ++var6) {
         ...
         if(var7 >= 0 && var8 >= 0 && var7 < 108 && var8 < 19 && this.field_147075_G.enchantItem(mc.thePlayer, var6)) {
            mc.playerController.sendEnchantPacket(this.field_147075_G.windowId, var6);
         }
      }
   }
   ...
   public void func_147068_g() {
      ...
      for(int var5 = 0; var5 < 3; ++var5) {
         if(this.field_147075_G.enchantLevels[var5] != 0) {
            var2 = true;
         }
      }
      ...
      float var51 = (this.field_147082_x - this.field_147071_v) * 0.4F;
      float var4 = 0.2F;
      if(var51 < -var4) {
         var51 = -var4;
      }
      ...
      this.field_147081_y += (var51 - this.field_147081_y) * 0.9F;
