...
public class GuiSelectWorld extends GuiScreen implements GuiYesNoCallback {
   ...
   protected void actionPerformed(GuiButton p_146284_1_) {
      if(p_146284_1_.enabled) {
         if(p_146284_1_.id == 2) {
            String var5 = this.func_146614_d(this.field_146640_r);
            if(var5 != null) {
               this.field_146643_x = true;
               GuiYesNo var6 = func_152129_a(this, var5, this.field_146640_r);
            ...
            mc.displayGuiScreen(new GuiRenameWorld(this, this.func_146621_a(this.field_146640_r)));
         } else if(p_146284_1_.id == 0) {
            mc.displayGuiScreen(this.field_146632_a);
         } else if(p_146284_1_.id == 7) {
            GuiCreateWorld var51 = new GuiCreateWorld(this);
            ISaveHandler var61 = mc.getSaveLoader().getSaveLoader(this.func_146621_a(this.field_146640_r), false);
            WorldInfo var4 = var61.loadWorldInfo();
            var61.flush();
            var51.func_146318_a(var4);
            mc.displayGuiScreen(var51);
         } else {
   ...
   class List extends GuiSlot {
      ...
      public List() {
         super(GuiSelectWorld.mc, GuiSelectWorld.this.width, GuiSelectWorld.this.height, 32, GuiSelectWorld.this.height - 64, 36);
      }
