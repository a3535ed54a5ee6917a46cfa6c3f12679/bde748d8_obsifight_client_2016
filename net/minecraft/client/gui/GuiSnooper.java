...
public class GuiSnooper extends GuiScreen {
   ...
   public void initGui() {
      ...
      this.field_146607_r = (String[])((String[])var2.toArray(new String[0]));
      ...
      boolean var61 = mc.getIntegratedServer() != null && mc.getIntegratedServer().getPlayerUsageSnooper() != null;
      Iterator var7 = (new TreeMap(mc.getPlayerUsageSnooper().getCurrentStats())).entrySet().iterator();

      Entry var5;
      while(var7.hasNext()) {
         var5 = (Entry)var7.next();
         this.field_146604_g.add((var61?"C ":"") + (String)var5.getKey());
   ...
   class List extends GuiSlot {
      ...
      public List() {
         super(GuiSnooper.mc, GuiSnooper.this.width, GuiSnooper.this.height, 80, GuiSnooper.this.height - 40, GuiSnooper.this.fontRendererObj.FONT_HEIGHT + 1);
      }
