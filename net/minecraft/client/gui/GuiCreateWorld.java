...
public class GuiCreateWorld extends GuiScreen {
   ...
   private void func_146314_g() {
      ...
      this.field_146336_i = func_146317_a(mc.getSaveLoader(), this.field_146336_i);
   }
   ...
   protected void actionPerformed(GuiButton p_146284_1_) {
      if(p_146284_1_.enabled) {
         if(p_146284_1_.id == 1) {
            mc.displayGuiScreen(this.field_146332_f);
            ...
            WorldSettings.GameType var81 = WorldSettings.GameType.getByName(this.field_146342_r);
            WorldSettings var6 = new WorldSettings(var2, var81, this.field_146341_s, this.field_146337_w, WorldType.worldTypes[this.field_146331_K]);
            ...
            mc.launchIntegratedServer(this.field_146336_i, this.field_146333_g.getText().trim(), var6);
            ...
            mc.displayGuiScreen(new GuiCreateFlatWorld(this, this.field_146334_a));
         }
      }
   }
