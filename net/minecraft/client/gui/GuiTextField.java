...
public class GuiTextField extends Gui {
   ...
   public void drawTextBox() {
      if(this.func_146176_q()) {
         ...
         if(var4.length() > 0) {
            String var13 = var5?var4.substring(0, var2):var4;
            var9 = this.field_146211_a.drawStringWithShadow(var13, var7, var8, var1);
         }

         boolean var131 = this.field_146224_r < this.field_146216_j.length() || this.field_146216_j.length() >= this.func_146208_g();
         int var11 = var9;
         if(!var5) {
