...
public class GuiFlatPresets extends GuiScreen {
   ...
   public GuiFlatPresets(GuiCreateFlatWorld p_i46378_1_) {
   ...
   protected void actionPerformed(GuiButton p_146284_1_) {
      if(p_146284_1_.id == 0 && this.func_146430_p()) {
         ...
         mc.displayGuiScreen(this.field_146432_g);
   ...
   private static void func_146421_a(String p_146421_0_, Item p_146421_1_, BiomeGenBase p_146421_2_, List p_146421_3_, FlatLayerInfo ... p_146421_4_) {
      ...
      for(int var8 = p_146421_4_.length - 1; var8 >= 0; --var8) {
         var5.getFlatLayers().add(p_146421_4_[var8]);
      }

      var5.setBiome(p_146421_2_.biomeID);
      var5.func_82645_d();
      if(p_146421_3_ != null) {
         Iterator var81 = p_146421_3_.iterator();

         while(var81.hasNext()) {
            String var7 = (String)var81.next();
   ...
   class ListSlot extends GuiSlot {
      ...
      private void func_148172_a(int p_148172_1_, int p_148172_2_, Item p_148172_3_) {
         ...
         RenderItem var10000 = GuiFlatPresets.field_146437_a;
         GuiFlatPresets var10002 = GuiFlatPresets.this;
         var10000.renderItemIntoGUI(GuiFlatPresets.this.fontRendererObj, GuiFlatPresets.mc.getTextureManager(), new ItemStack(p_148172_3_, 1, 0), p_148172_1_ + 2, p_148172_2_ + 2);
      ...
      private void func_148171_c(int p_148171_1_, int p_148171_2_, int p_148171_3_, int p_148171_4_) {
         ...
         GuiFlatPresets var10000 = GuiFlatPresets.this;
         GuiFlatPresets.mc.getTextureManager().bindTexture(Gui.statIcons);
