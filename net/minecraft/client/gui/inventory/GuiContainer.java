...
public abstract class GuiContainer extends GuiScreen {
   ...
   public void initGui() {
      super.initGui();
      mc.thePlayer.openContainer = this.field_147002_h;
   ...
   public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
      ...
      int var11;
      for(int var15 = 0; var15 < this.field_147002_h.inventorySlots.size(); ++var15) {
         Slot var16 = (Slot)this.field_147002_h.inventorySlots.get(var15);
         this.func_146977_a(var16);
         if(this.func_146981_a(var16, p_73863_1_, p_73863_2_) && var16.func_111238_b()) {
            this.field_147006_u = var16;
            GL11.glDisable(GL11.GL_LIGHTING);
            GL11.glDisable(GL11.GL_DEPTH_TEST);
            int var19 = var16.xDisplayPosition;
            var11 = var16.yDisplayPosition;
            GL11.glColorMask(true, true, true, false);
            this.drawGradientRect(var19, var11, var19 + 16, var11 + 16, -2130706433, -2130706433);
      ...
      InventoryPlayer var151 = mc.thePlayer.inventory;
      ItemStack var161 = this.field_147012_x == null?var151.getItemStack():this.field_147012_x;
      if(var161 != null) {
         byte var17 = 8;
         ...
         if(this.field_147012_x != null && this.field_147004_w) {
            var161 = var161.copy();
            var161.stackSize = MathHelper.ceiling_float_int((float)var161.stackSize / 2.0F);
         } else if(this.field_147007_t && this.field_147008_s.size() > 1) {
            var161 = var161.copy();
            var161.stackSize = this.field_146996_I;
            if(var161.stackSize == 0) {
               var20 = "" + EnumChatFormatting.YELLOW + "0";
            }
         }

         this.func_146982_a(var161, p_73863_1_ - var4 - var17, p_73863_2_ - var5 - var11, var20);
      }
      ...
      if(this.field_146991_C != null) {
         ...
         int var201 = this.field_146989_A.yDisplayPosition - this.field_147010_z;
         int var13 = this.field_147011_y + (int)((float)var11 * var18);
         int var14 = this.field_147010_z + (int)((float)var201 * var18);
         this.func_146982_a(this.field_146991_C, var13, var14, (String)null);
      }

      GL11.glPopMatrix();
      if(var151.getItemStack() == null && this.field_147006_u != null && this.field_147006_u.getHasStack()) {
         ItemStack var191 = this.field_147006_u.getStack();
         this.func_146285_a(var191, p_73863_1_, p_73863_2_);
      }
   ...
   private void func_146982_a(ItemStack p_146982_1_, int p_146982_2_, int p_146982_3_, String p_146982_4_) {
      ...
      itemRender.renderItemAndEffectIntoGUI(this.fontRendererObj, mc.getTextureManager(), p_146982_1_, p_146982_2_, p_146982_3_);
      itemRender.renderItemOverlayIntoGUI(this.fontRendererObj, mc.getTextureManager(), p_146982_1_, p_146982_2_, p_146982_3_ - (this.field_147012_x == null?0:8), p_146982_4_);
      this.zLevel = 0.0F;
   ...
   private void func_146977_a(Slot p_146977_1_) {
      ...
      if(!var6) {
         ...
         GL11.glEnable(GL11.GL_DEPTH_TEST);
         itemRender.renderItemAndEffectIntoGUI(this.fontRendererObj, mc.getTextureManager(), var4, var2, var3);
         itemRender.renderItemOverlayIntoGUI(this.fontRendererObj, mc.getTextureManager(), var4, var2, var3, var8);
      }
   ...
   protected void mouseClicked(int p_73864_1_, int p_73864_2_, int p_73864_3_) {
      ...
      boolean var4 = p_73864_3_ == mc.gameSettings.keyBindPickBlock.getKeyCode() + 100;
   ...
   protected void mouseClickMove(int p_146273_1_, int p_146273_2_, int p_146273_3_, long p_146273_4_) {
      ...
      ItemStack var7 = mc.thePlayer.inventory.getItemStack();
      if(this.field_147005_v != null && mc.gameSettings.touchscreen) {
         ...
         if(isShiftKeyDown()) {
            if(var4 != null && var4.inventory != null && this.field_146994_N != null) {
               ...
               while(var11.hasNext()) {
                  ...
                  if(var10 != null && var10.canTakeStack(mc.thePlayer) && var10.getHasStack() && var10.inventory == var4.inventory && Container.func_94527_a(var10, this.field_146994_N, true)) {
   ...
   protected void func_146984_a(Slot p_146984_1_, int p_146984_2_, int p_146984_3_, int p_146984_4_) {
      ...
      mc.playerController.windowClick(this.field_147002_h.windowId, p_146984_2_, p_146984_3_, p_146984_4_, mc.thePlayer);
   }
   ...
   protected boolean func_146983_a(int p_146983_1_) {
      if(mc.thePlayer.inventory.getItemStack() == null && this.field_147006_u != null) {
         for(int var2 = 0; var2 < 9; ++var2) {
            if(p_146983_1_ == mc.gameSettings.keyBindsHotbar[var2].getKeyCode()) {
   ...
   public void onGuiClosed() {
      if(mc.thePlayer != null) {
         this.field_147002_h.onContainerClosed(mc.thePlayer);
      }
   }
