...
public class GuiBeacon extends GuiContainer {
   ...
   public void updateScreen() {
      ...
      if(this.field_147027_y && this.field_147024_w.func_145998_l() >= 0) {
         ...
         for(int var7 = 0; var7 <= 2; ++var7) {
            var2 = TileEntityBeacon.field_146009_a[var7].length;
            var3 = var2 * 22 + (var2 - 1) * 2;

            for(var4 = 0; var4 < var2; ++var4) {
               var5 = TileEntityBeacon.field_146009_a[var7][var4].id;
               var6 = new GuiBeacon.PowerButton(var7 << 8 | var5, this.field_147003_i + 76 + var4 * 24 - var3 / 2, this.field_147009_r + 22 + var7 * 25, var5, var7);
         ...
         byte var81 = 3;
         var2 = TileEntityBeacon.field_146009_a[var81].length + 1;
         var3 = var2 * 22 + (var2 - 1) * 2;

         for(var4 = 0; var4 < var2 - 1; ++var4) {
            var5 = TileEntityBeacon.field_146009_a[var81][var4].id;
            var6 = new GuiBeacon.PowerButton(var81 << 8 | var5, this.field_147003_i + 167 + var4 * 24 - var3 / 2, this.field_147009_r + 47, var5, var81);
            this.buttonList.add(var6);
            if(var81 >= this.field_147024_w.func_145998_l()) {
               var6.enabled = false;
         ...
         if(this.field_147024_w.func_146007_j() > 0) {
            GuiBeacon.PowerButton var8 = new GuiBeacon.PowerButton(var81 << 8 | this.field_147024_w.func_146007_j(), this.field_147003_i + 167 + (var2 - 1) * 24 - var3 / 2, this.field_147009_r + 47, this.field_147024_w.func_146007_j(), var81);
   ...
   protected void actionPerformed(GuiButton p_146284_1_) {
      if(p_146284_1_.id == -2) {
         ...
         String var10 = "MC|Beacon";
         ByteBuf var11 = Unpooled.buffer();

         try {
            var11.writeInt(this.field_147024_w.func_146007_j());
            var11.writeInt(this.field_147024_w.func_146006_k());
            mc.getNetHandler().addToSendQueue(new C17PacketCustomPayload(var10, var11));
         ...
         int var101 = p_146284_1_.id;
         int var111 = var101 & 255;
         int var4 = var101 >> 8;
         if(var4 < 3) {
            this.field_147024_w.func_146001_d(var111);
         } else {
            this.field_147024_w.func_146004_e(var111);
         }
   ...
   protected void func_146976_a(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
      ...
      itemRender.renderItemAndEffectIntoGUI(this.fontRendererObj, mc.getTextureManager(), new ItemStack(Items.emerald), var4 + 42, var5 + 109);
      itemRender.renderItemAndEffectIntoGUI(this.fontRendererObj, mc.getTextureManager(), new ItemStack(Items.diamond), var4 + 42 + 22, var5 + 109);
      itemRender.renderItemAndEffectIntoGUI(this.fontRendererObj, mc.getTextureManager(), new ItemStack(Items.gold_ingot), var4 + 42 + 44, var5 + 109);
      itemRender.renderItemAndEffectIntoGUI(this.fontRendererObj, mc.getTextureManager(), new ItemStack(Items.iron_ingot), var4 + 42 + 66, var5 + 109);
