...
public class GuiContainerCreative extends InventoryEffectRenderer {
         ...
         if(p_146984_1_ == this.field_147064_C && var5) {
            ...
            if(field_147058_w == CreativeTabs.tabInventory.getTabIndex()) {
               if(p_146984_1_ == this.field_147064_C) {
                  ...
                  mc.thePlayer.inventoryContainer.slotClick(p_146984_1_ == null?p_146984_2_:((GuiContainerCreative.CreativeSlot)p_146984_1_).field_148332_b.slotNumber, p_146984_3_, p_146984_4_, mc.thePlayer);
               ...
               if(p_146984_4_ == 2) {
                  if(var8 != null && p_146984_3_ >= 0 && p_146984_3_ < 9) {
                     ...
                     mc.thePlayer.inventory.setInventorySlotContents(p_146984_3_, var9);
                     mc.thePlayer.inventoryContainer.detectAndSendChanges();
                  }
               ...
               this.field_147002_h.slotClick(p_146984_1_ == null?p_146984_2_:p_146984_1_.slotNumber, p_146984_3_, p_146984_4_, mc.thePlayer);
               if(Container.func_94532_c(p_146984_3_) == 2) {
                  for(var10 = 0; var10 < 9; ++var10) {
                     mc.playerController.sendSlotPacket(this.field_147002_h.getSlot(45 + var10).getStack(), 36 + var10);
                  }
               } else if(p_146984_1_ != null) {
                  var6 = this.field_147002_h.getSlot(p_146984_1_.slotNumber).getStack();
                  mc.playerController.sendSlotPacket(var6, p_146984_1_.slotNumber - this.field_147002_h.inventorySlots.size() + 9 + 36);
               }
            }
         }
      }
   ...
   public void initGui() {
      if(mc.playerController.isInCreativeMode()) {
         ...
         this.field_147059_E = new CreativeCrafting(mc);
         mc.thePlayer.inventoryContainer.addCraftingToCrafters(this.field_147059_E);
      } else {
         mc.displayGuiScreen(new GuiInventory(mc.thePlayer));
      }
   }
   ...
   public void onGuiClosed() {
      ...
      if(mc.thePlayer != null && mc.thePlayer.inventory != null) {
         mc.thePlayer.inventoryContainer.removeCraftingFromCrafters(this.field_147059_E);
      }
   ...
   private void func_147053_i() {
      ...
      while(var2.hasNext()) {
         ...
         if(var8 != null && var8.getCreativeTab() != null) {
            var8.getSubItems(var8, (CreativeTabs)null, var1.field_148330_a);
         }
      }
      ...
      String var111 = this.field_147062_A.getText().toLowerCase();

      while(var2.hasNext()) {
         ItemStack var121 = (ItemStack)var2.next();
         boolean var12 = false;
         Iterator var6 = var121.getTooltip(mc.thePlayer, mc.gameSettings.advancedItemTooltips).iterator();
   ...
   protected void func_146285_a(ItemStack p_146285_1_, int p_146285_2_, int p_146285_3_) {
      if(field_147058_w == CreativeTabs.tabAllSearch.getTabIndex()) {
         List var4 = p_146285_1_.getTooltip(mc.thePlayer, mc.gameSettings.advancedItemTooltips);
         CreativeTabs var5 = p_146285_1_.getItem().getCreativeTab();
         if(var5 == null && p_146285_1_.getItem() == Items.enchanted_book) {
            Map var12 = EnchantmentHelper.getEnchantments(p_146285_1_);
            if(var12.size() == 1) {
               Enchantment var7 = Enchantment.enchantmentsList[((Integer)var12.keySet().iterator().next()).intValue()];
         ...
         for(int var121 = 0; var121 < var4.size(); ++var121) {
            if(var121 == 0) {
               var4.set(var121, p_146285_1_.getRarity().rarityColor + (String)var4.get(var121));
            } else {
               var4.set(var121, EnumChatFormatting.GRAY + (String)var4.get(var121));
            }
         }
   ...
   protected void func_146976_a(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
      ...
      for(var7 = 0; var7 < var6; ++var7) {
         ...
         if(var9.getTabIndex() != field_147058_w) {
            this.func_147051_a(var9);
         }
      }
      ...
      GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
      int var91 = this.field_147003_i + 175;
      var6 = this.field_147009_r + 18;
      var7 = var6 + 112;
      mc.getTextureManager().bindTexture(field_147061_u);
      if(var4.shouldHidePlayerInventory()) {
         this.drawTexturedModalRect(var91, var6 + (int)((float)(var7 - var6 - 17) * this.field_147067_x), 232 + (this.func_147055_p()?0:12), 0, 12, 15);
      }

      this.func_147051_a(var4);
      if(var4 == CreativeTabs.tabInventory) {
         GuiInventory.func_147046_a(this.field_147003_i + 43, this.field_147009_r + 45, 20, (float)(this.field_147003_i + 43 - p_146976_2_), (float)(this.field_147009_r + 45 - 30 - p_146976_3_), mc.thePlayer);
      }
   }
   ...
   protected void func_147051_a(CreativeTabs p_147051_1_) {
      ...
      itemRender.renderItemAndEffectIntoGUI(this.fontRendererObj, mc.getTextureManager(), var10, var7, var8);
      itemRender.renderItemOverlayIntoGUI(this.fontRendererObj, mc.getTextureManager(), var10, var7, var8);
      GL11.glDisable(GL11.GL_LIGHTING);
