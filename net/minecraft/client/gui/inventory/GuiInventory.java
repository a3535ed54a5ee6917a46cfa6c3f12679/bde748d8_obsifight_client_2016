...
import fr.thisismac.injector.customclass.GuiSetMacro;
import fr.thisismac.injector.customclass.GuiTest;
...
public class GuiInventory extends InventoryEffectRenderer {
   ...
   public void initGui() {
      ...
      if(mc.theWorld.isClient) {
         if(!mc.thePlayer.getActivePotionEffects().isEmpty()) {
            this.buttonList.add(new GuiButton(4, this.width / 2 + 150, this.height / 2 - 75, 80, 20, "Menu craft"));
            this.buttonList.add(new GuiButton(5, this.width / 2 + 150, this.height / 2 - 25, 80, 20, "Menu waypoint"));
            this.buttonList.add(new GuiButton(6, this.width / 2 + 150, this.height / 2 - 50, 80, 20, "Menu macro"));
         } else {
            this.buttonList.add(new GuiButton(4, this.width / 2 + 90, this.height / 2 - 75, 80, 20, "Menu craft"));
            this.buttonList.add(new GuiButton(5, this.width / 2 + 90, this.height / 2 - 25, 80, 20, "Menu waypoint"));
            this.buttonList.add(new GuiButton(6, this.width / 2 + 90, this.height / 2 - 50, 80, 20, "Menu macro"));
         }
      }
   ...
   protected void actionPerformed(GuiButton p_146284_1_) {
      ...
      if(p_146284_1_.id == 6) {
         mc.displayGuiScreen(new GuiSetMacro(mc, mc.theWorld));
      }

      if(p_146284_1_.id == 7) {
         mc.displayGuiScreen(new GuiTest(new ModelDemonWings(), "textures/models/customs/demon_wings.png"));
      }
   }
}
