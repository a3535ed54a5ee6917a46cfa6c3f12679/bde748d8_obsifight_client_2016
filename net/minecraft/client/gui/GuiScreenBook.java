   ...
   private void func_146462_a(boolean p_146462_1_) {
      if(this.field_146475_i && this.field_146481_r && this.field_146483_y != null) {
         ...
         if(this.field_146474_h.hasTagCompound()) {
            NBTTagCompound var3 = this.field_146474_h.getTagCompound();
         ...
         ByteBuf var31 = Unpooled.buffer();

         try {
            (new PacketBuffer(var31)).writeItemStackToBuffer(this.field_146474_h);
            mc.getNetHandler().addToSendQueue(new C17PacketCustomPayload(var2, var31));
