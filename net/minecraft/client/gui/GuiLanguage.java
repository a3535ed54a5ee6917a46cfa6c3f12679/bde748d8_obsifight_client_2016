...
public class GuiLanguage extends GuiScreen {
   ...
   protected void actionPerformed(GuiButton p_146284_1_) {
      if(p_146284_1_.enabled) {
         ...
         case 5:
            break;
         case 6:
            mc.displayGuiScreen(this.field_146453_a);
            break;
         case 100:
            if(p_146284_1_ instanceof GuiOptionButton) {
               ...
               this.setWorldAndResolution(mc, var3, var4);
            }
            break;
         default:
   ...
   class List extends GuiSlot {
      ...
      public List() {
         super(GuiLanguage.mc, GuiLanguage.this.width, GuiLanguage.this.height, 32, GuiLanguage.this.height - 65 + 4, 18);
      ...
      protected void elementClicked(int p_148144_1_, boolean p_148144_2_, int p_148144_3_, int p_148144_4_) {
         ...
         GuiLanguage.mc.refreshResources();
