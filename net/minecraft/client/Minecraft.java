...
import fr.thisismac.injector.customclass.CustomPauseMenu;
...
public class Minecraft implements IPlayerUsage {
   ...
   private void startGame() throws LWJGLException {
      ...
      Core.get();
      Display.setTitle(var10000.append("Obsifight").append(" 1.7.10").toString());
      logger.info("LWJGL Version: " + Sys.getVersion());
      Util.EnumOS var1 = Util.getOSType();
      if(var1 != Util.EnumOS.OSX) {
         try {
            InputStream var4 = this.mcDefaultResourcePack.func_152780_c(new ResourceLocation("icons/icon_16x16.png"));
            InputStream var3 = this.mcDefaultResourcePack.func_152780_c(new ResourceLocation("icons/icon_32x32.png"));
            if(var4 != null && var3 != null) {
               Display.setIcon(new ByteBuffer[]{this.func_152340_a(var4), this.func_152340_a(var3)});
            }
   ...
   public void refreshResources() {
      ...
      while(var2.hasNext()) {
         ResourcePackRepository.Entry var4 = (ResourcePackRepository.Entry)var2.next();
         var1.add(var4.getResourcePack());
      }
      ...
      try {
         ...
         logger.info("Caught error stitching, removing all assigned resourcepacks", var41);
         var1.clear();
   ...
   public void displayGuiScreen(GuiScreen p_147108_1_) {
      ...
      if(p_147108_1_ == null && this.theWorld == null) {
         p_147108_1_ = new CustomMainMenu();
   ...
   private void runGameLoop() {
      ...
      if(this.isGamePaused && this.theWorld != null) {
         float var5 = this.timer.renderPartialTicks;
         this.timer.updateTimer();
         this.timer.renderPartialTicks = var5;
      } else {
         this.timer.updateTimer();
      }
      ...
      long var61 = System.nanoTime() - var51;
   ...
   private void displayDebugInfo(long p_71366_1_) {
      if(this.mcProfiler.profilingEnabled) {
         ...
         for(int var18 = 0; var18 < var3.size(); ++var18) {
            Profiler.Result var19 = (Profiler.Result)var3.get(var18);
            var13 = MathHelper.floor_double(var19.field_76332_a / 4.0D) + 1;
            var5.startDrawing(6);
            var5.setColorOpaque_I(var19.func_76329_a());
            ...
            for(var20 = var13; var20 >= 0; --var20) {
               var21 = (float)((var9 + var19.field_76332_a * (double)var20 / (double)var13) * Math.PI * 2.0D / 100.0D);
               var22 = MathHelper.sin(var21) * (float)var6;
               var17 = MathHelper.cos(var21) * (float)var6 * 0.5F;
               var5.addVertex((double)((float)var7 + var22), (double)((float)var8 - var17), 0.0D);
            }

            var5.draw();
            var5.startDrawing(5);
            var5.setColorOpaque_I((var19.func_76329_a() & 16711422) >> 1);
            ...
            for(var20 = var13; var20 >= 0; --var20) {
               ...
               var17 = MathHelper.cos(var21) * (float)var6 * 0.5F;
               var5.addVertex((double)((float)var7 + var22), (double)((float)var8 - var17), 0.0D);
               var5.addVertex((double)((float)var7 + var22), (double)((float)var8 - var17 + 10.0F), 0.0D);
            }

            var5.draw();
            var9 += var19.field_76332_a;
         }

         DecimalFormat var181 = new DecimalFormat("##0.00");
         GL11.glEnable(GL11.GL_TEXTURE_2D);
         String var191 = "";
         ...
         if(var4.field_76331_c.length() == 0) {
            ...
            var191 = var191 + var4.field_76331_c + " ";
         }

         var13 = 16777215;
         this.fontRenderer.drawStringWithShadow(var191, var7 - var6, var8 - var6 / 2 - 16, var13);
         this.fontRenderer.drawStringWithShadow(var191 = var181.format(var4.field_76330_b) + "%", var7 + var6 - this.fontRenderer.getStringWidth(var191), var8 - var6 / 2 - 16, var13);

         for(var20 = 0; var20 < var3.size(); ++var20) {
            Profiler.Result var201 = (Profiler.Result)var3.get(var20);
            String var211 = "";
            if(var201.field_76331_c.equals("unspecified")) {
               var211 = var211 + "[?] ";
            } else {
               var211 = var211 + "[" + (var20 + 1) + "] ";
            }

            var211 = var211 + var201.field_76331_c;
            this.fontRenderer.drawStringWithShadow(var211, var7 - var6, var8 + var6 / 2 + var20 * 8 + 20, var201.func_76329_a());
            this.fontRenderer.drawStringWithShadow(var211 = var181.format(var201.field_76332_a) + "%", var7 + var6 - 50 - this.fontRenderer.getStringWidth(var211), var8 + var6 / 2 + var20 * 8 + 20, var201.func_76329_a());
            this.fontRenderer.drawStringWithShadow(var211 = var181.format(var201.field_76330_b) + "%", var7 + var6 - this.fontRenderer.getStringWidth(var211), var8 + var6 / 2 + var20 * 8 + 20, var201.func_76329_a());
         }
      }
   }
   ...
   public void displayInGameMenu() {
      if(this.currentScreen == null) {
         this.displayGuiScreen(new CustomPauseMenu());
   ...
   private void func_147121_ag() {
      ...
      if(this.objectMouseOver == null) {
         ...
         case 1:
            ...
            break;
         case 2:
            int var7 = this.objectMouseOver.blockX;
            int var4 = this.objectMouseOver.blockY;
            int var5 = this.objectMouseOver.blockZ;
            if(this.theWorld.getBlock(var7, var4, var5).getMaterial() != Material.air) {
               int var6 = var2 != null?var2.stackSize:0;
               if(this.playerController.onPlayerRightClick(this.thePlayer, this.theWorld, var2, var7, var4, var5, this.objectMouseOver.sideHit, this.objectMouseOver.hitVec)) {
                  var1 = false;
                  this.thePlayer.swingItem();
               }
      ...
      if(var1) {
         ItemStack var71 = this.thePlayer.inventory.getCurrentItem();
         if(var71 != null && this.playerController.sendUseItem(this.thePlayer, this.theWorld, var71)) {
   ...
   public void runTick() {
      this.mcProfiler.startSection("modInjector");
      Core.get().tick();
      this.mcProfiler.startSection("scheduledExecutables");
      Queue var1 = this.field_152351_aB;
      Queue var2 = this.field_152351_aB;
      ...
      if(this.currentScreen != null) {
         try {
            ...
            var12 = CrashReport.makeCrashReport(var9, "Updating screen events");
            var3 = var12.makeCategory("Affected screen");
         ...
         if(this.currentScreen != null) {
            try {
               ...
               var12 = CrashReport.makeCrashReport(var8, "Ticking screen");
               var3 = var12.makeCategory("Affected screen");
               var3.addCrashSectionCallable("Screen name", new Callable() {
      ...
      if(this.currentScreen == null || this.currentScreen.field_146291_p) {
         ...
         int var7;
         while(Mouse.next()) {
            var7 = Mouse.getEventButton();
            KeyBinding.setKeyBindState(var7 - 100, Mouse.getEventButtonState());
            if(Mouse.getEventButtonState()) {
               KeyBinding.onTick(var7 - 100);
            }
            ...
            if(Keyboard.getEventKeyState()) {
               ...
               if(this.currentScreen != null) {
                  ...
                  if(Keyboard.getEventKey() == 33 && Keyboard.isKeyDown(61)) {
                     var13 = Keyboard.isKeyDown(42) | Keyboard.isKeyDown(54);
                     this.gameSettings.setOptionValue(GameSettings.Options.RENDER_DISTANCE, var13?-1:1);
                  }
         ...
         for(var7 = 0; var7 < 9; ++var7) {
            if(this.gameSettings.keyBindsHotbar[var7].isPressed()) {
               this.thePlayer.inventory.currentItem = var7;
            }
         }

         var13 = this.gameSettings.chatVisibility != EntityPlayer.EnumChatVisibility.HIDDEN;
         ...
         while(this.gameSettings.keymacro1.isPressed()) {
            this.thePlayer.sendChatMessage(Core.macro1);
         }

         while(this.gameSettings.keymacro2.isPressed()) {
            this.thePlayer.sendChatMessage(Core.macro2);
         }

         while(this.gameSettings.keymacro3.isPressed()) {
            this.thePlayer.sendChatMessage(Core.macro3);
         }

         while(this.gameSettings.keymacro4.isPressed()) {
            this.thePlayer.sendChatMessage(Core.macro4);
         }

         while(this.gameSettings.keyBindChat.isPressed() && var13) {
            this.displayGuiScreen(new GuiChat());
         }

         if(this.currentScreen == null && this.gameSettings.keyBindCommand.isPressed() && var13) {
            this.displayGuiScreen(new GuiChat("/"));
         }
      ...
      if(this.theWorld != null) {
         if(!this.isGamePaused) {
            ...
            try {
               ...
               var12 = CrashReport.makeCrashReport(var101, "Exception in world tick");
               if(this.theWorld == null) {
                  var3 = var12.makeCategory("Affected level");
                  var3.addCrashSection("Problem", "Level is null!");
               } else {
                  this.theWorld.addWorldInfoToCrashReport(var12);
               }
   ...
   public void launchIntegratedServer(String p_71371_1_, String p_71371_2_, WorldSettings p_71371_3_) {
      ...
      try {
         ...
         CrashReport var12 = CrashReport.makeCrashReport(var10, "Starting integrated server");
         CrashReportCategory var8 = var12.makeCategory("Starting integrated server");
      ...
      while(!this.theIntegratedServer.serverIsInRunLoop()) {
         String var11 = this.theIntegratedServer.getUserMessage();
         if(var11 != null) {
            this.loadingScreen.resetProgresAndWorkingMessage(I18n.format(var11, new Object[0]));
         } else {
      ...
      this.displayGuiScreen((GuiScreen)null);
      SocketAddress var111 = this.theIntegratedServer.func_147137_ag().addLocalEndpoint();
      NetworkManager var121 = NetworkManager.provideLocalClient(var111);
      var121.setNetHandler(new NetHandlerLoginClient(var121, this, (GuiScreen)null));
      var121.scheduleOutboundPacket(new C00Handshake(66, var111.toString(), 0, EnumConnectionState.LOGIN), new GenericFutureListener[0]);
      var121.scheduleOutboundPacket(new C00PacketLoginStart(this.getSession().func_148256_e()), new GenericFutureListener[0]);
      this.myNetworkManager = var121;
   }
   ...
   private void func_147112_ai() {
      if(this.objectMouseOver != null) {
         ...
         if(this.objectMouseOver.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK) {
            ...
            int var11 = this.objectMouseOver.blockY;
            int var12 = this.objectMouseOver.blockZ;
            Block var8 = this.theWorld.getBlock(var5, var11, var12);
            if(var8.getMaterial() == Material.air) {
               return;
            }

            var2 = var8.getItem(this.theWorld, var5, var11, var12);
            if(var2 == null) {
               return;
            }
            ...
            var3 = var9.getDamageValue(this.theWorld, var5, var11, var12);
         } else {
            ...
            if(this.objectMouseOver.entityHit instanceof EntityPainting) {
               ...
               EntityItemFrame var111 = (EntityItemFrame)this.objectMouseOver.entityHit;
               ItemStack var121 = var111.getDisplayedItem();
               if(var121 == null) {
                  var2 = Items.item_frame;
               } else {
                  var2 = var121.getItem();
                  var3 = var121.getItemDamage();
                  var4 = true;
               }
            } else if(this.objectMouseOver.entityHit instanceof EntityMinecart) {
               EntityMinecart var112 = (EntityMinecart)this.objectMouseOver.entityHit;
               if(var112.getMinecartType() == 2) {
                  var2 = Items.furnace_minecart;
               } else if(var112.getMinecartType() == 1) {
                  var2 = Items.chest_minecart;
               } else if(var112.getMinecartType() == 3) {
                  var2 = Items.tnt_minecart;
               } else if(var112.getMinecartType() == 5) {
                  var2 = Items.hopper_minecart;
               } else if(var112.getMinecartType() == 6) {
   ...
   public void func_152348_aa() {
      ...
      if(var1 != 0 && !Keyboard.isRepeatEvent() && (!(this.currentScreen instanceof GuiControls) || ((GuiControls)this.currentScreen).field_152177_g <= getSystemTime() - 20L)) {
         if(Keyboard.getEventKeyState()) {
   ...
   public ListenableFuture func_152343_a(Callable p_152343_1_) {
      ...
      if(!this.func_152345_ab()) {
         ListenableFutureTask var6 = ListenableFutureTask.create(p_152343_1_);
         Queue var3 = this.field_152351_aB;
         Queue var4 = this.field_152351_aB;
         synchronized(this.field_152351_aB) {
            this.field_152351_aB.add(var6);
            return var6;
         }
      } else {
         try {
