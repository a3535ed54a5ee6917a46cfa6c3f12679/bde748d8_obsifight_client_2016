...
public class HttpUtil {
   ...
   private static String func_151225_a(URL p_151225_0_, String p_151225_1_, boolean p_151225_2_) {
      try {
         Proxy var9 = MinecraftServer.getServer() == null?null:MinecraftServer.getServer().getServerProxy();
         if(var9 == null) {
            var9 = Proxy.NO_PROXY;
         }

         HttpURLConnection var4 = (HttpURLConnection)p_151225_0_.openConnection(var9);
         ...
         if(!p_151225_2_) {
            logger.error("Could not post to " + p_151225_0_, var91);
         }
         ...
         public void run() {
            ...
            try {
               try {
                  ...
                  while(var8.hasNext()) {
                     Entry var28 = (Entry)var8.next();
                     var1.setRequestProperty((String)var28.getKey(), (String)var28.getValue());
                     if(p_151223_5_ != null) {
                  ...
                  if(p_151223_0_.exists()) {
                     ...
                     HttpUtil.logger.warn("Deleting " + p_151223_0_ + " as it does not match what we currently have (" + var29 + " vs our " + var30 + ").");
                     p_151223_0_.delete();
