...
public class Blocks {
   ...
   public static final Block stained_stonebrick = (Block)Block.blockRegistry.getObject("stained_stonebrick");
   public static final Block renforced_wood = (Block)Block.blockRegistry.getObject("renforced_wood");
   public static final Block renforced_stone = (Block)Block.blockRegistry.getObject("renforced_stone");
   public static final Block renforced_brick = (Block)Block.blockRegistry.getObject("renforced_brick");
   public static final Block chest_garnet = (Block)Block.blockRegistry.getObject("chest_garnet");
   public static final Block chest_amethyst = (Block)Block.blockRegistry.getObject("chest_amethyst");
   public static final Block chest_titanium = (Block)Block.blockRegistry.getObject("chest_titanium");
   public static final Block chest_xenotium = (Block)Block.blockRegistry.getObject("chest_xenotium");
   public static final Block invisible_block = (Block)Block.blockRegistry.getObject("invisible_block");
   public static final Block invisible_block_light = (Block)Block.blockRegistry.getObject("invisible_block_light");
   public static final Block copper_ore = (Block)Block.blockRegistry.getObject("copper_ore");
   public static final Block stone_andesite = (Block)Block.blockRegistry.getObject("stone_andesite");
   public static final Block sadian_block = (Block)Block.blockRegistry.getObject("sadian_block");
   public static final Block xtnt = (Block)Block.blockRegistry.getObject("xtnt");
   public static final Block iron_ladder = (Block)Block.blockRegistry.getObject("iron_ladder");
   public static final Block weed = (Block)Block.blockRegistry.getObject("weed");
   public static final Block renforced_glass = (Block)Block.blockRegistry.getObject("renforced_glass");
   public static final Block terrazine_block = (Block)Block.blockRegistry.getObject("terrazine_block");
   public static final Block terrazine_ore = (Block)Block.blockRegistry.getObject("terrazine_ore");
   public static final Block end_brick = (Block)Block.blockRegistry.getObject("end_brick");
   public static final Block quartz_noir = (Block)Block.blockRegistry.getObject("quartz_noir");
   public static final Block custom_door = (Block)Block.blockRegistry.getObject("CUSTOM_DOOR");
   public static final Block custom_trapdoor = (Block)Block.blockRegistry.getObject("custom_trapdoor");
   public static final Block trapblock = (Block)Block.blockRegistry.getObject("trapblock");
   public static final Block xpBlock = (Block)Block.blockRegistry.getObject("xpBlock");
   public static final Block obsidian_stair = (Block)Block.blockRegistry.getObject("obsidian_stair");
   public static final Block JumpBlock = (Block)Block.blockRegistry.getObject("JumpBlock");
   public static final Block stained_sand = (Block)Block.blockRegistry.getObject("colosand");
   public static final Block stained_sand_black = (Block)Block.blockRegistry.getObject("stained_sand_black");
   public static final Block stained_sand_red = (Block)Block.blockRegistry.getObject("stained_sand_red");
   public static final Block stained_sand_green = (Block)Block.blockRegistry.getObject("stained_sand_green");
   public static final Block stained_sand_brown = (Block)Block.blockRegistry.getObject("stained_sand_brown");
   public static final Block stained_sand_blue = (Block)Block.blockRegistry.getObject("stained_sand_blue");
   public static final Block stained_sand_purple = (Block)Block.blockRegistry.getObject("stained_sand_purple");
   public static final Block stained_sand_cyan = (Block)Block.blockRegistry.getObject("stained_sand_cyan");
   public static final Block stained_sand_silver = (Block)Block.blockRegistry.getObject("stained_sand_silver");
   public static final Block stained_sand_gray = (Block)Block.blockRegistry.getObject("stained_sand_gray");
   public static final Block stained_sand_pink = (Block)Block.blockRegistry.getObject("stained_sand_pink");
   public static final Block stained_sand_lime = (Block)Block.blockRegistry.getObject("stained_sand_lime");
   public static final Block stained_sand_yellow = (Block)Block.blockRegistry.getObject("stained_sand_yellow");
   public static final Block stained_sand_lignt_blue = (Block)Block.blockRegistry.getObject("stained_sand_lignt_blue");
   public static final Block stained_sand_magenta = (Block)Block.blockRegistry.getObject("stained_sand_magenta");
   public static final Block stained_sand_orange = (Block)Block.blockRegistry.getObject("stained_sand_orange");
   public static final Block stained_sand_white = (Block)Block.blockRegistry.getObject("stained_sand_white");
   public static final Block stainedSand = (Block)Block.blockRegistry.getObject("stainedSand");
   public static final Block bone_block = (Block)Block.blockRegistry.getObject("bone_block");
   public static final Block garnet_ore = (Block)Block.blockRegistry.getObject("garnet_ore");
   public static final Block amethyst_ore = (Block)Block.blockRegistry.getObject("amethyst_ore");
   public static final Block titanium_ore = (Block)Block.blockRegistry.getObject("titanium_ore");
   public static final Block xenotium_ore = (Block)Block.blockRegistry.getObject("xenotium_ore");
   public static final Block manganese_ore = (Block)Block.blockRegistry.getObject("manganese_ore");
   public static final Block garnet_block = (Block)Block.blockRegistry.getObject("garnet_block");
   public static final Block amethyst_block = (Block)Block.blockRegistry.getObject("amethyst_block");
   public static final Block titanium_block = (Block)Block.blockRegistry.getObject("titanium_block");
   public static final Block xenotium_block = (Block)Block.blockRegistry.getObject("xenotium_block");
   public static final Block manganese_block = (Block)Block.blockRegistry.getObject("manganese_block");
   public static final Block WorkSurface = (Block)Block.blockRegistry.getObject("WorkSurface");
