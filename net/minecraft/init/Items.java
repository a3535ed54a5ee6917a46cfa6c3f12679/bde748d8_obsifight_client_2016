...
public class Items {
   ...
   public static final Item key_garnet = (Item)Item.itemRegistry.getObject("key_garnet");
   public static final Item key_amethyst = (Item)Item.itemRegistry.getObject("key_amethyst");
   public static final Item key_titanium = (Item)Item.itemRegistry.getObject("key_titanium");
   public static final Item key_obsidian = (Item)Item.itemRegistry.getObject("key_obsidian");
   public static final Item copper_ingot = (Item)Item.itemRegistry.getObject("copper_ingot");
   public static final Item admin_axe = (Item)Item.itemRegistry.getObject("admin_axe");
   public static final Item core_neutral = (Item)Item.itemRegistry.getObject("core_neutral");
   public static final Item core_obsidian = (Item)Item.itemRegistry.getObject("core_obsidian");
   public static final Item core_titanium = (Item)Item.itemRegistry.getObject("core_titanium");
   public static final Item core_xenotium = (Item)Item.itemRegistry.getObject("core_xenotium");
   public static final Item orb_repair = (Item)Item.itemRegistry.getObject("orb_repair");
   public static final Item canabis_seed = (Item)Item.itemRegistry.getObject("canabis_seed");
   public static final Item canabis = (Item)Item.itemRegistry.getObject("canabis");
   public static final Item canabis_seche = (Item)Item.itemRegistry.getObject("canabis_seche");
   public static final Item pizza = (Item)Item.itemRegistry.getObject("pizza");
   public static final Item kebab = (Item)Item.itemRegistry.getObject("kebab");
   public static final Item logblock_tool = (Item)Item.itemRegistry.getObject("logblock_tool");
   public static final Item shop_tool = (Item)Item.itemRegistry.getObject("shop_tool");
   public static final Item joint = (Item)Item.itemRegistry.getObject("joint");
   public static final Item terrazine_ingot = (Item)Item.itemRegistry.getObject("terrazine_ingot");
   public static final Item debuff = (Item)Item.itemRegistry.getObject("debuff");
   public static final Item cookie_garnet = (Item)Item.itemRegistry.getObject("cookie_garnet");
   public static final Item cookie_amethyste = (Item)Item.itemRegistry.getObject("cookie_amethyste");
   public static final Item cookie_titanium = (Item)Item.itemRegistry.getObject("cookie_titanium");
   public static final Item cookie_obsidian = (Item)Item.itemRegistry.getObject("cookie_obsidian");
   public static final Item customDoor = (Item)Item.itemRegistry.getObject("customDoor");
   public static final ItemArmor manganese_helmet = (ItemArmor)Item.itemRegistry.getObject("manganese_helmet");
   public static final ItemArmor manganese_chestplate = (ItemArmor)Item.itemRegistry.getObject("manganese_chestplate");
   public static final ItemArmor manganese_leggings = (ItemArmor)Item.itemRegistry.getObject("manganese_leggings");
   public static final ItemArmor manganese_boots = (ItemArmor)Item.itemRegistry.getObject("manganese_boots");
   public static final ItemArmor garnet_helmet = (ItemArmor)Item.itemRegistry.getObject("garnet_helmet");
   public static final ItemArmor garnet_chestplate = (ItemArmor)Item.itemRegistry.getObject("garnet_chestplate");
   public static final ItemArmor garnet_leggings = (ItemArmor)Item.itemRegistry.getObject("garnet_leggings");
   public static final ItemArmor garnet_boots = (ItemArmor)Item.itemRegistry.getObject("garnet_boots");
   public static final ItemArmor amethyst_helmet = (ItemArmor)Item.itemRegistry.getObject("amethyst_helmet");
   public static final ItemArmor amethyst_chestplate = (ItemArmor)Item.itemRegistry.getObject("amethyst_chestplate");
   public static final ItemArmor amethyst_leggings = (ItemArmor)Item.itemRegistry.getObject("amethyst_leggings");
   public static final ItemArmor amethyst_boots = (ItemArmor)Item.itemRegistry.getObject("amethyst_boots");
   public static final ItemArmor titanium_helmet = (ItemArmor)Item.itemRegistry.getObject("titanium_helmet");
   public static final ItemArmor titanium_chestplate = (ItemArmor)Item.itemRegistry.getObject("titanium_chestplate");
   public static final ItemArmor titanium_leggings = (ItemArmor)Item.itemRegistry.getObject("titanium_leggings");
   public static final ItemArmor titanium_boots = (ItemArmor)Item.itemRegistry.getObject("titanium_boots");
   public static final ItemArmor xenotium_helmet = (ItemArmor)Item.itemRegistry.getObject("xenotium_helmet");
   public static final ItemArmor xenotium_chestplate = (ItemArmor)Item.itemRegistry.getObject("xenotium_chestplate");
   public static final ItemArmor xenotium_leggings = (ItemArmor)Item.itemRegistry.getObject("xenotium_leggings");
   public static final ItemArmor xenotium_boots = (ItemArmor)Item.itemRegistry.getObject("xenotium_boots");
   public static final ItemArmor obsidium_helmet = (ItemArmor)Item.itemRegistry.getObject("obsidium_helmet");
   public static final ItemArmor obsidium_chestplate = (ItemArmor)Item.itemRegistry.getObject("obsidium_chestplate");
   public static final ItemArmor obsidium_leggings = (ItemArmor)Item.itemRegistry.getObject("obsidium_leggings");
   public static final ItemArmor obsidium_boots = (ItemArmor)Item.itemRegistry.getObject("obsidium_boots");
   public static final Item xenotium = (Item)Item.itemRegistry.getObject("ingot_xenotium");
   public static final Item garnet = (Item)Item.itemRegistry.getObject("ingot_garnet");
   public static final Item titanium = (Item)Item.itemRegistry.getObject("ingot_titanium");
   public static final Item manganese = (Item)Item.itemRegistry.getObject("ingot_manganese");
   public static final Item amethyst = (Item)Item.itemRegistry.getObject("ingot_amethyst");
   public static final Item obsidian = (Item)Item.itemRegistry.getObject("ingot_obsidian");
   public static final ItemBow bow_garnet = (ItemBow)Item.itemRegistry.getObject("bow_garnet");
   public static final ItemBow bow_amethyst = (ItemBow)Item.itemRegistry.getObject("bow_amethyst");
   public static final ItemBow bow_titanium = (ItemBow)Item.itemRegistry.getObject("bow_titanium");
   public static final ItemBow bow_xenotium = (ItemBow)Item.itemRegistry.getObject("bow_xenotium");
   public static final ItemBow bow_obsidium = (ItemBow)Item.itemRegistry.getObject("bow_obsidium");
   public static final ItemBow bow_manganese = (ItemBow)Item.itemRegistry.getObject("bow_manganese");
   public static final Item garnet_sword = (Item)Item.itemRegistry.getObject("sword_garnet");
   public static final Item amethyst_sword = (Item)Item.itemRegistry.getObject("sword_amethyst");
   public static final Item titanium_sword = (Item)Item.itemRegistry.getObject("sword_titanium");
   public static final Item xenotium_sword = (Item)Item.itemRegistry.getObject("sword_xenotium");
   public static final Item obsidium_sword = (Item)Item.itemRegistry.getObject("sword_obsidium");
   public static final Item manganese_sword = (Item)Item.itemRegistry.getObject("sword_manganese");
   public static final Item garnet_pickaxe = (Item)Item.itemRegistry.getObject("pickaxe_garnet");
   public static final Item amethyst_pickaxe = (Item)Item.itemRegistry.getObject("pickaxe_amethyst");
   public static final Item titanium_pickaxe = (Item)Item.itemRegistry.getObject("pickaxe_titanium");
   public static final Item xenotium_pickaxe = (Item)Item.itemRegistry.getObject("pickaxe_xenotium");
   public static final Item obsidium_pickaxe = (Item)Item.itemRegistry.getObject("pickaxe_obsidium");
   public static final Item manganese_pickaxe = (Item)Item.itemRegistry.getObject("pickaxe_manganese");
   public static final Item garnet_shovel = (Item)Item.itemRegistry.getObject("shovel_garnet");
   public static final Item amethyst_shovel = (Item)Item.itemRegistry.getObject("shovel_amethyst");
   public static final Item titanium_shovel = (Item)Item.itemRegistry.getObject("shovel_titanium");
   public static final Item xenotium_shovel = (Item)Item.itemRegistry.getObject("shovel_xenotium");
   public static final Item obsidium_shovel = (Item)Item.itemRegistry.getObject("shovel_obsidium");
   public static final Item manganese_shovel = (Item)Item.itemRegistry.getObject("shovel_manganese");
   public static final Item garnet_axe = (Item)Item.itemRegistry.getObject("axe_garnet");
   public static final Item amethyst_axe = (Item)Item.itemRegistry.getObject("axe_amethyst");
   public static final Item titanium_axe = (Item)Item.itemRegistry.getObject("axe_titanium");
   public static final Item xenotium_axe = (Item)Item.itemRegistry.getObject("axe_xenotium");
   public static final Item obsidium_axe = (Item)Item.itemRegistry.getObject("axe_obsidium");
   public static final Item manganese_axe = (Item)Item.itemRegistry.getObject("axe_manganese");
   public static final Item garnet_hoe = (Item)Item.itemRegistry.getObject("hoe_garnet");
   public static final Item amethyst_hoe = (Item)Item.itemRegistry.getObject("hoe_amethyst");
   public static final Item titanium_hoe = (Item)Item.itemRegistry.getObject("hoe_titanium");
   public static final Item xenotium_hoe = (Item)Item.itemRegistry.getObject("hoe_xenotium");
   public static final Item obsidium_hoe = (Item)Item.itemRegistry.getObject("hoe_obsidium");
   public static final Item manganese_hoe = (Item)Item.itemRegistry.getObject("hoe_manganese");
