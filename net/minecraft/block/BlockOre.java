...
public class BlockOre extends Block {
   ...
   public Item getItemDropped(int p_149650_1_, Random p_149650_2_, int p_149650_3_) {
      return this == Blocks.coal_ore?Items.coal:(this == Blocks.diamond_ore?Items.diamond:(this == Blocks.lapis_ore?Items.dye:(this == Blocks.emerald_ore?Items.emerald:(this == Blocks.quartz_ore?Items.quartz:(this == Block.getBlockFromName("garnet_ore")?Items.garnet:(this == Block.getBlockFromName("amethyst_ore")?Items.amethyst:(this == Block.getBlockFromName("titanium_ore")?Items.titanium:(this == Block.getBlockFromName("xenotium_ore")?Items.xenotium:(this == Block.getBlockFromName("manganese_ore")?Items.manganese:(this == Block.getBlockFromName("obsidian_ore")?Items.obsidian:Item.getItemFromBlock(this)))))))))));
   }
   ...
   public int damageDropped(int p_149692_1_) {
      return this == Blocks.lapis_ore?4:(this == Blocks.garnet_ore?0:(this == Blocks.amethyst_ore?0:(this == Blocks.titanium_ore?0:(this == Blocks.manganese_ore?0:(this == Blocks.xenotium_ore?0:0)))));
   }
}
