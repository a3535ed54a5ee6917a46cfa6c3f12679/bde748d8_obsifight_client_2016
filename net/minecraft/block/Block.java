...
import fr.thisismac.injector.customclass.BlockBon;
import fr.thisismac.injector.customclass.BlockColoredFalling;
import fr.thisismac.injector.customclass.BlockCustomTrapdoor;
import fr.thisismac.injector.customclass.BlockDoorCustom;
import fr.thisismac.injector.customclass.BlockJump;
import fr.thisismac.injector.customclass.BlockMagma;
import fr.thisismac.injector.customclass.BlockRenforcedGlass;
import fr.thisismac.injector.customclass.BlockTerrazine;
import fr.thisismac.injector.customclass.BlockTrap;
import fr.thisismac.injector.customclass.BlockXP;
import fr.thisismac.injector.customclass.BlockXTNT;
import fr.thisismac.injector.customclass.CustomBlockInvisible;
import fr.thisismac.injector.customclass.CustomChest;
...
public class Block {
   ...
   public static void registerBlocks() {
      ...
      Block stone = (new BlockStone()).setHardness(1.5F).setResistance(10.0F).setStepSound(soundTypePiston).setBlockName("stone").setBlockTextureName("stone");
      blockRegistry.addObject(1, "stone", stone);
      ...
      Block mossycobble = (new Block(Material.rock)).setHardness(2.0F).setResistance(10.0F).setStepSound(soundTypePiston).setBlockName("stoneMoss").setCreativeTab(CreativeTabs.tabBlock).setBlockTextureName("cobblestone_mossy");
      blockRegistry.addObject(48, "mossy_cobblestone", mossycobble);
      ...
      blockRegistry.addObject(176, "renforced_wood", (new Block(Material.anvil)).setBlockName("renforced_wood").setBlockTextureName("renforced_wood").setHardness(5.0F).setStepSound(soundTypeWood).setCreativeTab(CreativeTabs.tabBlock).setResistance(10.0F));
      blockRegistry.addObject(177, "renforced_stone", (new Block(Material.anvil)).setBlockName("renforced_stone").setBlockTextureName("renforced_stone").setHardness(5.0F).setStepSound(soundTypeStone).setCreativeTab(CreativeTabs.tabBlock).setResistance(10.0F));
      blockRegistry.addObject(178, "renforced_brick", (new Block(Material.anvil)).setBlockName("renforced_brick").setBlockTextureName("renforced_brick").setHardness(5.0F).setStepSound(soundTypeStone).setCreativeTab(CreativeTabs.tabBlock).setResistance(10.0F));
      blockRegistry.addObject(179, "chest_garnet", (new CustomChest(Integer.valueOf(2), "textures/entity/chest/chest_garnet.png")).setBlockName("chest_garnet").setHardness(2.5F));
      blockRegistry.addObject(180, "chest_amethyst", (new CustomChest(Integer.valueOf(3), "textures/entity/chest/chest_amethyste.png")).setBlockName("chest_amethyst").setHardness(2.5F));
      blockRegistry.addObject(181, "chest_titanium", (new CustomChest(Integer.valueOf(4), "textures/entity/chest/chest_titanium.png")).setBlockName("chest_titanium").setHardness(2.5F));
      blockRegistry.addObject(182, "chest_xenotium", (new CustomChest(Integer.valueOf(5), "textures/entity/chest/chest_xenotium.png")).setBlockName("chest_xenotium").setHardness(2.5F));
      blockRegistry.addObject(183, "invisible_block", (new CustomBlockInvisible(Material.glass, false)).setHardness(10.0F).setBlockName("invisible_block").setBlockTextureName("invisible").setCreativeTab(CreativeTabs.tabBlock).setStepSound(soundTypeGlass));
      blockRegistry.addObject(184, "invisible_block_light", (new CustomBlockInvisible(Material.glass, false)).setHardness(10.0F).setBlockName("invisible_block_light").setBlockTextureName("invisible").setCreativeTab(CreativeTabs.tabBlock).setLightLevel(1.0F).setStepSound(soundTypeGlass));
      blockRegistry.addObject(185, "copper_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).setBlockName("copper_ore").setBlockTextureName("copper_ore"));
      blockRegistry.addObject(186, "stone_andesite", (new Block(Material.rock)).setBlockName("stone_andesite").setHardness(2.0F).setBlockTextureName("stone_andesite").setStepSound(soundTypeStone).setCreativeTab(CreativeTabs.tabBlock));
      blockRegistry.addObject(187, "sadian_block", (new BlockFalling()).setHardness(0.5F).setResistance(23.0F).setBlockName("sadian_block").setBlockTextureName("sadian_block").setStepSound(field_149776_m).setCreativeTab(CreativeTabs.tabBlock));
      blockRegistry.addObject(188, "xtnt", (new BlockXTNT()).setHardness(0.0F).setStepSound(soundTypeGrass).setBlockName("xtnt").setBlockTextureName("xeno_tnt"));
      blockRegistry.addObject(189, "iron_ladder", (new BlockLadder()).setHardness(0.4F).setStepSound(soundTypeLadder).setBlockName("iron_ladder").setBlockTextureName("iron_ladder"));
      blockRegistry.addObject(190, "weed", (new BlockWeed()).setBlockName("weed").setBlockTextureName("weed"));
      blockRegistry.addObject(191, "renforced_glass", (new BlockRenforcedGlass(Material.anvil, true)).setBlockName("renforced_glass").setBlockTextureName("renforced_glass").setStepSound(soundTypeGlass));
      blockRegistry.addObject(192, "terrazine_block", (new BlockTerrazine()).setBlockName("terrazine_block").setBlockTextureName("terrazine_block").setCreativeTab(CreativeTabs.tabBlock));
      blockRegistry.addObject(193, "terrazine_ore", (new Block(Material.rock)).setBlockName("terrazine_ore").setBlockTextureName("terrazine_ore").setCreativeTab(CreativeTabs.tabBlock));
      blockRegistry.addObject(194, "end_brick", (new Block(Material.rock)).setBlockName("end_brick").setBlockTextureName("end_brick").setCreativeTab(CreativeTabs.tabBlock));
      Block var9a = (new Block(Material.rock)).setStepSound(soundTypePiston).setHardness(0.8F).setBlockName("quartzNoir").setBlockTextureName("burnt_quartz").setCreativeTab(CreativeTabs.tabBlock);
      blockRegistry.addObject(195, "quartz_noir", var9a);
      blockRegistry.addObject(196, "CUSTOM_DOOR", (new BlockDoorCustom(Material.wood)).setBlockTextureName("BlockDoorCustom").setBlockTextureName("BlockDoorCustom").setHardness(3.0F));
      blockRegistry.addObject(197, "custom_trapdoor", (new BlockCustomTrapdoor(Material.wood)).setBlockTextureName("BlockCustomTrapdoor").setBlockTextureName("customTrap").setHardness(3.0F));
      blockRegistry.addObject(198, "trapblock", (new BlockTrap()).setBlockTextureName("stone").setBlockName("trap"));
      blockRegistry.addObject(199, "xpBlock", (new BlockXP(Material.rock)).setBlockName("xpBlock").setBlockTextureName("xpBlock").setHardness(2.5F));
      blockRegistry.addObject(200, "JumpBlock", (new BlockJump()).setBlockName("blockJump").setBlockTextureName("stone"));
      blockRegistry.addObject(201, "obsidian_stair", (new BlockStairs(Blocks.obsidian, 1)).setBlockName("obsidian_stair").setCreativeTab(CreativeTabs.tabBlock));
      blockRegistry.addObject(213, "magmaBlock", (new BlockMagma()).setBlockName("MagmaBlock").setBlockTextureName("magma").setHardness(2.5F).setStepSound(soundTypeMetal));
      blockRegistry.addObject(214, "netherwart_block", (new Block(Material.rock)).setBlockName("netherwart_block").setBlockTextureName("netherwart_block").setHardness(2.0F).setResistance(3.0F).setCreativeTab(CreativeTabs.tabBlock).setStepSound(soundTypeWood));
      blockRegistry.addObject(215, "red_netherbrick", (new Block(Material.rock)).setBlockName("red_netherbrick").setBlockTextureName("rednether_brick").setCreativeTab(CreativeTabs.tabBlock).setStepSound(soundTypeStone).setHardness(6.0F).setResistance(7.0F));
      blockRegistry.addObject(216, "boneBlock", (new BlockBon()).setBlockName("boneblock").setCreativeTab(CreativeTabs.tabBlock));
      blockRegistry.addObject(218, "stained_sand", (new BlockColoredFalling(Material.sand)).setHardness(0.5F).setBlockName("stained_sand").setBlockTextureName("stained_sand"));
      blockRegistry.addObject(219, "hardened_stairs_" + ItemDye.field_150922_c[0], (new BlockStairs(getBlockFromName("stained_hardened_clay"), 0)).setBlockName("hardened_stairs_" + ItemDye.field_150922_c[0]));
      blockRegistry.addObject(220, "hardened_stairs_" + ItemDye.field_150922_c[1], (new BlockStairs(getBlockFromName("stained_hardened_clay"), 1)).setBlockName("hardened_stairs_" + ItemDye.field_150922_c[1]));
      blockRegistry.addObject(221, "hardened_stairs_" + ItemDye.field_150922_c[2], (new BlockStairs(getBlockFromName("stained_hardened_clay"), 2)).setBlockName("hardened_stairs_" + ItemDye.field_150922_c[2]));
      blockRegistry.addObject(222, "hardened_stairs_" + ItemDye.field_150922_c[3], (new BlockStairs(getBlockFromName("stained_hardened_clay"), 3)).setBlockName("hardened_stairs_" + ItemDye.field_150922_c[3]));
      blockRegistry.addObject(223, "hardened_stairs_" + ItemDye.field_150922_c[4], (new BlockStairs(getBlockFromName("stained_hardened_clay"), 4)).setBlockName("hardened_stairs_" + ItemDye.field_150922_c[4]));
      blockRegistry.addObject(224, "hardened_stairs_" + ItemDye.field_150922_c[5], (new BlockStairs(getBlockFromName("stained_hardened_clay"), 5)).setBlockName("hardened_stairs_" + ItemDye.field_150922_c[5]));
      blockRegistry.addObject(225, "hardened_stairs_" + ItemDye.field_150922_c[6], (new BlockStairs(getBlockFromName("stained_hardened_clay"), 6)).setBlockName("hardened_stairs_" + ItemDye.field_150922_c[6]));
      blockRegistry.addObject(226, "hardened_stairs_" + ItemDye.field_150922_c[7], (new BlockStairs(getBlockFromName("stained_hardened_clay"), 7)).setBlockName("hardened_stairs_" + ItemDye.field_150922_c[7]));
      blockRegistry.addObject(227, "hardened_stairs_" + ItemDye.field_150922_c[8], (new BlockStairs(getBlockFromName("stained_hardened_clay"), 8)).setBlockName("hardened_stairs_" + ItemDye.field_150922_c[8]));
      blockRegistry.addObject(228, "hardened_stairs_" + ItemDye.field_150922_c[9], (new BlockStairs(getBlockFromName("stained_hardened_clay"), 9)).setBlockName("hardened_stairs_" + ItemDye.field_150922_c[9]));
      blockRegistry.addObject(229, "hardened_stairs_" + ItemDye.field_150922_c[10], (new BlockStairs(getBlockFromName("stained_hardened_clay"), 10)).setBlockName("hardened_stairs_" + ItemDye.field_150922_c[10]));
      blockRegistry.addObject(230, "hardened_stairs_" + ItemDye.field_150922_c[11], (new BlockStairs(getBlockFromName("stained_hardened_clay"), 11)).setBlockName("hardened_stairs_" + ItemDye.field_150922_c[11]));
      blockRegistry.addObject(231, "hardened_stairs_" + ItemDye.field_150922_c[12], (new BlockStairs(getBlockFromName("stained_hardened_clay"), 12)).setBlockName("hardened_stairs_" + ItemDye.field_150922_c[12]));
      blockRegistry.addObject(232, "hardened_stairs_" + ItemDye.field_150922_c[13], (new BlockStairs(getBlockFromName("stained_hardened_clay"), 13)).setBlockName("hardened_stairs_" + ItemDye.field_150922_c[13]));
      blockRegistry.addObject(233, "hardened_stairs_" + ItemDye.field_150922_c[14], (new BlockStairs(getBlockFromName("stained_hardened_clay"), 14)).setBlockName("hardened_stairs_" + ItemDye.field_150922_c[14]));
      blockRegistry.addObject(234, "hardened_stairs_" + ItemDye.field_150922_c[15], (new BlockStairs(getBlockFromName("stained_hardened_clay"), 15)).setBlockName("hardened_stairs_" + ItemDye.field_150922_c[15]));
      blockRegistry.addObject(235, "garnet_block", (new BlockCompressed(MapColor.field_151648_G)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundTypeMetal).setBlockName("garnet_block").setBlockTextureName("garnet_block"));
      blockRegistry.addObject(236, "amethyst_block", (new BlockCompressed(MapColor.field_151648_G)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundTypeMetal).setBlockName("amethyst_block").setBlockTextureName("amethyst_block"));
      blockRegistry.addObject(237, "titanium_block", (new BlockCompressed(MapColor.field_151648_G)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundTypeMetal).setBlockName("titanium_block").setBlockTextureName("titanium_block"));
      blockRegistry.addObject(238, "xenotium_block", (new BlockCompressed(MapColor.field_151648_G)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundTypeMetal).setBlockName("xenotium_block").setBlockTextureName("xenotium_block"));
      blockRegistry.addObject(239, "manganese_block", (new BlockCompressed(MapColor.field_151648_G)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundTypeMetal).setBlockName("manganese_block").setBlockTextureName("manganese_block"));
      blockRegistry.addObject(240, "garnet_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).setBlockName("ore_garnet").setBlockTextureName("garnet_ore"));
      blockRegistry.addObject(241, "amethyst_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).setBlockName("ore_amethyst").setBlockTextureName("amethyst_ore"));
      blockRegistry.addObject(242, "titanium_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).setBlockName("ore_titanium").setBlockTextureName("titanium_ore"));
      blockRegistry.addObject(243, "xenotium_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).setBlockName("ore_xenotium").setBlockTextureName("xenotium_ore"));
      blockRegistry.addObject(244, "manganese_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).setBlockName("ore_manganese").setBlockTextureName("manganese_ore"));
      blockRegistry.addObject(250, "obsidian_block", (new BlockCompressed(MapColor.field_151648_G)).setHardness(5.0F).setResistance(10.0F).setStepSound(soundTypeMetal).setBlockName("obsidian_block").setBlockTextureName("obsidian_block"));
      blockRegistry.addObject(251, "obsidian_ore", (new BlockOre()).setHardness(3.0F).setResistance(5.0F).setStepSound(soundTypePiston).setBlockName("ore_obsidian").setBlockTextureName("obsidian_ore"));
      blockRegistry.addObject(252, "WorkSurface", (new BlockWorkbench()).setHardness(2.5F).setStepSound(soundTypeWood).setBlockName("workbench").setBlockTextureName("crafting_table"));
   ...
   public void harvestBlock(World p_149636_1_, EntityPlayer p_149636_2_, int p_149636_3_, int p_149636_4_, int p_149636_5_, int p_149636_6_) {
      ...
      if(this.canSilkHarvest() && EnchantmentHelper.getSilkTouchModifier(p_149636_2_)) {
         ItemStack var71 = this.createStackedBlock(p_149636_6_);
         if(var71 != null) {
            this.dropBlockAsItem_do(p_149636_1_, p_149636_3_, p_149636_4_, p_149636_5_, var71);
         }
      } else {
