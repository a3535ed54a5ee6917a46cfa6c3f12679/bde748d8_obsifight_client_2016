...
public class IntegratedServer extends MinecraftServer {
   ...
   protected void loadAllWorlds(String par1Str, String par2Str, long par3, WorldType par5WorldType, String par6Str) {
      ...
      if(Reflector.DimensionManager.exists()) {
         Object var15 = this.isDemo()?new DemoWorldServer(this, var7, par2Str, 0, this.theProfiler):new WorldServerOF(this, var7, par2Str, 0, this.theWorldSettings, this.theProfiler);
         Integer[] var16 = (Integer[])((Integer[])((Integer[])Reflector.call(Reflector.DimensionManager_getStaticDimensionIDs, new Object[0])));
         Integer[] arr$ = var16;
         int len$ = var16.length;

         for(int i$ = 0; i$ < len$; ++i$) {
            int dim = arr$[i$].intValue();
            Object world = dim == 0?var15:new WorldServerMultiOF(this, var7, par2Str, dim, this.theWorldSettings, (WorldServer)var15, this.theProfiler);
         ...
         this.getConfigurationManager().setPlayerManager(new WorldServer[]{(WorldServer)var15});
      } else {
         this.worldServers = new WorldServer[3];
         this.timeOfLastDimensionTick = new long[this.worldServers.length][100];

         for(int var151 = 0; var151 < this.worldServers.length; ++var151) {
            byte var161 = 0;
            if(var151 == 1) {
               var161 = -1;
            }
            ...
            if(var151 == 0) {
               if(this.isDemo()) {
                  this.worldServers[var151] = new DemoWorldServer(this, var7, par2Str, var161, this.theProfiler);
               } else {
                  this.worldServers[var151] = new WorldServerOF(this, var7, par2Str, var161, this.theWorldSettings, this.theProfiler);
               }
            } else {
               this.worldServers[var151] = new WorldServerMultiOF(this, var7, par2Str, var161, this.theWorldSettings, this.worldServers[0], this.theProfiler);
            }

            this.worldServers[var151].addWorldAccess(new WorldManager(this, this.worldServers[var151]));
   ...
   public String shareToLAN(WorldSettings.GameType par1EnumGameType, boolean par2) {
      try {
         ...
         this.func_147137_ag().addLanEndpoint((InetAddress)null, var61);
         logger.info("Started on " + var61);
         this.isPublic = true;
         this.lanServerPing = new ThreadLanServerPing(this.getMOTD(), var61 + "");
