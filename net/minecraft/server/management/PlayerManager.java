...
public class PlayerManager {
   ...
   public void updatePlayerInstances() {
      ...
      if(this.players.isEmpty()) {
         WorldProvider var22 = this.theWorldServer.provider;
         if(!var22.canRespawnHere()) {
            this.theWorldServer.theChunkProviderServer.unloadAllChunks();
         }
      }

      if(this.chunkCoordsNotLoaded.size() > 0) {
         for(int var221 = 0; var221 < this.players.size(); ++var221) {
            EntityPlayerMP player = (EntityPlayerMP)this.players.get(var221);
