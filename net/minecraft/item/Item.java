...
import fr.thisismac.injector.customclass.CustomBow;
import fr.thisismac.injector.customclass.CustomMinerai;
import fr.thisismac.injector.customclass.ItemCookieAmethyste;
import fr.thisismac.injector.customclass.ItemCookieGarnet;
import fr.thisismac.injector.customclass.ItemCookieObsidian;
import fr.thisismac.injector.customclass.ItemCookieTitanium;
import fr.thisismac.injector.customclass.ItemDebuff;
import fr.thisismac.injector.customclass.ItemDoorCustom;
import fr.thisismac.injector.customclass.ItemJoint;
import fr.thisismac.injector.customclass.ItemOrb;
...
public class Item {
   ...
   public static void registerItems() {
      ...
      itemRegistry.addObject(288, "feather", (new Item()).setUnlocalizedName("feather").setPotionEffect("-0-1-2-3-4+5+6-7-9+11-12+14").setCreativeTab(CreativeTabs.tabMaterials).setTextureName("feather"));
      ...
      itemRegistry.addObject(368, "ender_pearl", (new ItemEnderPearl()).setPotionEffect("+0+1+2+3+4-5-6+7+9-11+12-14").setUnlocalizedName("enderPearl").setTextureName("ender_pearl"));
      ...
      itemRegistry.addObject(423, "key_garnet", (new Item()).setTextureName("key_garnet").setUnlocalizedName("key_garnet").setCreativeTab(CreativeTabs.tabMaterials).setMaxStackSize(1));
      itemRegistry.addObject(424, "key_amethyst", (new Item()).setTextureName("key_amethyste").setUnlocalizedName("key_amethyst").setCreativeTab(CreativeTabs.tabMaterials).setMaxStackSize(1));
      itemRegistry.addObject(425, "key_titanium", (new Item()).setTextureName("key_titanium").setUnlocalizedName("key_titanium").setCreativeTab(CreativeTabs.tabMaterials).setMaxStackSize(1));
      itemRegistry.addObject(426, "key_obsidian", (new Item()).setTextureName("key_obsidian").setUnlocalizedName("key_obsidian").setCreativeTab(CreativeTabs.tabMaterials).setMaxStackSize(1));
      itemRegistry.addObject(427, "copper_ingot", (new Item()).setTextureName("copper_ingot").setUnlocalizedName("copper_ingot").setCreativeTab(CreativeTabs.tabMaterials));
      itemRegistry.addObject(429, "admin_axe", (new ItemSword(Item.ToolMaterial.WOOD)).setUnlocalizedName("admin_axe").setTextureName("admin_axe").setCreativeTab(CreativeTabs.tabTools));
      itemRegistry.addObject(430, "core_neutral", (new ItemSimpleFoiled()).setTextureName("core_neutral").setUnlocalizedName("core_neutral").setCreativeTab(CreativeTabs.tabMaterials));
      itemRegistry.addObject(431, "core_obsidian", (new ItemSimpleFoiled()).setTextureName("core_obsidian").setUnlocalizedName("core_obsidian").setCreativeTab(CreativeTabs.tabMaterials));
      itemRegistry.addObject(432, "core_titanium", (new ItemSimpleFoiled()).setTextureName("core_titanium").setUnlocalizedName("core_titanium").setCreativeTab(CreativeTabs.tabMaterials));
      itemRegistry.addObject(433, "core_xenotium", (new ItemSimpleFoiled()).setTextureName("core_xenotium").setUnlocalizedName("core_xenotium").setCreativeTab(CreativeTabs.tabMaterials));
      itemRegistry.addObject(434, "orb_repair", (new ItemOrb()).setTextureName("orb_repair").setUnlocalizedName("orb_repair").setCreativeTab(CreativeTabs.tabMaterials));
      itemRegistry.addObject(435, "canabis_seed", (new ItemSeeds(Blocks.weed, Blocks.farmland)).setUnlocalizedName("canabis_seed").setTextureName("graine").setCreativeTab(CreativeTabs.tabMaterials));
      itemRegistry.addObject(436, "canabis", (new Item()).setUnlocalizedName("canabis").setTextureName("canabis").setCreativeTab(CreativeTabs.tabFood));
      itemRegistry.addObject(437, "canabis_seche", (new Item()).setUnlocalizedName("canabis_seche").setTextureName("canabis_seche").setCreativeTab(CreativeTabs.tabFood));
      itemRegistry.addObject(438, "pizza", (new ItemFood(8, 0.8F, false)).setTextureName("pizza").setUnlocalizedName("pizza"));
      itemRegistry.addObject(439, "kebab", (new ItemFood(8, 0.8F, false)).setTextureName("kebab").setUnlocalizedName("kebab"));
      itemRegistry.addObject(440, "logblock_tool", (new Item()).setTextureName("logblock_tool").setUnlocalizedName("logblock_tool").setCreativeTab(CreativeTabs.tabMaterials).setMaxStackSize(1));
      itemRegistry.addObject(441, "shop_tool", (new Item()).setTextureName("shop_tool").setUnlocalizedName("shop_tool").setCreativeTab(CreativeTabs.tabMaterials).setMaxStackSize(1));
      itemRegistry.addObject(442, "joint", (new ItemJoint(0, 0.0F, false)).setAlwaysEdible().setTextureName("joint").setUnlocalizedName("joint").setCreativeTab(CreativeTabs.tabMisc));
      itemRegistry.addObject(443, "terrazine_ingot", (new Item()).setUnlocalizedName("terrazine_ingot").setTextureName("terrazine_ingot").setCreativeTab(CreativeTabs.tabMaterials));
      itemRegistry.addObject(444, "debuff", (new ItemDebuff()).setUnlocalizedName("debuff").setTextureName("debuff"));
      itemRegistry.addObject(445, "cookie_garnet", (new ItemCookieGarnet(0, 0.0F, false)).setAlwaysEdible().setUnlocalizedName("cookie_garnet").setTextureName("cookie_garnet"));
      itemRegistry.addObject(446, "cookie_amethyste", (new ItemCookieAmethyste(0, 0.0F, false)).setUnlocalizedName("cookie_amethyste").setTextureName("cookie_amethyste"));
      itemRegistry.addObject(447, "cookie_titanium", (new ItemCookieTitanium(0, 0.0F, false)).setUnlocalizedName("cookie_titanium").setTextureName("cookie_titanium"));
      itemRegistry.addObject(448, "cookie_obsidian", (new ItemCookieObsidian(0, 0.0F, false)).setUnlocalizedName("cookie_obsidian").setTextureName("cookie_obsidian"));
      itemRegistry.addObject(449, "customDoor", (new ItemDoorCustom(Material.wood)).setUnlocalizedName("secretDoor").setTextureName("secretDoor"));
      itemRegistry.addObject(451, "garnet_helmet", (new ItemArmor(ItemArmor.ArmorMaterial.GARNET, 6, 0)).setUnlocalizedName("helmet_garnet").setTextureName("garnet_helmet"));
      itemRegistry.addObject(452, "garnet_chestplate", (new ItemArmor(ItemArmor.ArmorMaterial.GARNET, 6, 1)).setUnlocalizedName("chestplate_garnet").setTextureName("garnet_chestplate"));
      itemRegistry.addObject(453, "garnet_leggings", (new ItemArmor(ItemArmor.ArmorMaterial.GARNET, 6, 2)).setUnlocalizedName("legging_garnet").setTextureName("garnet_leggings"));
      itemRegistry.addObject(454, "garnet_boots", (new ItemArmor(ItemArmor.ArmorMaterial.GARNET, 6, 3)).setUnlocalizedName("boots_garnet").setTextureName("garnet_boots"));
      itemRegistry.addObject(455, "amethyst_helmet", (new ItemArmor(ItemArmor.ArmorMaterial.AMETHYST, 7, 0)).setUnlocalizedName("helmet_amethyst").setTextureName("amethyst_helmet"));
      itemRegistry.addObject(456, "amethyst_chestplate", (new ItemArmor(ItemArmor.ArmorMaterial.AMETHYST, 7, 1)).setUnlocalizedName("chestplate_amethyst").setTextureName("amethyst_chestplate"));
      itemRegistry.addObject(457, "amethyst_leggings", (new ItemArmor(ItemArmor.ArmorMaterial.AMETHYST, 7, 2)).setUnlocalizedName("legging_amethyst").setTextureName("amethyst_leggings"));
      itemRegistry.addObject(458, "amethyst_boots", (new ItemArmor(ItemArmor.ArmorMaterial.AMETHYST, 7, 3)).setUnlocalizedName("boots_amethyst").setTextureName("amethyst_boots"));
      itemRegistry.addObject(459, "titanium_helmet", (new ItemArmor(ItemArmor.ArmorMaterial.TITANIUM, 8, 0)).setUnlocalizedName("helmet_titanium").setTextureName("titanium_helmet"));
      itemRegistry.addObject(460, "titanium_chestplate", (new ItemArmor(ItemArmor.ArmorMaterial.TITANIUM, 8, 1)).setUnlocalizedName("chestplate_titanium").setTextureName("titanium_chestplate"));
      itemRegistry.addObject(461, "titanium_leggings", (new ItemArmor(ItemArmor.ArmorMaterial.TITANIUM, 8, 2)).setUnlocalizedName("legging_titanium").setTextureName("titanium_leggings"));
      itemRegistry.addObject(462, "titanium_boots", (new ItemArmor(ItemArmor.ArmorMaterial.TITANIUM, 8, 3)).setUnlocalizedName("boots_titanium").setTextureName("titanium_boots"));
      itemRegistry.addObject(463, "manganese_helmet", (new ItemArmor(ItemArmor.ArmorMaterial.MANGANESE, 5, 0)).setUnlocalizedName("helmet_manganese").setTextureName("manganese_helmet"));
      itemRegistry.addObject(464, "manganese_chestplate", (new ItemArmor(ItemArmor.ArmorMaterial.MANGANESE, 5, 1)).setUnlocalizedName("chestplate_manganese").setTextureName("manganese_chestplate"));
      itemRegistry.addObject(465, "manganese_leggings", (new ItemArmor(ItemArmor.ArmorMaterial.MANGANESE, 5, 2)).setUnlocalizedName("legging_manganese").setTextureName("manganese_leggings"));
      itemRegistry.addObject(466, "manganese_boots", (new ItemArmor(ItemArmor.ArmorMaterial.MANGANESE, 5, 3)).setUnlocalizedName("boots_manganese").setTextureName("manganese_boots"));
      itemRegistry.addObject(467, "obsidium_helmet", (new ItemArmor(ItemArmor.ArmorMaterial.OBSIDIUM, 10, 0)).setUnlocalizedName("helmet_obsidium").setTextureName("obsidium_helmet"));
      itemRegistry.addObject(468, "obsidium_chestplate", (new ItemArmor(ItemArmor.ArmorMaterial.OBSIDIUM, 10, 1)).setUnlocalizedName("chestplate_obsidium").setTextureName("obsidium_chestplate"));
      itemRegistry.addObject(469, "obsidium_leggings", (new ItemArmor(ItemArmor.ArmorMaterial.OBSIDIUM, 10, 2)).setUnlocalizedName("legging_obsidium").setTextureName("obsidium_leggings"));
      itemRegistry.addObject(470, "obsidium_boots", (new ItemArmor(ItemArmor.ArmorMaterial.OBSIDIUM, 10, 3)).setUnlocalizedName("boots_obsidium").setTextureName("obsidium_boots"));
      itemRegistry.addObject(471, "ingot_garnet", (new CustomMinerai("ingot_garnet")).setUnlocalizedName("ingot_garnet").setTextureName("garnet_ingot").setCreativeTab(CreativeTabs.tabMaterials));
      itemRegistry.addObject(472, "ingot_amethyst", (new CustomMinerai("ingot_amethyst")).setUnlocalizedName("ingot_amehyst").setTextureName("amethyst_ingot").setCreativeTab(CreativeTabs.tabMaterials));
      itemRegistry.addObject(473, "ingot_titanium", (new CustomMinerai("ingot_titanium")).setUnlocalizedName("ingot_titanium").setTextureName("titanium_ingot").setCreativeTab(CreativeTabs.tabMaterials));
      itemRegistry.addObject(474, "ingot_xenotium", (new CustomMinerai("ingot_xenotium")).setUnlocalizedName("ingot_xenotium").setTextureName("xenotium_ingot").setCreativeTab(CreativeTabs.tabMaterials));
      itemRegistry.addObject(475, "ingot_manganese", (new CustomMinerai("ingot_manganese")).setUnlocalizedName("ingot_manganese").setTextureName("manganese_ingot").setCreativeTab(CreativeTabs.tabMaterials));
      itemRegistry.addObject(476, "sword_garnet", (new ItemSword(Item.ToolMaterial.GARNET)).setUnlocalizedName("sword_garnet").setTextureName("garnet_sword"));
      itemRegistry.addObject(477, "shovel_garnet", (new ItemSpade(Item.ToolMaterial.GARNET)).setUnlocalizedName("shovel_garnet").setTextureName("garnet_shovel"));
      itemRegistry.addObject(478, "pickaxe_garnet", (new ItemPickaxe(Item.ToolMaterial.GARNET)).setUnlocalizedName("pickaxe_garnet").setTextureName("garnet_pickaxe"));
      itemRegistry.addObject(479, "axe_garnet", (new ItemAxe(Item.ToolMaterial.GARNET)).setUnlocalizedName("axe_garnet").setTextureName("garnet_axe"));
      itemRegistry.addObject(480, "sword_amethyst", (new ItemSword(Item.ToolMaterial.AMETHYST)).setUnlocalizedName("sword_amethyst").setTextureName("amethyst_sword"));
      itemRegistry.addObject(481, "shovel_amethyst", (new ItemSpade(Item.ToolMaterial.AMETHYST)).setUnlocalizedName("shovel_amethyst").setTextureName("amethyst_shovel"));
      itemRegistry.addObject(482, "pickaxe_amethyst", (new ItemPickaxe(Item.ToolMaterial.AMETHYST)).setUnlocalizedName("pickaxe_amethyst").setTextureName("amethyst_pickaxe"));
      itemRegistry.addObject(483, "axe_amethyst", (new ItemAxe(Item.ToolMaterial.AMETHYST)).setUnlocalizedName("axe_amethyst").setTextureName("amethyst_axe"));
      itemRegistry.addObject(484, "sword_titanium", (new ItemSword(Item.ToolMaterial.TITANIUM)).setUnlocalizedName("sword_titanium").setTextureName("titanium_sword"));
      itemRegistry.addObject(485, "shovel_titanium", (new ItemSpade(Item.ToolMaterial.TITANIUM)).setUnlocalizedName("shovel_titanium").setTextureName("titanium_shovel"));
      itemRegistry.addObject(486, "pickaxe_titanium", (new ItemPickaxe(Item.ToolMaterial.TITANIUM)).setUnlocalizedName("pickaxe_titanium").setTextureName("titanium_pickaxe"));
      itemRegistry.addObject(488, "axe_titanium", (new ItemAxe(Item.ToolMaterial.TITANIUM)).setUnlocalizedName("axe_titanium").setTextureName("titanium_axe"));
      itemRegistry.addObject(489, "ingot_obsidian", (new CustomMinerai("ingot_obsidian")).setUnlocalizedName("ingot_obsidian").setTextureName("obsidian_ingot").setCreativeTab(CreativeTabs.tabMaterials));
      itemRegistry.addObject(493, "sword_obsidium", (new ItemSword(Item.ToolMaterial.OBSIDIUM)).setUnlocalizedName("sword_obsidium").setTextureName("obsidium_sword"));
      itemRegistry.addObject(494, "shovel_obsidium", (new ItemSpade(Item.ToolMaterial.OBSIDIUM)).setUnlocalizedName("shovel_obsidium").setTextureName("obsidium_shovel"));
      itemRegistry.addObject(495, "pickaxe_obsidium", (new ItemPickaxe(Item.ToolMaterial.OBSIDIUM)).setUnlocalizedName("pickaxe_obsidium").setTextureName("obsidium_pickaxe"));
      itemRegistry.addObject(496, "axe_obsidium", (new ItemAxe(Item.ToolMaterial.OBSIDIUM)).setUnlocalizedName("axe_obsidium").setTextureName("obsidium_axe"));
      itemRegistry.addObject(497, "sword_manganese", (new ItemSword(Item.ToolMaterial.MANGANESE)).setUnlocalizedName("sword_manganese").setTextureName("manganese_sword"));
      itemRegistry.addObject(498, "shovel_manganese", (new ItemSpade(Item.ToolMaterial.MANGANESE)).setUnlocalizedName("shovel_manganese").setTextureName("manganese_shovel"));
      itemRegistry.addObject(499, "pickaxe_manganese", (new ItemPickaxe(Item.ToolMaterial.MANGANESE)).setUnlocalizedName("pickaxe_manganese").setTextureName("manganese_pickaxe"));
      itemRegistry.addObject(500, "axe_manganese", (new ItemAxe(Item.ToolMaterial.MANGANESE)).setUnlocalizedName("axe_manganese").setTextureName("manganese_axe"));
      itemRegistry.addObject(501, "hoe_garnet", (new ItemHoe(Item.ToolMaterial.GARNET)).setUnlocalizedName("hoe_garnet").setTextureName("garnet_hoe"));
      itemRegistry.addObject(502, "hoe_amethyst", (new ItemHoe(Item.ToolMaterial.AMETHYST)).setUnlocalizedName("hoe_amethyst").setTextureName("amethyst_hoe"));
      itemRegistry.addObject(503, "hoe_titanium", (new ItemHoe(Item.ToolMaterial.TITANIUM)).setUnlocalizedName("hoe_titanium").setTextureName("titanium_hoe"));
      itemRegistry.addObject(505, "hoe_obsidium", (new ItemHoe(Item.ToolMaterial.OBSIDIUM)).setUnlocalizedName("hoe_obsidium").setTextureName("obsidium_hoe"));
      itemRegistry.addObject(506, "hoe_manganese", (new ItemHoe(Item.ToolMaterial.MANGANESE)).setUnlocalizedName("hoe_manganese").setTextureName("manganese_hoe"));
      itemRegistry.addObject(507, "bow_garnet", (new CustomBow(2.0D, 1000, false)).setUnlocalizedName("bow_garnet").setTextureName("garnet_bow"));
      itemRegistry.addObject(508, "bow_amethyst", (new CustomBow(3.0D, 2000, false)).setUnlocalizedName("bow_amethyst").setTextureName("amethyst_bow"));
      itemRegistry.addObject(509, "bow_titanium", (new CustomBow(4.0D, 3000, false)).setUnlocalizedName("bow_titanium").setTextureName("titanium_bow"));
      itemRegistry.addObject(511, "bow_obsidium", (new CustomBow(6.0D, 5000, false)).setUnlocalizedName("bow_obsidium").setTextureName("obsidium_bow"));
      itemRegistry.addObject(512, "bow_manganese", (new CustomBow(1.0D, 500, false)).setUnlocalizedName("bow_manganese").setTextureName("manganese_bow"));
      ...
      while(var2.hasNext()) {
         ...
         } else if(var4 == Block.getBlockById(202)) {
            var5 = (new ItemCloth(Block.getBlockById(202))).setUnlocalizedName("sandstoneStained");
         } else if(var4 == Block.getBlockById(218)) {
            var5 = (new ItemCloth(Block.getBlockById(218))).setUnlocalizedName("stained_sand");
   ...
   public static enum ToolMaterial {
      WOOD("WOOD", 0, "WOOD", 0, 0, 59, 1.0F, 0.0F, 15),
      STONE("STONE", 1, "STONE", 1, 1, 131, 4.0F, 1.0F, 5),
      IRON("IRON", 2, "IRON", 2, 2, 250, 6.0F, 2.0F, 14),
      EMERALD("EMERALD", 3, "EMERALD", 3, 3, 950, 8.0F, 4.0F, 10),
      GOLD("GOLD", 4, "GOLD", 4, 0, 32, 12.0F, 1.69F, 22),
      MANGANESE("MANGANESE", 5, "MANGANESE", 5, 3, 1200, 14.0F, 3.5F, 10),
      GARNET("GARNET", 6, "GARNET", 6, 3, 1500, 10.0F, 4.5F, 10),
      AMETHYST("AMETHYST", 7, "AMETHYST", 7, 3, 2000, 13.0F, 6.0F, 10),
      TITANIUM("TITANIUM", 8, "TITANIUM", 8, 3, 2499, 16.0F, 7.0F, 10),
      OBSIDIUM("OBSIDIUM", 9, "OBSIDIUM", 10, 3, 3502, 18.0F, 8.0F, 5);
      private final int harvestLevel;
      private final int maxUses;
      private final float efficiencyOnProperMaterial;
      private final float damageVsEntity;
      private final int enchantability;
      private static final Item.ToolMaterial[] $VALUES = new Item.ToolMaterial[]{WOOD, STONE, IRON, EMERALD, GOLD, GARNET, MANGANESE, AMETHYST, TITANIUM, OBSIDIUM};
      private static final String __OBFID = "CL_00000042";

      private static final Item.ToolMaterial[] $VALUES$ = new Item.ToolMaterial[]{WOOD, STONE, IRON, EMERALD, GOLD, MANGANESE, GARNET, AMETHYST, TITANIUM, OBSIDIUM};
      private static final String __OBFID = "CL_00000042";

      private ToolMaterial(String p_i46414_1_, int p_i46414_2_, String p_i1874_1_, int p_i1874_2_, int p_i1874_3_, int p_i1874_4_, float p_i1874_5_, float p_i1874_6_, int p_i1874_7_) {
      ...
      public Item func_150995_f() {
         return this == WOOD?Item.getItemFromBlock(Blocks.planks):(this == STONE?Item.getItemFromBlock(Blocks.cobblestone):(this == GOLD?Items.gold_ingot:(this == IRON?Items.iron_ingot:(this == EMERALD?Items.diamond:(this == AMETHYST?Items.amethyst:(this == GARNET?Items.garnet:(this == TITANIUM?Items.titanium:(this == MANGANESE?Items.manganese:null))))))));
      }
   }
}
