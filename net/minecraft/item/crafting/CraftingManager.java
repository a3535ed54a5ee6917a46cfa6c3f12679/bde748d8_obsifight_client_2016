...
public class CraftingManager {
   ...
   public ShapedRecipes addRecipe(ItemStack p_92103_1_, Object ... p_92103_2_) {
      ...
      if(p_92103_2_[var4] instanceof String[]) {
         String[] var12 = (String[])((String[])((String[])p_92103_2_[var4++]));

         for(int var14 = 0; var14 < var12.length; ++var14) {
            String var17 = var12[var14];
            ++var6;
            var5 = var17.length();
            var3 = var3 + var17;
         }
      ...
      HashMap var121;
      for(var121 = new HashMap(); var4 < p_92103_2_.length; var4 += 2) {
      ...
      for(int var16 = 0; var16 < var5 * var6; ++var16) {
         ...
         if(var121.containsKey(Character.valueOf(var10))) {
            var141[var16] = ((ItemStack)var121.get(Character.valueOf(var10))).copy();
         } else {
            var141[var16] = null;
         }
      }

      ShapedRecipes var171 = new ShapedRecipes(var5, var6, var141, p_92103_1_);
      this.recipes.add(var171);
      return var171;
   }
   ...
   public ItemStack findMatchingRecipe(InventoryCrafting p_82787_1_, World p_82787_2_) {
      ...
      for(var6 = 0; var6 < p_82787_1_.getSizeInventory(); ++var6) {
         ItemStack var12 = p_82787_1_.getStackInSlot(var6);
         if(var12 != null) {
            if(var3 == 0) {
               var4 = var12;
            }
      ...
      if(var3 == 2 && var4.getItem() == var5.getItem() && var4.stackSize == 1 && var5.stackSize == 1 && var4.getItem().isDamageable()) {
         Item var131 = var4.getItem();
         int var13 = var131.getMaxDamage() - var4.getItemDamageForDisplay();
         int var8 = var131.getMaxDamage() - var5.getItemDamageForDisplay();
         int var9 = var13 + var8 + var131.getMaxDamage() * 5 / 100;
         int var10 = var131.getMaxDamage() - var9;
         if(var10 < 0) {
            var10 = 0;
         }
         ...
         for(var6 = 0; var6 < this.recipes.size(); ++var6) {
            IRecipe var121 = (IRecipe)this.recipes.get(var6);
            if(var121.matches(p_82787_1_, p_82787_2_)) {
               return var121.getCraftingResult(p_82787_1_);
            }
         }
