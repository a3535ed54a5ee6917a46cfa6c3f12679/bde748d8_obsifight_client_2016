...
public abstract class EntityLivingBase extends Entity {
   ...
   protected void entityInit() {
      ...
      this.dataWatcher.addObject(31, String.valueOf(""));
   }
   ...
   protected void onDeathUpdate() {
      ...
      if(this.deathTime == 20) {
         ...
         if(!this.worldObj.isClient && (this.recentlyHit > 0 || this.isPlayer()) && this.func_146066_aG() && this.worldObj.getGameRules().getGameRuleBooleanValue("doMobLoot")) {
            ...
            while(var1 > 0) {
               int var81 = EntityXPOrb.getXPSplit(var1);
               var1 -= var81;
               this.worldObj.spawnEntityInWorld(new EntityXPOrb(this.worldObj, this.posX, this.posY, this.posZ, var81));
            }
         }
   ...
   public void readEntityFromNBT(NBTTagCompound p_70037_1_) {
      ...
      if(p_70037_1_.func_150297_b("ActiveEffects", 9)) {
         NBTTagList var61 = p_70037_1_.getTagList("ActiveEffects", 10);

         for(int var3 = 0; var3 < var61.tagCount(); ++var3) {
            NBTTagCompound var4 = var61.getCompoundTagAt(var3);
   ...
   protected void updatePotionEffects() {
      ...
      while(var1.hasNext()) {
         Integer var111 = (Integer)var1.next();
         PotionEffect var13 = (PotionEffect)this.activePotionsMap.get(var111);
         if(!var13.onUpdate(this)) {
            ...
            this.onChangedPotionEffect(var13, false);
         }
      }
      ...
      if(this.potionsNeedUpdate) {
         if(!this.worldObj.isClient) {
            if(this.activePotionsMap.isEmpty()) {
               ...
               this.dataWatcher.updateObject(31, String.valueOf(""));
               ...
               int var14 = this.activePotionsMap.size();
               int var15 = 1;

               for(Iterator i$ = this.activePotionsMap.values().iterator(); i$.hasNext(); ++var15) {
                  Object var16 = i$.next();
                  PotionEffect potion = (PotionEffect)var16;
                  if(var15 == var14) {
                     var12.append(Integer.toString(potion.getPotionID()));
                  } else {
                     var12.append(Integer.toString(potion.getPotionID()) + ";");
                  }
               }

               this.dataWatcher.updateObject(31, String.valueOf(var12));
            }
         }
      ...
      this.effects = this.dataWatcher.getWatchableObjectString(31);
      boolean var131 = this.dataWatcher.getWatchableObjectByte(8) > 0;
      if(var11 > 0) {
         boolean var141 = false;
         if(!this.isInvisible()) {
            var141 = this.rand.nextBoolean();
         } else {
            var141 = this.rand.nextInt(15) == 0;
         }

         if(var131) {
            var141 &= this.rand.nextInt(5) == 0;
         }

         if(var141 && var11 > 0) {
            double var151 = (double)(var11 >> 16 & 255) / 255.0D;
            double var161 = (double)(var11 >> 8 & 255) / 255.0D;
            double var9 = (double)(var11 >> 0 & 255) / 255.0D;
            this.worldObj.spawnParticle(var131?"mobSpellAmbient":"mobSpell", this.posX + (this.rand.nextDouble() - 0.5D) * (double)this.width, this.posY + this.rand.nextDouble() * (double)this.height - (double)this.yOffset, this.posZ + (this.rand.nextDouble() - 0.5D) * (double)this.width, var151, var161, var9);
         }
      }
   }
   ...
   public boolean isOnIronLadder() {
      ...
      return var4 == Block.getBlockById(189);
   }
         ...
         if(this.getHealth() <= 0.0F) {
            ...
            if(var4 != null) {
               ...
               if(var4 instanceof EntityPlayer) {
                  ...
                  EntityWolf var102 = (EntityWolf)var4;
                  if(var102.isTamed()) {
                     this.recentlyHit = 100;
                     this.attackingPlayer = null;
                  }
            ...
            if(var3) {
               ...
               if(var4 != null) {
                  double var1021 = var4.posX - this.posX;

                  double var7;
                  for(var7 = var4.posZ - this.posZ; var1021 * var1021 + var7 * var7 < 1.0E-4D; var7 = (Math.random() - Math.random()) * 0.01D) {
                     var1021 = (Math.random() - Math.random()) * 0.01D;
                  }

                  this.attackedAtYaw = (float)(Math.atan2(var7, var1021) * 180.0D / Math.PI) - this.rotationYaw;
                  this.knockBack(var4, p_70097_2_, var1021, var7);
               } else {
            ...
            String var1022;
            if(this.getHealth() <= 0.0F) {
               var1022 = this.getDeathSound();
               if(var3 && var1022 != null) {
                  this.playSound(var1022, this.getSoundVolume(), this.getSoundPitch());
               }

               this.onDeath(p_70097_1_);
            } else {
               var1022 = this.getHurtSound();
               if(var3 && var1022 != null) {
                  this.playSound(var1022, this.getSoundVolume(), this.getSoundPitch());
               }
            }
   ...
   protected void fall(float p_70069_1_) {
      ...
      PotionEffect featherFalling = this.getActivePotionEffect(Potion.featherFalling);
      ...
      if(var4 > 0) {
         ...
         boolean falleffect = this.hasFallEffect();
         if(!falleffect) {
   ...
   public boolean hasFallEffect() {
      ...
      do {
         ...
         Integer var2 = (Integer)var1.next();
         var3 = (PotionEffect)this.activePotionsMap.get(var2);
      } while(!this.worldObj.isClient || var3.getEffectName() != "potion.featherFalling");
   ...
   protected float applyArmorCalculations(DamageSource p_70655_1_, float p_70655_2_) {
      if(!p_70655_1_.isUnblockable()) {
         int var3 = 50 - this.getTotalArmorValue();
         if(this.isPotionActive(Potion.armorBreak)) {
            var3 += 20 * this.getTotalArmorValue() / 100;
         }

         float var4 = p_70655_2_ * (float)var3;
         this.damageArmor(p_70655_2_);
         p_70655_2_ = var4 / 100.0F;
      }
   ...
   public final String getAFEffects() {
   ...
   public void moveEntityWithHeading(float p_70612_1_, float p_70612_2_) {
      ...
      if(this.isInWater() && (!(this instanceof EntityPlayer) || !((EntityPlayer)this).capabilities.isFlying)) {
         ...
         if(this.getActivePotionEffect(Potion.waterSpeed) != null) {
            this.motionX *= 0.930000011920929D;
            this.motionY *= 0.930000011920929D;
            this.motionZ *= 0.930000011920929D;
         } else {
         ...
         float var91 = 0.91F;
         if(this.onGround) {
            var91 = this.worldObj.getBlock(MathHelper.floor_double(this.posX), MathHelper.floor_double(this.boundingBox.minY) - 1, MathHelper.floor_double(this.posZ)).slipperiness * 0.91F;
         }

         float var4 = 0.16277136F / (var91 * var91 * var91);
         if(this.onGround) {
            var10 = this.getAIMoveSpeed() * var4;
         } else {
            var10 = this.jumpMovementFactor;
         }
         ...
         if(this.isOnIronLadder()) {
            ...
            var7 = this.isSneaking() && this instanceof EntityPlayer;
         ...
         if(this.isCollidedHorizontally && this.isOnIronLadder()) {
            this.motionY = 0.5D;
         }
         ...
         this.motionX *= (double)var91;
         this.motionZ *= (double)var91;
      }

      this.prevLimbSwingAmount = this.limbSwingAmount;
      var8 = this.posX - this.prevPosX;
      double var911 = this.posZ - this.prevPosZ;
      var10 = MathHelper.sqrt_double(var8 * var8 + var911 * var911) * 4.0F;
      if(var10 > 1.0F) {
         var10 = 1.0F;
      }
   ...
   public void onUpdate() {
      super.onUpdate();
      if(!this.worldObj.isClient) {
         int var91 = this.getArrowCountInEntity();
         if(var91 > 0) {
            if(this.arrowHitTimer <= 0) {
               this.arrowHitTimer = 20 * (30 - var91);
            }

            --this.arrowHitTimer;
            if(this.arrowHitTimer <= 0) {
               this.setArrowCountInEntity(var91 - 1);
            }
         }

         for(int var2 = 0; var2 < 5; ++var2) {
            ItemStack var101 = this.previousEquipment[var2];
            ItemStack var4 = this.getEquipmentInSlot(var2);
            if(!ItemStack.areItemStacksEqual(var4, var101)) {
               ((WorldServer)this.worldObj).getEntityTracker().func_151247_a(this, new S04PacketEntityEquipment(this.getEntityId(), var2, var4));
               if(var101 != null) {
                  this.attributeMap.removeAttributeModifiers(var101.getAttributeModifiers());
               }
