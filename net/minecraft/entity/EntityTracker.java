...
public class EntityTracker {
   ...
   public void addEntityToTracker(Entity p_72786_1_) {
      ...
      } else if(p_72786_1_ instanceof EntityXTNT) {
         this.addEntityToTracker(p_72786_1_, 160, 10, true);
   ...
   public void addEntityToTracker(Entity p_72785_1_, int p_72785_2_, final int p_72785_3_, boolean p_72785_4_) {
      ...
      try {
         ...
         EntityTrackerEntry var11 = new EntityTrackerEntry(p_72785_1_, p_72785_2_, p_72785_3_, p_72785_4_);
         this.trackedEntities.add(var11);
         this.trackedEntityIDs.addKey(p_72785_1_.getEntityId(), var11);
         var11.sendEventsToPlayers(this.theWorld.playerEntities);
      } catch (Throwable var111) {
         CrashReport var6 = CrashReport.makeCrashReport(var111, "Adding entity to track");
   ...
   public void removeEntityFromAllTrackingPlayers(Entity p_72790_1_) {
      if(p_72790_1_ instanceof EntityPlayerMP) {
         EntityPlayerMP var5 = (EntityPlayerMP)p_72790_1_;
         Iterator var3 = this.trackedEntities.iterator();

         while(var3.hasNext()) {
            EntityTrackerEntry var4 = (EntityTrackerEntry)var3.next();
            var4.removeFromWatchingList(var5);
         }
      }

      EntityTrackerEntry var51 = (EntityTrackerEntry)this.trackedEntityIDs.removeObject(p_72790_1_.getEntityId());
      if(var51 != null) {
         this.trackedEntities.remove(var51);
         var51.informAllAssociatedPlayersOfItemDestruction();
      }
   }
   ...
   public void updateTrackedEntities() {
      ...
      while(var2.hasNext()) {
         EntityTrackerEntry var6 = (EntityTrackerEntry)var2.next();
         var6.sendLocationToAllClients(this.theWorld.playerEntities);
         if(var6.playerEntitiesUpdated && var6.myEntity instanceof EntityPlayerMP) {
            var1.add((EntityPlayerMP)var6.myEntity);
         }
      }

      for(int var71 = 0; var71 < var1.size(); ++var71) {
         EntityPlayerMP var7 = (EntityPlayerMP)var1.get(var71);
