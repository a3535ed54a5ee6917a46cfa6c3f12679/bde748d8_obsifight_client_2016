...
public class EntityCow extends EntityAnimal {
   ...
   public boolean interact(EntityPlayer p_70085_1_) {
      ...
      if(var2 != null && var2.getItem() == Items.bucket && !p_70085_1_.capabilities.isCreativeMode) {
         ...
         return true;
      } else if(var2 != null && var2.getItem() == Items.glass_bottle && !p_70085_1_.capabilities.isCreativeMode) {
         if(var2.stackSize-- == 1) {
            p_70085_1_.inventory.setInventorySlotContents(p_70085_1_.inventory.currentItem, new ItemStack(Items.debuff));
         } else if(!p_70085_1_.inventory.addItemStackToInventory(new ItemStack(Items.debuff))) {
            p_70085_1_.dropPlayerItemWithRandomChoice(new ItemStack(Items.debuff, 1, 0), false);
         }
