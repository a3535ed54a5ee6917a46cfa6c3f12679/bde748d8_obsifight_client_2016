...
public class EntityDragon extends EntityLiving implements IBossDisplayData, IEntityMultiPart, IMob {
      ...
      if(this.getHealth() <= 0.0F) {
         ...
         if(this.worldObj.isClient) {
            if(this.newPosRotationIncrements > 0) {
               ...
               var281 = this.posY + (this.newPosY - this.posY) / (double)this.newPosRotationIncrements;
               ...
               this.setPosition(var26, var281, var6);
               this.setRotation(this.rotationYaw, this.rotationPitch);
            }
         } else {
            var26 = this.targetX - this.posX;
            var281 = this.targetY - this.posY;
            var6 = this.targetZ - this.posZ;
            var8 = var26 * var26 + var281 * var281 + var6 * var6;
            double var27;
            double var28;
            if(this.target != null) {
               this.targetX = this.target.posX;
               this.targetZ = this.target.posZ;
               var27 = this.targetX - this.posX;
               var28 = this.targetZ - this.posZ;
               double var29 = Math.sqrt(var27 * var27 + var28 * var28);
               double var33 = 0.4000000059604645D + var29 / 80.0D - 1.0D;
               if(var33 > 10.0D) {
                  var33 = 10.0D;
               }

               this.targetY = this.target.boundingBox.minY + var33;
            } else {
            ...
            var281 /= (double)MathHelper.sqrt_double(var26 * var26 + var6 * var6);
            var31 = 0.6F;
            if(var281 < (double)(-var31)) {
               var281 = (double)(-var31);
            }
            ...
            this.motionY += var281 * 0.10000000149011612D;
            this.rotationYaw = MathHelper.wrapAngleTo180_float(this.rotationYaw);
            var27 = 180.0D - Math.atan2(var26, var6) * 180.0D / Math.PI;
            var28 = MathHelper.wrapAngleTo180_double(var27 - (double)this.rotationYaw);
            if(var28 > 50.0D) {
               var28 = 50.0D;
            }
            ...
            Vec3 var311 = Vec3.createVectorHelper(this.targetX - this.posX, this.targetY - this.posY, this.targetZ - this.posZ).normalize();
            Vec3 var9 = Vec3.createVectorHelper((double)MathHelper.sin(this.rotationYaw * (float)Math.PI / 180.0F), this.motionY, (double)(-MathHelper.cos(this.rotationYaw * (float)Math.PI / 180.0F))).normalize();
            var341 = (float)(var9.dotProduct(var311) + 0.5D) / 1.5F;
            if(var341 < 0.0F) {
               var341 = 0.0F;
            }

            this.randomYawVelocity *= 0.8F;
            float var30 = MathHelper.sqrt_double(this.motionX * this.motionX + this.motionZ * this.motionZ) * 1.0F + 1.0F;
            double var32 = Math.sqrt(this.motionX * this.motionX + this.motionZ * this.motionZ) * 1.0D + 1.0D;
            if(var32 > 40.0D) {
               var32 = 40.0D;
            }

            this.randomYawVelocity = (float)((double)this.randomYawVelocity + var28 * (0.699999988079071D / var32 / (double)var30));
            this.rotationYaw += this.randomYawVelocity * 0.1F;
            var35 = (float)(2.0D / (var32 + 1.0D));
            var36 = 0.06F;
            this.moveFlying(0.0F, -1.0F, var36 * (var341 * var35 + (1.0F - var35)));
            if(this.slowed) {
            ...
            Vec3 var37 = Vec3.createVectorHelper(this.motionX, this.motionY, this.motionZ).normalize();
            var38 = (float)(var37.dotProduct(var9) + 1.0D) / 2.0F;
            var38 = 0.8F + 0.15F * var38;
            this.motionX *= (double)var38;
            this.motionZ *= (double)var38;
         ...
         float var291 = -MathHelper.sin(var2);
         float var5 = this.rotationYaw * (float)Math.PI / 180.0F;
         float var301 = MathHelper.sin(var5);
         float var7 = MathHelper.cos(var5);
         this.dragonPartBody.onUpdate();
         this.dragonPartBody.setLocationAndAngles(this.posX + (double)(var301 * 0.5F), this.posY, this.posZ - (double)(var7 * 0.5F), 0.0F, 0.0F);
         this.dragonPartWing1.onUpdate();
         this.dragonPartWing1.setLocationAndAngles(this.posX + (double)(var7 * 4.5F), this.posY + 2.0D, this.posZ + (double)(var301 * 4.5F), 0.0F, 0.0F);
         this.dragonPartWing2.onUpdate();
         this.dragonPartWing2.setLocationAndAngles(this.posX - (double)(var7 * 4.5F), this.posY + 2.0D, this.posZ - (double)(var301 * 4.5F), 0.0F, 0.0F);
         ...
         double[] var321 = this.getMovementOffsets(5, 1.0F);
         double[] var331 = this.getMovementOffsets(0, 1.0F);
         var31 = MathHelper.sin(this.rotationYaw * (float)Math.PI / 180.0F - this.randomYawVelocity * 0.01F);
         var341 = MathHelper.cos(this.rotationYaw * (float)Math.PI / 180.0F - this.randomYawVelocity * 0.01F);
         this.dragonPartHead.onUpdate();
         this.dragonPartHead.setLocationAndAngles(this.posX + (double)(var31 * 5.5F * var3), this.posY + (var331[1] - var321[1]) * 1.0D + (double)(var291 * 5.5F), this.posZ - (double)(var341 * 5.5F * var3), 0.0F, 0.0F);

         for(int var351 = 0; var351 < 3; ++var351) {
            EntityDragonPart var361 = null;
            if(var351 == 0) {
               var361 = this.dragonPartTail1;
            }

            if(var351 == 1) {
               var361 = this.dragonPartTail2;
            }

            if(var351 == 2) {
               var361 = this.dragonPartTail3;
            }

            double[] var34 = this.getMovementOffsets(12 + var351 * 2, 1.0F);
            var35 = this.rotationYaw * (float)Math.PI / 180.0F + this.simplifyAngle(var34[0] - var321[0]) * (float)Math.PI / 180.0F * 1.0F;
            var36 = MathHelper.sin(var35);
            float var371 = MathHelper.cos(var35);
            var38 = 1.5F;
            float var40 = (float)(var351 + 1) * 2.0F;
            var361.onUpdate();
            var361.setLocationAndAngles(this.posX - (double)((var301 * var38 + var36 * var40) * var3), this.posY + (var34[1] - var321[1]) * 1.0D - (double)((var40 + var38) * var291) + 1.5D, this.posZ + (double)((var7 * var38 + var371 * var40) * var3), 0.0F, 0.0F);
         }
   ...
   private boolean destroyBlocksInAABB(AxisAlignedBB p_70972_1_) {
      ...
      for(int var16 = var2; var16 <= var5; ++var16) {
         for(int var11 = var3; var11 <= var6; ++var11) {
            for(int var17 = var4; var17 <= var7; ++var17) {
               Block var13 = this.worldObj.getBlock(var16, var11, var17);
               if(var13.getMaterial() != Material.air) {
                  if(var13 != Blocks.obsidian && var13 != Blocks.end_stone && var13 != Blocks.bedrock && this.worldObj.getGameRules().getGameRuleBooleanValue("mobGriefing")) {
                     var9 = this.worldObj.setBlockToAir(var16, var11, var17) || var9;
                  } else {
                     var8 = true;
                  }
               }
      ...
      if(var9) {
         double var161 = p_70972_1_.minX + (p_70972_1_.maxX - p_70972_1_.minX) * (double)this.rand.nextFloat();
         double var171 = p_70972_1_.minY + (p_70972_1_.maxY - p_70972_1_.minY) * (double)this.rand.nextFloat();
         double var14 = p_70972_1_.minZ + (p_70972_1_.maxZ - p_70972_1_.minZ) * (double)this.rand.nextFloat();
         this.worldObj.spawnParticle("largeexplode", var161, var171, var14, 0.0D, 0.0D, 0.0D);
      }
   ...
   protected void onDeathUpdate() {
      ...
      if(this.deathTicks >= 180 && this.deathTicks <= 200) {
         float var4 = (this.rand.nextFloat() - 0.5F) * 8.0F;
         float var5 = (this.rand.nextFloat() - 0.5F) * 4.0F;
         float var3 = (this.rand.nextFloat() - 0.5F) * 8.0F;
         this.worldObj.spawnParticle("hugeexplosion", this.posX + (double)var4, this.posY + 2.0D + (double)var5, this.posZ + (double)var3, 0.0D, 0.0D, 0.0D);
      }
      ...
      if(!this.worldObj.isClient) {
         if(this.deathTicks > 150 && this.deathTicks % 5 == 0) {
            ...
            while(var41 > 0) {
               var51 = EntityXPOrb.getXPSplit(var41);
               var41 -= var51;
               this.worldObj.spawnEntityInWorld(new EntityXPOrb(this.worldObj, this.posX, this.posY, this.posZ, var51));
            }
         }
