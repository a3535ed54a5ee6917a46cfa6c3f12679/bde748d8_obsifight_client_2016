...
public class EntityList {
   ...
   public static Entity createEntityByName(String p_75620_0_, World p_75620_1_) {
      ...
      try {
         Class var4 = (Class)stringToClassMapping.get(p_75620_0_);
         if(var4 != null) {
            var2 = (Entity)var4.getConstructor(new Class[]{World.class}).newInstance(new Object[]{p_75620_1_});
         }
   ...
   public static Entity createEntityFromNBT(NBTTagCompound p_75615_0_, World p_75615_1_) {
      ...
      try {
         Class var4 = (Class)stringToClassMapping.get(p_75615_0_.getString("id"));
         if(var4 != null) {
            var2 = (Entity)var4.getConstructor(new Class[]{World.class}).newInstance(new Object[]{p_75615_1_});
         }
      } catch (Exception var41) {
         var41.printStackTrace();
      }
   ...
   public static Entity createEntityByID(int p_75616_0_, World p_75616_1_) {
      ...
      try {
         Class var4 = getClassFromID(p_75616_0_);
         if(var4 != null) {
            var2 = (Entity)var4.getConstructor(new Class[]{World.class}).newInstance(new Object[]{p_75616_1_});
         }
      } catch (Exception var41) {
         var41.printStackTrace();
      }
   ...
   static {
      ...
      addMapping(EntityXTNT.class, "XTNT", 110);
      addMapping(EntityKingZombie.class, "KingZombie", 111, 44975, 10489616);
      addMapping(EntityGoldCow.class, "GoldenCow", 112, 15151, 11495003);
      addMapping(EntityBigWolf.class, "BigWolf", 113, 15151, 11495003);
      addMapping(EntityHellCow.class, "HellCow", 114, 12345, 123456789);
   }
