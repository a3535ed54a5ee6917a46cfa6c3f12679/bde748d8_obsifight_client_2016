...
public abstract class EntityLiving extends EntityLivingBase {
   ...
   public EntityLiving(World par1World) {
      ...
      for(int var5 = 0; var5 < this.equipmentDropChances.length; ++var5) {
         this.equipmentDropChances[var5] = 0.085F;
      }

      UUID var51 = this.getUniqueID();
      long uuidLow = var51.getLeastSignificantBits();
   ...
   public void writeEntityToNBT(NBTTagCompound par1NBTTagCompound) {
      ...
      NBTTagCompound var4;
      for(int var61 = 0; var61 < this.equipment.length; ++var61) {
         var4 = new NBTTagCompound();
         if(this.equipment[var61] != null) {
            this.equipment[var61].writeToNBT(var4);
         }
      ...
      if(this.leashedToEntity != null) {
         ...
         if(this.leashedToEntity instanceof EntityLivingBase) {
            ...
            EntityHanging var71 = (EntityHanging)this.leashedToEntity;
            var4.setInteger("X", var71.field_146063_b);
            var4.setInteger("Y", var71.field_146064_c);
            var4.setInteger("Z", var71.field_146062_d);
         }
               ...
               if(var5 > -1) {
                  ...
                  if(var7 != null) {
                     if(var5 == 0) {
                        if(var4.getItem() instanceof ItemSword && !(var7.getItem() instanceof ItemSword)) {
                           ...
                           ItemSword var112 = (ItemSword)var4.getItem();
                           ItemSword var121 = (ItemSword)var7.getItem();
                           if(var112.func_150931_i() == var121.func_150931_i()) {
                              var6 = var4.getItemDamage() > var7.getItemDamage() || var4.hasTagCompound() && !var7.hasTagCompound();
                           } else {
                              var6 = var112.func_150931_i() > var121.func_150931_i();
                           }
                        } else {
                           var6 = false;
                        }
                        ...
                        ItemArmor var1121 = (ItemArmor)var4.getItem();
                        ItemArmor var1211 = (ItemArmor)var7.getItem();
                        if(var1121.damageReduceAmount == var1211.damageReduceAmount) {
                           var6 = var4.getItemDamage() > var7.getItemDamage() || var4.hasTagCompound() && !var7.hasTagCompound();
                        } else {
                           var6 = var1121.damageReduceAmount > var1211.damageReduceAmount;
                        }
                     } else {
                        var6 = false;
                     }
                  ...
                  if(var6) {
                     ...
                     if(var4.getItem() == Items.diamond && var3.func_145800_j() != null) {
                        EntityPlayer var1122 = this.worldObj.getPlayerEntityByName(var3.func_145800_j());
                        if(var1122 != null) {
                           var1122.triggerAchievement(AchievementList.field_150966_x);
                        }
                     }
   ...
   protected void updateEntityActionState() {
      ...
      if(this.rand.nextFloat() < 0.02F) {
         EntityPlayer var41 = this.worldObj.getClosestPlayerToEntity(this, (double)var1);
         if(var41 != null) {
            this.currentTarget = var41;
   ...
   public void faceEntity(Entity par1Entity, float par2, float par3) {
      ...
      if(par1Entity instanceof EntityLivingBase) {
         EntityLivingBase var141 = (EntityLivingBase)par1Entity;
         var6 = var141.posY + (double)var141.getEyeHeight() - (this.posY + (double)this.getEyeHeight());
      } else {
         var6 = (par1Entity.boundingBox.minY + par1Entity.boundingBox.maxY) / 2.0D - (this.posY + (double)this.getEyeHeight());
      }

      double var1411 = (double)MathHelper.sqrt_double(var4 * var4 + var8 * var8);
      float var12 = (float)(Math.atan2(var8, var4) * 180.0D / Math.PI) - 90.0F;
      float var13 = (float)(-(Math.atan2(var6, var1411) * 180.0D / Math.PI));
