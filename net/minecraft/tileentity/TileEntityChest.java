...
public class TileEntityChest extends TileEntity implements IInventory {
   ...
   public void updateEntity() {
      ...
      if(!this.worldObj.isClient && this.field_145987_o != 0 && (this.field_145983_q + this.field_145851_c + this.field_145848_d + this.field_145849_e) % 200 == 0) {
         ...
         var1 = 5.0F;
         List var11 = this.worldObj.getEntitiesWithinAABB(EntityPlayer.class, AxisAlignedBB.getBoundingBox((double)((float)this.field_145851_c - var1), (double)((float)this.field_145848_d - var1), (double)((float)this.field_145849_e - var1), (double)((float)(this.field_145851_c + 1) + var1), (double)((float)(this.field_145848_d + 1) + var1), (double)((float)(this.field_145849_e + 1) + var1)));
         Iterator var3 = var11.iterator();

         while(var3.hasNext()) {
            EntityPlayer var9 = (EntityPlayer)var3.next();
            if(var9.openContainer instanceof ContainerChest) {
               IInventory var10 = ((ContainerChest)var9.openContainer).getLowerChestInventory();
               if(var10 == this || var10 instanceof InventoryLargeChest && ((InventoryLargeChest)var10).isPartOfLargeChest(this)) {
                  ++this.field_145987_o;
               }
            }
         }
      ...
      if(this.field_145987_o > 0 && this.field_145989_m == 0.0F && this.field_145992_i == null && this.field_145991_k == null) {
         double var91 = (double)this.field_145851_c + 0.5D;
         var8 = (double)this.field_145849_e + 0.5D;
         if(this.field_145988_l != null) {
            var8 += 0.5D;
         }
         ...
         this.worldObj.playSoundEffect(var91, (double)this.field_145848_d + 0.5D, var8, "random.chestopen", 0.5F, this.worldObj.rand.nextFloat() * 0.1F + 0.9F);
      }

      if(this.field_145987_o == 0 && this.field_145989_m > 0.0F || this.field_145987_o > 0 && this.field_145989_m < 1.0F) {
         float var101 = this.field_145989_m;
         ...
         float var111 = 0.5F;
         if(this.field_145989_m < var111 && var101 >= var111 && this.field_145992_i == null && this.field_145991_k == null) {
            var8 = (double)this.field_145851_c + 0.5D;
            ...
            this.worldObj.playSoundEffect(var8, (double)this.field_145848_d + 0.5D, var6, "random.chestclosed", 0.5F, this.worldObj.rand.nextFloat() * 0.1F + 0.9F);
         }
